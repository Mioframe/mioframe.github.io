import { G as H, I as q, d as I, c as O, n as U, h as p, o as V, B as R, r as b, C as j } from "./iframe-KtfoL3fw.js";
import { _ as G } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { u as f, d as y, v as K, c as W, x as L } from "./index-C1qInJPL.js";
const z = { trailing: true };
function Y(n, e = 25, a = {}) {
  if (a = { ...z, ...a }, !Number.isFinite(e)) throw new TypeError("Expected `wait` to be a finite number");
  let l, s, r = [], t, o;
  const c = (u, v) => (t = J(n, u, v), t.finally(() => {
...
const B = /* @__PURE__ */ Symbol("MDStateLayerForcedState"), ue = (n) => {
  q(B, n);
}, X = () => H(B, void 0), ee = I({ __name: "MDStateLayer", props: { hover: { type: Boolean, default: false }, focused: { type: Boolean, default: false }, pressed: { type: Boolean, default: false }, dragged: { type: Boolean, default: false }, disabled: { type: Boolean, default: false } }, setup(n) {
  ...
  return (o, c) => (V(), O("span", { class: U(["md-state-layer", { "md-state_hover": !e.disabled && l.value, "md-state_focused": !e.disabled && s.value, "md-state_pressed": !e.disabled && r.value, "md-state_dragged": !e.disabled && t.value, "md-state_disabled": e.disabled }]), "aria-hidden": "true" }, null, 2));
} }), de = G(ee, [["__scopeId", "data-v-73ae0dfb"]]), i = /* @__PURE__ */ Object.create(null), C = 6e4, N = C * 60, S = N * 24, k = S * 365.25;
i.year = i.yr = i.y = k;
i.month = i.mo = i.mth = k / 12;
i.week = i.wk = i.w = S * 7;
i.day = i.d = S;
i.hour = i.hr = i.h = N;
i.minute = i.min = i.m = C;
