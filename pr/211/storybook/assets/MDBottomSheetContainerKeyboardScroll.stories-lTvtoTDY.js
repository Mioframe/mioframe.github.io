import { X as U, E as j, M as q, r as x, g as W, d as N, S as B, C as H, c as D, b as g, s as G, i as h, a as X, h as Y, v as F, G as J, T as Z, j as M, y as O, o as T, p as ee, w as te, F as oe, f as se, t as ne } from "./iframe-D1c-MjKU.js";
import { u as ae, a as re, M as le } from "./useStateLayer-C8uLNXms.js";
import { r as ie, u as ce, g as ue, t as de, h as fe, a as pe, b as me } from "./index-CcjJLo8I.js";
import { u as he } from "./index-BmLbTzID.js";
import { u as ve } from "./FabContainer.vue_vue_type_style_index_0_scoped_7d3751a5_lang-BCyk1uyV.js";
import { c as be, d as ye } from "./main-DBaDxEAL.js";
import "./MDIconButton-BwWS2lf9.js";
import "./useLocalSettings-zeziLJyo.js";
import { u as ge } from "./useFocusTrap-CAn4tX4C.js";
import { _ as z } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import "./preload-helper-PPVm8Dsz.js";
import "./MDSymbol-cV0rPsuE.js";
...
function we(t, e, { signal: s, edges: l } = {}) {
  let o, n = null;
  const i = l != null && l.includes("leading"), f = l == null || l.includes("trailing"), p = () => {
...
function Te(t, e, { signal: s, edges: l = ["leading", "trailing"] } = {}) {
  let o = null;
  const n = we(function(...f) {
    o = Date.now(), t.apply(this, f);
  }, e, { signal: s, edges: l }), i = function(...f) {
    if (o == null && (o = Date.now()), Date.now() - o >= e) {
      o = Date.now(), t.apply(this, f), n.cancel(), n.schedule();
      return;
    }
    n.apply(this, f);
  };
...
function ke(t) {
  ...
  }, p = (a, ...r) => new Promise((c, d) => {
    f(a, c, d, r);
  });
  return Object.defineProperties(p, { activeCount: { get: () => l }, pendingCount: { get: () => s.size }, clearQueue: { value() {
    if (!e) {
      s.clear();
      return;
    }
    ...
    const c = Array.from(a, (d, u) => p(r, d, u));
...
const He = (t, { throttleMs: e = 1e3 / 10 } = {}) => {
  ...
  }, f = ke(1), p = async ({ behavior: a = "smooth", left: r, top: c }) => {
    await f(async () => {
      await j(), await i({ behavior: a, left: r, top: c });
    });
  };
  return de(() => {
    o.value = false, f.clearQueue();
  }), { scrollTo: p, position: U(W({ scrollTop: s, scrollLeft: l })) };
  ...
  const e = B(t, "open"), s = B(t, "scrollPosition"), l = t, o = M("containerEl"), n = () => {
    e.value = !e.value;
  }, i = M("dragHandleEl"), { hover: f, focused: p, durationPressedState: a } = ae(i);
  re(i);
  const r = M("bodyEl"), { height: c } = fe(r, { height: 0, width: 0 }, { box: "border-box" }), { position: d, scrollTo: u } = He(o, { throttleMs: 1e3 / 60 });
  H(d, ({ scrollTop: m }) => {
    s.value = m;
  }), H([e, c, r], ([m, v, y]) => {
    if (v && y) if (m) {
  ...
  }, K = ve(), { left: L, width: P } = pe(K, { updateTiming: "next-frame", windowScroll: false, immediate: false }), V = O(() => ({ paddingLeft: `${L.value}px`, paddingRight: `calc(100% - ${L.value + P.value}px)` })), R = O(() => ({ width: `${P.value}px` }));
  return be(e, () => (e.value = false, false)), ye(e, () => (e.value = false, false)), (m, v) => (T(), D("div", { ref_key: "containerEl", ref: o, class: "md-bottom-sheet md-bottom-sheet__scrim", role: "dialog", "aria-hidden": h(b), style: F(V.value), onClick: J(w, ["self"]), onKeydown: $ }, [g("div", { ref_key: "bodyEl", ref: r, class: "md md-bottom-sheet__body", style: F(R.value) }, [g("div", De, [g("button", { ref_key: "dragHandleEl", ref: i, type: "button", class: G(["md-bottom-sheet__drag-handle", { "md-state_hover": h(f), "md-state_focused": h(p), "md-state_pressed": h(a) }]), "aria-label": e.value ? l.dragHandleCloseLabel : l.dragHandleExpandLabel, onClick: n }, [X(h(le), { hover: h(f), focused: h(p), pressed: h(a) }, null, 8, ["hover", "focused", "pressed"]), v[0] || (v[0] = g("span", { class: "md-bottom-sheet__drag-pill" }, null, -1))], 10, Le)]), Y(m.$slots, "default", {}, void 0, true)], 4)], 44, Me));
...
} }), Ae = z(Oe, [["__scopeId", "data-v-f4c38cc5"]]), Ye = { title: "shared/ui/Sheets/MDBottomSheetContainerKeyboardScrollStoryHarness", component: Ae, parameters: { layout: "fullscreen" } }, S = {};
