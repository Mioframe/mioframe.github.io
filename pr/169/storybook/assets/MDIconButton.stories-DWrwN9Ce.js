import { M as o } from "./MDIconButton-Bi2MCK2x.js";
import { d as $, f as m, g as n, h as C, a as O, t as v, r as R, o as p, F as z, i as N, G as V, H as W } from "./iframe-C2GKzqnw.js";
import { _ as E } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { _ as c } from "./MDStateLayerForcedStateProvider.vue_vue_type_script_setup_true_lang-NWezaRX6.js";
import { u as Y } from "./useFocusIndicator-CRAbAK7O.js";
...
import "./useStateLayer-PWYx-fYw.js";
...
const Z = { id: "visual-md-icon-button-target-hit", class: "visual-checker-backdrop md-icon-button-target-hit" }, j = { class: "md-icon-button-target-hit__stage" }, X = { class: "md-icon-button-target-hit__status" }, J = { id: "visual-md-icon-button-target-hit-count" }, K = $({ __name: "MDIconButtonTargetHitVisualStory", setup(a) {
  ...
  const t = ["add", "filter", "sort", "search"], e = V({ add: 0, filter: 0, sort: 0, search: 0 }), s = R("none"), d = (i) => {
    e[i] += 1;
  }, r = (i) => {
    s.value = i;
  }, w = (i) => {
...
`) } } } }, A = () => ({ template: '<div class="visual-checker-backdrop"><story /></div>' }), b = { decorators: [A] }, y = { tags: ["visual"], render: () => ({ components: { MDIconButton: o, MDStateLayerForcedStateProvider: c }, template: `
  ...
  const s = H[a], d = s[t], [r, w] = e === "hover" ? [d.hoverIcon, d.stateLayerColor] : G[a][t][e], i = e === "hover" ? s.hoverOpacity : G[a][`${e}Opacity`], u = e === "hover" ? "hovered" : e === "focus" ? "focused" : "pressed";
