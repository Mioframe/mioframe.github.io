import { d as M, c as y, a as f, b as k, t as x, r as a, o as S } from "./iframe-CKr7v8KT.js";
import { u as C } from "./useFocusIndicator-DCv146sm.js";
import { M as h } from "./MDLoadingIndicator-CTBu3dop.js";
import { M as t } from "./MDButton-BYbJFZSB.js";
...
const O = { id: "visual-md-button-target-hit", class: "visual-checker-backdrop" }, w = { id: "visual-md-button-target-hit-count" }, T = M({ __name: "MDButtonTargetHitVisualStory", setup(e) {
  const o = a(0), n = () => {
    o.value += 1;
  };
  return (D, B) => (S(), y("div", O, [f(t, { label: "OK", size: "extra-small", onClick: n }), k("output", w, x(o.value), 1)]));
    ...
    ` }) }, i = { render: () => ({ components: { MDButtonTargetHitVisualStory: T }, template: "<MDButtonTargetHitVisualStory />" }) }, d = { render: () => ({ components: { MDButton: t }, template: `
  ...
  return { attemptedOverrides: e, toggleAttemptedOverrides: () => {
    ...
    ` }) }, b = { tags: ["visual"], render: () => ({ components: { MDButton: t, MDLoadingIndicator: h }, template: `
      <div
        class="md"
...
const U = ["Default", "VisualStates", "SizeGeometry", "ExpandedTargetHitArea", "SmallGeometryContract", "FocusIndicatorTarget", "BehaviorContracts", "HostAttributeBoundary", "RealInteractionFeedback", "LoadingIndicatorPresentation", "LegacySurfaceColorOwnership", "ContextualTextTokens"];
export {
