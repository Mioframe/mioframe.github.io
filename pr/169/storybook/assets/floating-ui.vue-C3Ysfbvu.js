import { d as Ht, c as It, Y as Xt, A as jt, o as Yt, b as P, r as U, l as ut, z as j, s as qt, Z as Kt, _ as Ut, y as G } from "./iframe-BmKBn1Mu.js";
import { b as Gt } from "./useOverlay-DJ1otShK.js";
const Be = Ht({ __name: "TeleportContainer", props: { to: {}, container: {}, defer: { type: Boolean }, disabled: { type: Boolean } }, setup(t) {
  const e = t;
  return Gt(P(() => e.container)), (n, o) => (Yt(), It(Xt, { to: t.to, defer: t.defer, disabled: t.disabled }, [jt(n.$slots, "default")], 8, ["to", "defer", "disabled"]));
} }), q = Math.min, F = Math.max, nt = Math.round, et = Math.floor, M = (t) => ({ x: t, y: t }), Zt = { left: "right", right: "left", bottom: "top", top: "bottom" };
function Jt(t, e, n) {
  return F(t, q(e, n));
}
function Q(t, e) {
...
function At(t, e, n) {
  ...
  const r = V(e), s = Ft(e), l = Vt(s), c = z(e), a = r === "y", f = o.x + o.width / 2 - i.width / 2, d = o.y + o.height / 2 - i.height / 2, m = o[l] / 2 - i[l] / 2;
  let u;
  switch (c) {
    case "top":
...
const ce = 50, ae = async (t, e, n) => {
  ...
  return t === void 0 && (t = {}), { name: "flip", options: t, async fn(e) {
    var n, o;
    const { placement: i, middlewareData: r, rects: s, initialPlacement: l, platform: c, elements: a } = e, { mainAxis: f = true, crossAxis: d = true, fallbackPlacements: m, fallbackStrategy: u = "bestFit", fallbackAxisSideDirection: h = "none", flipAlignment: g = true, ...w } = Q(t, e);
    if ((n = r.arrow) != null && n.alignmentOffset) return {};
    const p = z(i), v = V(l), y = z(l) === l, x = await (c.isRTL == null ? void 0 : c.isRTL(a.floating)), O = m || (y || !g ? [ot(l)] : te(l)), R = h !== "none";
    ...
    if (S = [...S, { placement: i, overflows: L }], !L.every((k) => k <= 0)) {
      ...
      if (ft && (!(d === "alignment" ? v !== V(ft) : false) || S.every((E) => V(E.placement) === v ? E.overflows[0] > 0 : true))) return { data: { index: k, overflows: S }, reset: { placement: ft } };
      let K = (bt = S.filter((N) => N.overflows[0] <= 0).sort((N, E) => N.overflows[1] - E.overflows[1])[0]) == null ? void 0 : bt.placement;
      if (!K) switch (u) {
        case "bestFit": {
          var Rt;
          const N = (Rt = S.filter((E) => {
            if (R) {
              const _ = V(E.placement);
              return _ === v || _ === "y";
            }
            return true;
          }).map((E) => [E.placement, E.overflows.filter((_) => _ > 0).reduce((_, zt) => _ + zt, 0)]).sort((E, _) => E[1] - _[1])[0]) == null ? void 0 : Rt[0];
          N && (K = N);
          break;
        }
...
async function de(t, e) {
  const { placement: n, platform: o, elements: i } = t, r = await (o.isRTL == null ? void 0 : o.isRTL(i.floating)), s = z(n), l = tt(n), c = V(n) === "y", a = ue.has(s) ? -1 : 1, f = r && c ? -1 : 1, d = Q(e, t);
...
const me = function(t) {
  ...
  return t === void 0 && (t = {}), { name: "shift", options: t, async fn(e) {
    const { x: n, y: o, placement: i, platform: r } = e, { mainAxis: s = true, crossAxis: l = false, limiter: c = { fn: (v) => {
      let { x: y, y: x } = v;
      return { x: y, y: x };
    } }, ...a } = Q(t, e), f = { x: n, y: o }, d = await r.detectOverflow(e, a), m = V(i), u = Pt(m);
    let h = f[u], g = f[m];
    const w = (v, y) => Jt(y + d[v === "y" ? "top" : "left"], y, y - d[v === "y" ? "bottom" : "right"]);
    s && (h = w(u, h)), l && (g = w(m, g));
  ...
  return t === void 0 && (t = {}), { name: "size", options: t, async fn(e) {
    ...
    }, ...l } = Q(t, e), c = await i.detectOverflow(e, l), a = z(n), f = tt(n), d = V(n) === "y", { width: m, height: u } = o.floating;
    let h, g;
    ...
    let R = v, b = y;
    x != null && x.enabled.x && (b = p), x != null && x.enabled.y && (R = w), O && !f && (d ? b = m - 2 * F(c.left, c.right) : R = u - 2 * F(c.top, c.bottom)), await s({ ...e, availableWidth: b, availableHeight: R });
...
const we = /transform|translate|scale|rotate|perspective|filter/, ve = /paint|layout|strict|content/, B = (t) => !!t && t !== "none";
let dt;
function wt(t) {
  const e = T(t) ? D(t) : t;
  return B(e.transform) || B(e.translate) || B(e.scale) || B(e.rotate) || B(e.perspective) || !vt() && (B(e.backdropFilter) || B(e.filter)) || we.test(e.willChange || "") || ve.test(e.contain || "");
}
function ye(t) {
  let e = H(t);
  for (; $(e) && !Z(e); ) {
...
function Mt(t) {
  const e = H(t);
  return Z(e) ? (t.ownerDocument || t).body : $(e) && st(e) ? e : Mt(e);
}
function J(t, e, n) {
  var o;
  e === void 0 && (e = []), n === void 0 && (n = true);
  const i = Mt(t), r = i === ((o = t.ownerDocument) == null ? void 0 : o.body), s = A(i);
  if (r) {
    const l = gt(s);
    return e.concat(s, s.visualViewport || [], st(i) ? i : [], l && n ? J(l) : []);
  } else return e.concat(i, J(i, [], n));
}
function gt(t) {
...
function Oe(t) {
  const e = ct(t), n = t.ownerDocument.body, o = F(t.scrollWidth, t.clientWidth, n.scrollWidth, n.clientWidth), i = F(t.scrollHeight, t.clientHeight, n.scrollHeight, n.clientHeight);
  let r = -e.scrollLeft + at(t);
  const s = -e.scrollTop;
  return D(n).direction === "rtl" && (r += F(t.clientWidth, n.clientWidth) - o), { width: o, height: i, x: r, y: s };
}
const Ae = 25;
function Ee(t, e, n) {
  n === void 0 && (n = "viewport");
...
function Se(t, e) {
  const n = e.get(t);
  if (n) return n;
  let o = J(t, [], false).filter((l) => T(l) && X(l) !== "body"), i = null;
  const r = D(t).position === "fixed";
  let s = r ? H(t) : t;
  for (; T(s) && !Z(s); ) {
    const l = D(s), c = wt(s), a = i ? i.position : r ? "fixed" : "";
    !c && (a === "fixed" || a === "absolute" && l.position === "static") ? o = o.filter((d) => d !== s) : i = l, s = H(s);
  }
  return e.set(t, o), o;
}
function Te(t) {
  ...
  for (let m = 1; m < s.length; m++) {
    const u = Lt(e, s[m], i);
    c = F(u.top, c), a = q(u.right, a), f = q(u.bottom, f), d = F(u.left, d);
  }
...
function Pe(t, e, n) {
  ...
  !o && i && (c.x = at(i));
  const a = i && !o && !r ? $t(i, l) : M(0), f = s.left + l.scrollLeft - c.x - a.x, d = s.top + l.scrollTop - c.y - a.y;
...
function kt(t, e) {
  ...
  return o && Z(o) && mt(o) && !wt(o) ? n : o || ye(t) || n;
}
...
const Me = { convertOffsetParentRelativeRectToViewportRelativeRect: Re, getDocumentElement: W, getClippingRect: Te, getOffsetParent: kt, getElementRects: Ve, getClientRects: Ce, getDimensions: De, getScale: Y, isElement: T, isRTL: Fe };
function Nt(t, e) {
...
function We(t, e, n) {
  ...
  function l(f, d) {
    ...
    if (f || e(), !g || !w) return;
    const p = et(h), v = et(r.clientWidth - (u + g)), y = et(r.clientHeight - (h + w)), x = et(u), R = { rootMargin: -p + "px " + -v + "px " + -y + "px " + -x + "px", threshold: F(0, q(1, d)) || 1 };
    let b = true;
    function C(L) {
      const S = L[0].intersectionRatio;
      if (!Nt(m, t.getBoundingClientRect())) return l();
      if (S !== d) {
        if (!b) return l();
...
function ze(t, e, n, o) {
  o === void 0 && (o = {});
  const { ancestorScroll: i = true, ancestorResize: r = true, elementResize: s = typeof ResizeObserver == "function", layoutShift: l = typeof IntersectionObserver == "function", animationFrame: c = false } = o, a = yt(t), f = i || r ? [...a ? J(a) : [], ...e ? J(e) : []] : [];
  f.forEach((p) => {
  ...
  function w() {
    const p = I(t);
    g && !Nt(g, p) && n(), g = p, h = requestAnimationFrame(w);
  }
  return n(), () => {
    var p;
    f.forEach((v) => {
...
const He = me, Ie = he, Xe = fe, je = ge, _e = (t, e, n) => {
  const o = /* @__PURE__ */ new Map(), i = n ?? {}, r = { ...Me, ...i.platform, _c: o };
...
function Ye(t, e, n) {
  ...
  }), a = P(() => Tt(t.value)), f = P(() => Tt(e.value)), d = U(0), m = U(0), u = U(l.value), h = U(s.value), g = qt({}), w = U(false), p = P(() => {
    const b = { position: u.value, left: "0", top: "0" };
    if (!f.value) return b;
    const C = Dt(f.value, d.value), L = Dt(f.value, m.value);
    return c.value ? { ...b, transform: "translate(" + C + "px, " + L + "px)", ...Bt(f.value) >= 1.5 && { willChange: "transform" } } : { position: u.value, left: C + "px", top: L + "px" };
  });
  let v;
  function y() {
  ...
  return ut([r, s, l, i], y, { flush: "sync" }), ut([a, f], O, { flush: "sync" }), ut(i, R, { flush: "sync" }), Kt() && Ut(x), { x: j(d), y: j(m), strategy: j(u), placement: j(h), middlewareData: j(g), isPositioned: j(w), floatingStyles: p, update: y };
}
export {
  Be as _,
  ze as a,
