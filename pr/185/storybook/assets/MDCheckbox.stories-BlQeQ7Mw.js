import { M as d } from "./MDCheckbox-2F4dHAgn.js";
import "./iframe-BW_3G6Xd.js";
...
const { useArgs: u } = __STORYBOOK_MODULE_PREVIEW_API__, I = { title: "shared/ui/MDCheckbox", component: d, args: { ariaLabel: "Diagnostics", id: "storybook-md-checkbox-default", modelValue: false }, argTypes: { "onUpdate:modelValue": { action: "update:modelValue" }, onClick: { action: "click" } }, parameters: { layout: "centered" } }, m = `
...
`, e = { render: function() {
  ...
  return { components: { MDCheckbox: d }, setup() {
    return { args: n, onUpdateModelValue: l };
  }, template: '<MDCheckbox v-bind="args" @update:model-value="onUpdateModelValue" />' };
} }, a = { args: { modelValue: true } }, s = { args: { indeterminate: true, modelValue: void 0 } }, o = { args: { disabled: true, modelValue: true } }, r = { tags: ["visual"], render: () => ({ components: { MDCheckbox: d }, template: m }) }, t = { tags: ["visual"], render: () => ({ components: { MDCheckbox: d }, template: p }) };
...
const w = ["Default", "Checked", "Indeterminate", "Disabled", "VisualStates", "VisualInteractionStates"];
export {
  a as Checked,
  e as Default,
  o as Disabled,
