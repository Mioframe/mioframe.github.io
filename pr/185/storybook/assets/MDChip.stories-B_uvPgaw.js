import { d as _, u as K, i as Q, A as U, o as i, c as m, n as L, e, b as n, a as s, f as y, g as S, j as x, t as j, h as p, r as W, S as O, w as V } from "./iframe-BW_3G6Xd.js";
...
import { u as X, a as Y, M as H } from "./useStateLayer-BheEhEQ0.js";
import { M as T } from "./MDSymbol-BapSH0y3.js";
import "./FabContainer.vue_vue_type_style_index_0_scoped_3ecc84a9_lang-ChTYPP0c.js";
import "./useLocalSettings-B6N-OD9R.js";
import { M as Z } from "./MDIconButton-98R518Qz.js";
...
const ae = ["aria-disabled", "draggable"], te = ["disabled"], se = { key: 0, class: "md-chip__leading-icon" }, le = { class: "md-chip__label-text" }, oe = ["disabled", "draggable"], ie = { key: 0, class: "md-chip__leading-icon" }, de = { class: "md-chip__label-text" }, ce = { key: 1, class: "md-chip__trailing-icon" }, ne = _({ __name: "MDChipBase", props: { elevated: { type: Boolean }, label: {}, type: {}, selected: { type: Boolean }, draggable: { type: Boolean }, autofocus: { type: Boolean }, disabled: { type: Boolean }, closeTooltip: {} }, emits: ["click", "clickClose"], setup(t, { emit: c }) {
  const a = t, r = c, l = K(), o = p(() => a.type), F = p(() => o.value === "input"), P = p(() => o.value === "assist"), C = p(() => o.value === "filter"), h = p(() => !!a.selected), q = p(() => a.closeTooltip ?? "remove"), k = Q("actionEl"), b = W(false), { hover: D, focused: B, durationPressedState: I } = X(k, { dragged: b }), u = p(() => !a.disabled);
  ...
  return (o, F) => (i(), y(E, { type: "input", label: t.label, elevated: t.elevated, draggable: t.draggable, autofocus: t.autofocus, disabled: t.disabled, "close-tooltip": t.closeTooltip, onClick: r, onClickClose: l }, null, 8, ["label", "elevated", "draggable", "autofocus", "disabled", "close-tooltip"]));
