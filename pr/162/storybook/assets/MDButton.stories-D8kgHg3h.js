import { d as D, f as g, h as B, g as M, t as f, r as m, o as k } from "./iframe-C35YEs8u.js";
import { u as C } from "./useFocusIndicator-DvEcrPRC.js";
import { M as S } from "./MDLoadingIndicator-aI8rB5Oe.js";
import { M as t } from "./MDButton-CRpHMN2N.js";
import "./preload-helper-PPVm8Dsz.js";
import "./index-DNuDdE2n.js";
import "./_plugin-vue_export-helper-DlAUqK2U.js";
const x = { id: "visual-md-button-target-hit", class: "visual-checker-backdrop" }, y = { id: "visual-md-button-target-hit-count" }, h = D({ __name: "MDButtonTargetHitVisualStory", setup(p) {
  const e = m(0), a = () => {
    e.value += 1;
  };
  return (b, v) => (k(), g("div", x, [B(t, { label: "OK", size: "extra-small", onClick: a }), M("output", y, f(e.value), 1)]));
} }), E = { title: "Material 3/Components/Buttons/MDButton", component: t, args: { color: "filled", label: "Save" }, argTypes: { onClick: { action: "click" } }, parameters: { layout: "centered", docs: { description: { component: "Mioframe Material action Button adapter backed privately by @m3e/web. Supports the production-selected filled, outlined, and text colors, small and extra-small sizes, disabled state, native button/submit behavior, leading icon content, and short indeterminate loading." } } } }, o = {}, n = { tags: ["visual"], render: () => ({ components: { MDButton: t }, template: `
    ...
    ` }) }, i = { render: () => ({ components: { MDButtonTargetHitVisualStory: h }, template: "<MDButtonTargetHitVisualStory />" }) }, s = { render: () => ({ components: { MDButton: t }, setup() {
  C();
}, template: `
  ...
  const p = m(0), e = m(0), a = m(0);
  return { disabledClickCount: a, loadingClickCount: e, onDisabledClick: () => {
    a.value += 1;
  }, onLoadingClick: () => {
    e.value += 1;
  }, onSubmit: () => {
    ...
    ` }) }, u = { tags: ["visual"], render: () => ({ components: { MDButton: t, MDLoadingIndicator: S }, template: `
      <div
...
const H = ["Default", "VisualStates", "SizeGeometry", "ExpandedTargetHitArea", "FocusIndicatorTarget", "BehaviorContracts", "RealInteractionFeedback", "LoadingIndicatorPresentation", "LegacySurfaceColorOwnership"];
export {
  ...
  r as LoadingIndicatorPresentation,
