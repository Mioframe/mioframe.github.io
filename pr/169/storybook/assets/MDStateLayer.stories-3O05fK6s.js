import { d, r as n, b as p } from "./iframe-DwF8-rx2.js";
import { M as c } from "./MDButton-BQXCb0QI.js";
import "./MDLoadingIndicator-CUiRzum_.js";
import { M as l, u, a as v } from "./useStateLayer-BRrXhbAT.js";
...
const y = d({ components: { MDStateLayer: l }, props: { label: { type: String, required: true }, disabled: { type: Boolean, default: false }, enableRipple: { type: Boolean, default: true }, dragged: { type: Boolean, default: false } }, setup(a) {
  ...
  ` }), _ = { title: "shared/ui/MDStateLayer", component: l, parameters: { layout: "centered" } }, e = { tags: ["visual"], render: () => ({ components: { MDStateLayer: l, StateLayerDemoHost: y }, template: `
...
const S = ["VisualStates", "VisualHostIntegration"];
export {
