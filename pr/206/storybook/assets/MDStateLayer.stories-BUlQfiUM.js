import { d, r as n, y as p } from "./iframe-Ca4XsWix.js";
import { M as c } from "./MDButton-iOvxmI9b.js";
...
import { M as l, u, a as v } from "./useStateLayer-jmFK2RnY.js";
...
const m = d({ components: { MDStateLayer: l }, props: { label: { type: String, required: true }, disabled: { type: Boolean, default: false }, enableRipple: { type: Boolean, default: true }, dragged: { type: Boolean, default: false } }, setup(a) {
  ...
  ` }), k = { title: "shared/ui/MDStateLayer", component: l, parameters: { layout: "centered" } }, e = { tags: ["visual"], render: () => ({ components: { MDStateLayer: l, StateLayerDemoHost: m }, template: `
...
const B = ["VisualStates", "VisualHostIntegration"];
export {
