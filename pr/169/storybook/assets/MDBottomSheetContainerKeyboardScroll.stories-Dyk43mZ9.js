import { W as Q, G as U, p as j, r as x, y as q, d as N, R as A, l as H, f as D, g, n as G, u as h, h as X, A as Y, k as B, X as J, S as Z, j as M, b as F, o as T, c as ee, w as te, i as oe, F as se, t as ne } from "./iframe-DwF8-rx2.js";
import { u as ae, a as re, M as le } from "./useStateLayer-BRrXhbAT.js";
import { r as ie, d as ce, g as ue, t as de, c as pe, h as fe, f as me } from "./index-uugn3NIi.js";
import { a as he } from "./index-0vA-ZLHP.js";
import { u as ve } from "./FabContainer.vue_vue_type_style_index_0_scoped_3ecc84a9_lang-BC8Ok-cP.js";
import "./MDCircularProgressIndicator--WetYLWC.js";
import "./floating-ui.vue-BHK0henk.js";
import "./MDOverlayTooltip.vue_vue_type_style_index_0_scoped_237db18c_lang-D5NTsE_g.js";
import { u as be, a as ye } from "./main-DLExUt5Z.js";
import "./MDIconButton-CgYAPrfC.js";
import "./useLocalSettings-CPPkaQKa.js";
import { u as ge } from "./useFocusTrap-CDSdobjT.js";
import { _ as z } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import "./preload-helper-PPVm8Dsz.js";
import "./MDSymbol-CLjzonBB.js";
...
const He = (t, { throttleMs: e = 1e3 / 10 } = {}) => {
  ...
  }), { scrollTo: f, position: Q(U({ scrollTop: s, scrollLeft: l })) };
  ...
  const e = A(t, "open"), s = A(t, "scrollPosition"), l = t, o = M("containerEl"), n = () => {
    e.value = !e.value;
  ...
  H(d, ({ scrollTop: m }) => {
    ...
    if (v && y) if (m) {
      const W = Math.min(v, y.offsetTop);
      u({ top: W });
    } else u({ top: 0 });
  }, { immediate: true });
  const w = () => {
  ...
  return (o, n) => (T(), ee(qe, { open: e.value, "onUpdate:open": n[0] || (n[0] = (i) => e.value = i), "scroll-position": s.value, "onUpdate:scrollPosition": n[1] || (n[1] = (i) => s.value = i), "aria-label": "Keyboard scroll test sheet" }, { default: te(() => [g("ul", Ae, [(T(true), D(se, null, oe(h(l), (i) => (T(), D("li", { key: i }, [g("button", Be, ne(i), 1)]))), 128))])]), _: 1 }, 8, ["open", "scroll-position"]));
} }), Oe = z(Fe, [["__scopeId", "data-v-f4c38cc5"]]), st = { title: "shared/ui/Sheets/MDBottomSheetContainerKeyboardScrollStoryHarness", component: Oe, parameters: { layout: "fullscreen" } }, S = {};
