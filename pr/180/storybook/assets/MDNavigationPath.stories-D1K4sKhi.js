import { d as P, o as i, f as y, e as d, N as B, c as m, a as p, F as g, l as x, h as k, r as R } from "./iframe-BH_xToKO.js";
import { M as _ } from "./MDButton-BPFW3dml.js";
...
import { M as S } from "./MDSymbol-DFQOl1vw.js";
...
const u = { SEPARATOR: "/", normalize(t) {
...
} }, O = P({ __name: "MDNavigationPathSegmentButton", props: { label: {}, path: {} }, emits: ["click"], setup(t, { emit: e }) {
  const a = t, o = e, s = () => {
    o("click", a.path);
  };
  ...
  return (n, f) => (i(), m("div", j, [p(d(z), { tooltip: "Home", "md-symbol-name": "home", color: "standard", class: "md-navigation-path__home-button", onClick: D }), (i(true), m(g, null, x(M.value, ({ name: c, path: v }) => (i(), m(g, { key: v }, [p(d(S), { class: "md-navigation-path__separator", name: "chevron_right" }), p(O, { label: c, path: v, onClick: C }, null, 8, ["label", "path"])], 64))), 128))]));
} }), b = N(A, [["__scopeId", "data-v-8478865b"]]), Z = { title: "shared/ui/NavigationPath/MDNavigationPath", component: b, parameters: { layout: "centered" } }, r = { args: { path: "/My Drive/Long project folder/Research materials/Final documents" }, render: () => ({ components: { MDButton: _, MDNavigationPath: b }, setup() {
  const t = R("none");
...
const tt = ["ButtonGeometryAndOverflow"];
export {
