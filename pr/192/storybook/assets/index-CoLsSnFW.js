import { E as J, B as D, a6 as X, M as w, a7 as be, a8 as ce, N as fe, a9 as ge, Z as we, r as Y, q as Z, a1 as Se, a2 as Ee, a4 as Q, s as Te, C as _, a0 as Oe, m as ue, h as N, H as _e, e as Ae } from "./iframe-Q3swnoIu.js";
function Re(e, t, n = {}) {
  let o, u, i, l = true;
  const a = () => {
    l = true, i();
...
function qe(e) {
  ...
  return Oe(n.trigger), Z(n.trigger), n;
}
function ye(e, t, n = {}) {
  const { window: o = R, ...u } = n;
  let i;
