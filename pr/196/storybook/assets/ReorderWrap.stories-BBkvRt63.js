import { d as l, k as g, o as d, c as n, v as _, s as f, j as p, t as y, b as h, a as v, w as x, r as I, F as b, f as S, p as R } from "./iframe-CHPDa0j6.js";
import { u as k, _ as W } from "./useReorderItem-De2QwMag.js";
...
const z = ["aria-label"], $ = l({ __name: "ReorderWrapStoryItem", props: { itemId: {}, index: {}, width: {}, height: {} }, setup(e) {
  const r = e, t = g("root"), { isDragging: a } = k({ id: () => r.itemId, index: () => r.index, element: () => t.value ?? void 0, handle: () => t.value ?? void 0 });
