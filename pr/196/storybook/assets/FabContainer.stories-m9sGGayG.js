import { d as g, B as L, H, c as _, a as E, w as M, i as a, v as u, j as D, y as b, o as A, b as B, s as T, h as j, r as l, Z as I } from "./iframe-D-D37Lk_.js";
import { d as R, j as V, k as z, h as O } from "./index-DjPXEiqi.js";
import { i as U } from "./isUndefined-Dgw4-efh.js";
import { u as $ } from "./useOverlay-DCJeQa-J.js";
import { u as N, a as W, _ as Z, o as q, s as G } from "./MDSymbol-B7NY5YzM.js";
import { a as J } from "./index-C68bolNh.js";
import { u as K, d as Q } from "./FabContainer.vue_vue_type_style_index_0_scoped_3ecc84a9_lang-CVd5Wi3t.js";
import "./MDOverlayTooltip.vue_vue_type_style_index_0_scoped_237db18c_lang-C45UlKYX.js";
import "./useStateLayer-CGFClYxV.js";
import "./MDIconButton-DBjoGHuW.js";
import "./useLocalSettings-cQYzo4qr.js";
import { _ as X } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { M as m } from "./MDExtendedFab-Et9XuOPl.js";
...
const Y = ["aria-hidden"], ee = g({ __name: "FabContainer", props: { autoHide: { type: Boolean } }, setup(e) {
  const t = e, { autoHide: n } = L(t), s = D("fabContainer"), y = R(), r = l(), { directions: f } = V(y);
  H(() => {
  ...
  return (c, te) => (A(), _("div", { class: "fab-container fab-container__placeholder", style: u(P.value) }, [E(a(Z), { container: s.value, to: a(C) }, { default: M(() => [B("div", { ref: "fabContainer", class: T(["fab-container__surface", { "fab-container__surface_auto-hide": a(n), "fab-container__surface_hidden": !x.value }]), style: u(a(w)), "aria-hidden": a(k) }, [j(c.$slots, "default", {}, void 0, true)], 14, Y)]), _: 3 }, 8, ["container", "to"])], 4));
...
const Ce = ["Default", "PaneAnchoringLoadingTransition", "TwoPaneLayout"];
export {
  d as Default,
