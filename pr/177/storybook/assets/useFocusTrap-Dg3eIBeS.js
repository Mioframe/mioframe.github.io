...
var fe = ["input:not([inert]):not([inert] *)", "select:not([inert]):not([inert] *)", "textarea:not([inert]):not([inert] *)", "a[href]:not([inert]):not([inert] *)", "area[href]:not([inert]):not([inert] *)", "button:not([inert]):not([inert] *)", "[tabindex]:not(slot):not([inert]):not([inert] *)", "audio[controls]:not([inert]):not([inert] *)", "video[controls]:not([inert]):not([inert] *)", '[contenteditable]:not([contenteditable="false"]):not([inert]):not([inert] *)', "details>summary:first-of-type:not([inert]):not([inert] *)", "details:not([inert]):not([inert] *)"], M = fe.join(","), de = typeof Element > "u", O = de ? function() {
  ...
  var h = O.call(e, "details>summary:first-of-type"), w = h ? e.parentElement : e;
  if (O.call(w, "details:not([open]) *")) return true;
  ...
  if (/^(INPUT|BUTTON|SELECT|TEXTAREA)$/.test(e.tagName)) for (var t = e.parentElement; t; ) {
    if (t.tagName === "FIELDSET" && t.disabled) {
      for (var r = 0; r < t.children.length; r++) {
        ...
        if (u.tagName === "LEGEND") return O.call(t, "fieldset[disabled] *") ? true : !u.contains(e);
      }
      return true;
    }
    t = t.parentElement;
  ...
  return O.call(e, M) === false ? false : Z(t, e);
}, Ve = fe.concat("iframe:not([inert]):not([inert] *)").join(","), H = function(e, t) {
  if (t = t || {}, !e) throw new Error("No node provided");
  return O.call(e, Ve) === false ? false : q(t, e);
};
function z(n, e) {
...
var k = { getActiveTrap: function(e) {
  ...
  var r = t?.document || document, u = t?.trapStack || et, s = le({ returnFocusOnDeactivate: true, escapeDeactivates: true, delayInitialFocus: true, delayReturnFocus: true, isolateSubtrees: false, isKeyForward: $e, isKeyBackward: Qe }, t), a = { containers: [], containerGroups: [], tabbableGroups: [], adjacentElements: /* @__PURE__ */ new Set(), alreadySilent: /* @__PURE__ */ new Set(), nodeFocusedBeforeActivation: null, mostRecentlyFocusedNode: null, active: false, paused: false, manuallyPaused: false, delayInitialFocusTimer: void 0, recentNavEvent: void 0 }, c, h = function(i, o, l) {
    ...
    if (i !== false && i !== m(document)) {
      ...
      i.focus({ preventScroll: !!s.preventScroll }), a.mostRecentlyFocusedNode = i, Je(i) && i.select();
    }
  }, J = function(i) {
    ...
    if (a.tabbableGroups.length > 0) {
      ...
      if (f < 0) d ? y = a.tabbableGroups[a.tabbableGroups.length - 1].lastTabbableNode : y = a.tabbableGroups[0].firstTabbableNode;
        ...
        if (b < 0 && (p.container === o || H(o, s.tabbableOptions) && !C(o, s.tabbableOptions) && !p.nextTabbableNode(o, false)) && (b = f), b >= 0) {
        ...
        if (E < 0 && (p.container === o || H(o, s.tabbableOptions) && !C(o, s.tabbableOptions) && !p.nextTabbableNode(o)) && (E = f), E >= 0) {
    ...
    if (l || o instanceof Document) l && (a.mostRecentlyFocusedNode = o);
      ...
      d && (v = X({ target: a.mostRecentlyFocusedNode, isBackward: s.isKeyBackward(a.recentNavEvent) })), R(v || a.mostRecentlyFocusedNode || T());
    }
    a.recentNavEvent = void 0;
  }, me = function(i) {
    var o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false;
    a.recentNavEvent = i;
    var l = X({ event: i, isBackward: o });
    l && (x(i) && i.preventDefault(), R(l));
  }, Q = function(i) {
    (s.isKeyForward(i) || s.isKeyBackward(i)) && me(i, s.isKeyBackward(i));
  }, ee = function(i) {
    Xe(i) && j(s.escapeDeactivates, i) !== false && (i.preventDefault(), c.deactivate());
  }, te = function(i) {
    var o = K(i);
    ...
    if (a.active) {
      ...
      }) : R(T()), r.addEventListener("focusin", $, true), r.addEventListener("mousedown", B, { capture: true, passive: false }), r.addEventListener("touchstart", B, { capture: true, passive: false }), r.addEventListener("click", te, { capture: true, passive: false }), r.addEventListener("keydown", Q, { capture: true, passive: false }), r.addEventListener("keydown", ee), i;
    }
  }, ge = function(i) {
    ...
    if (a.active) return r.removeEventListener("focusin", $, true), r.removeEventListener("mousedown", B, true), r.removeEventListener("touchstart", B, true), r.removeEventListener("click", te, true), r.removeEventListener("keydown", Q, true), r.removeEventListener("keydown", ee), c;
  }, we = function(i) {
  ...
  return c = { get active() {
    ...
    l?.({ trap: c });
    var p = function() {
      f && R(J(a.nodeFocusedBeforeActivation)), v?.({ trap: c });
    }, b = function() {
      y && f ? ce(p) : p();
    };
    return f && d ? (d(J(a.nodeFocusedBeforeActivation)).then(b, b), this) : (b(), this);
  }, pause: function(i) {
