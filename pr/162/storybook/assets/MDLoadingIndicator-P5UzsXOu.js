import { d as $i, O as ki, f as Ei, H as Si, u as _s, b as at, o as Mi } from "./iframe-aWYE055N.js";
import { _ as Li } from "./_plugin-vue_export-helper-DlAUqK2U.js";
function f(o2, e, t, s) {
  ...
  else for (var d = o2.length - 1; d >= 0; d--) (l = o2[d]) && (r = (n < 3 ? l(r) : n > 3 ? l(e, t, r) : l(e, t)) || r);
...
const dt = globalThis, ms = dt.ShadowRoot && (dt.ShadyCSS === void 0 || dt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, us = /* @__PURE__ */ Symbol(), Cs = /* @__PURE__ */ new WeakMap();
let Us = class {
  constructor(e, t, s) {
...
}, ws = ms ? (o2) => o2 : (o2) => o2 instanceof CSSStyleSheet ? ((e) => {
  let t = "";
  for (const s of e.cssRules) t += s.cssText;
  return i(t);
})(o2) : o2;
const { is: zi, defineProperty: Hi, getOwnPropertyDescriptor: Ti, getOwnPropertyNames: Fi, getOwnPropertySymbols: Pi, getPrototypeOf: Di } = Object, Rt = globalThis, $s = Rt.trustedTypes, Wi = $s ? $s.emptyScript : "", Ri = Rt.reactiveElementPolyfillSupport, Ne = (o2, e) => o2, Tt = { toAttribute(o2, e) {
  switch (e) {
    case Boolean:
      o2 = o2 ? Wi : null;
      break;
  ...
  return t;
} }, fs = (o2, e) => !zi(o2, e), ks = { attribute: true, type: String, converter: Tt, reflect: false, useDefault: false, hasChanged: fs };
...
let ve = class extends HTMLElement {
  ...
  static getPropertyDescriptor(e, t, s) {
    const { get: n, set: r } = Ti(this.prototype, e) ?? { get() {
      return this[t];
    }, set(l) {
      this[t] = l;
    } };
    return { get: n, set(l) {
      const d = n?.call(this);
      r?.call(this, l), this.requestUpdate(e, d, s);
    }, configurable: true, enumerable: true };
  }
  static getPropertyOptions(e) {
    return this.elementProperties.get(e) ?? ks;
  }
  static _$Ei() {
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const n of s) t.unshift(ws(n));
    } else e !== void 0 && t.push(ws(e));
    return t;
  }
  static _$Eu(e, t) {
    const s = t.attribute;
  ...
  _$AK(e, t) {
    ...
    if (n !== void 0 && this._$Em !== n) {
      const r = s.getPropertyOptions(n), l = typeof r.converter == "function" ? { fromAttribute: r.converter } : r.converter?.fromAttribute !== void 0 ? r.converter : Tt;
      this._$Em = n;
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (s.size > 0) for (const [n, r] of s) {
        ...
        l !== true || this._$AL.has(n) || d === void 0 || this.C(n, void 0, r, d);
      }
    }
    let e = false;
    const t = this._$AL;
...
ve.elementStyles = [], ve.shadowRootOptions = { mode: "open" }, ve[Ne("elementProperties")] = /* @__PURE__ */ new Map(), ve[Ne("finalized")] = /* @__PURE__ */ new Map(), Ri?.({ ReactiveElement: ve }), (Rt.reactiveElementVersions ??= []).push("2.1.2");
const vs = globalThis, Es = (o2) => o2, Ft = vs.trustedTypes, Ss = Ft ? Ft.createPolicy("lit-html", { createHTML: (o2) => o2 }) : void 0, Ns = "$lit$", K = `lit$${Math.random().toFixed(9).slice(2)}$`, Ks = "?" + K, Ii = `<${Ks}>`, ce = document, Ye = () => ce.createComment(""), Ge = (o2) => o2 === null || typeof o2 != "object" && typeof o2 != "function", ys = Array.isArray, Oi = (o2) => ys(o2) || typeof o2?.[Symbol.iterator] == "function", jt = `[ 	
\f\r]`, He = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ms = /-->/g, Ls = />/g, Z = RegExp(`>|${jt}(?:([^\\s"'>=/]+)(${jt}*=${jt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), As = /'/g, zs = /"/g, js = /^(?:script|style|textarea|title)$/i, Bi = (o2) => (e, ...t) => ({ _$litType$: o2, strings: e, values: t }), L = Bi(1), $e = /* @__PURE__ */ Symbol.for("lit-noChange"), C = /* @__PURE__ */ Symbol.for("lit-nothing"), Hs = /* @__PURE__ */ new WeakMap(), ne = ce.createTreeWalker(ce, 129);
function Vs(o2, e) {
...
const Ui = (o2, e) => {
  ...
  for (let d = 0; d < t; d++) {
    const m = o2[d];
    let u, v, h = -1, g = 0;
    for (; g < m.length && (l.lastIndex = g, v = l.exec(m), v !== null); ) g = l.lastIndex, l === He ? v[1] === "!--" ? l = Ms : v[1] !== void 0 ? l = Ls : v[2] !== void 0 ? (js.test(v[2]) && (n = RegExp("</" + v[2], "g")), l = Z) : v[3] !== void 0 && (l = Z) : l === Z ? v[0] === ">" ? (l = n ?? He, h = -1) : v[1] === void 0 ? h = -2 : (h = l.lastIndex - v[2].length, u = v[1], l = v[3] === void 0 ? Z : v[3] === '"' ? zs : As) : l === zs || l === As ? l = Z : l === Ms || l === Ls ? l = He : (l = Z, n = void 0);
    const y = l === Z && o2[d + 1].startsWith("/>") ? " " : "";
    r += l === He ? m + Ii : h >= 0 ? (s.push(u), m.slice(0, h) + Ns + m.slice(h) + K + y) : m + K + (h === -2 ? d : y);
  }
  return [Vs(o2, r + (o2[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), s];
};
class Qe {
  constructor({ strings: e, _$litType$: t }, s) {
    ...
    this.parts = [];
    let r = 0, l = 0;
    const d = e.length - 1, m = this.parts, [u, v] = Ui(e, t);
    if (this.el = Qe.createElement(u, s), ne.currentNode = this.el.content, t === 2 || t === 3) {
      const h = this.el.content.firstChild;
      h.replaceWith(...h.childNodes);
    }
    for (; (n = ne.nextNode()) !== null && m.length < d; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const h of n.getAttributeNames()) if (h.endsWith(Ns)) {
          const g = v[l++], y = n.getAttribute(h).split(K), w = /([.?@])?(.*)/.exec(g);
          m.push({ type: 1, index: r, name: w[2], strings: y, ctor: w[1] === "." ? Ki : w[1] === "?" ? ji : w[1] === "@" ? Vi : It }), n.removeAttribute(h);
        } else h.startsWith(K) && (m.push({ type: 6, index: r }), n.removeAttribute(h));
        if (js.test(n.tagName)) {
          const h = n.textContent.split(K), g = h.length - 1;
          if (g > 0) {
            n.textContent = Ft ? Ft.emptyScript : "";
            for (let y = 0; y < g; y++) n.append(h[y], Ye()), ne.nextNode(), m.push({ type: 2, index: ++r });
            n.append(h[g], Ye());
          }
        }
      } else if (n.nodeType === 8) if (n.data === Ks) m.push({ type: 2, index: r });
      else {
        let h = -1;
        for (; (h = n.data.indexOf(K, h + 1)) !== -1; ) m.push({ type: 7, index: r }), h += K.length - 1;
      }
      r++;
    }
  }
...
class Ni {
  ...
  u(e) {
    ...
    ne.currentNode = n;
    let r = ne.nextNode(), l = 0, d = 0, m = s[0];
    for (; m !== void 0; ) {
      if (l === m.index) {
        let u;
        m.type === 2 ? u = new nt(r, r.nextSibling, this, e) : m.type === 1 ? u = new m.ctor(r, m.name, m.strings, this, e) : m.type === 6 && (u = new qi(r, this, e)), this._$AV.push(u), m = s[++d];
      }
...
class nt {
  ...
  _$AI(e, t = this) {
    e = ke(this, e, t), Ge(e) ? e === C || e == null || e === "" ? (this._$AH !== C && this._$AR(), this._$AH = C) : e !== this._$AH && e !== $e && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Oi(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  $(e) {
    const { values: t, _$litType$: s } = e, n = typeof s == "number" ? this._$AC(e) : (s.el === void 0 && (s.el = Qe.createElement(Vs(s.h, s.h[0]), this.options)), s);
    if (this._$AH?._$AD === n) this._$AH.p(t);
    else {
      const r = new Ni(n, this), l = r.u(this.options);
      r.p(t), this.T(l), this._$AH = r;
    }
  }
  _$AC(e) {
    let t = Hs.get(e.strings);
    return t === void 0 && Hs.set(e.strings, t = new Qe(e)), t;
  }
  k(e) {
...
class It {
  ...
  _$AI(e, t = this, s, n) {
    ...
    if (r === void 0) e = ke(this, e, t, 0), l = !Ge(e) || e !== this._$AH && e !== $e, l && (this._$AH = e);
      ...
      const d = e;
      let m, u;
      for (e = r[0], m = 0; m < r.length - 1; m++) u = ke(this, d[s + m], t, m), u === $e && (u = this._$AH[m]), l ||= !Ge(u) || u !== this._$AH[m], u === C ? e = C : e !== C && (e += (u ?? "") + r[m + 1]), this._$AH[m] = u;
    }
    l && !n && this.j(e);
  }
  j(e) {
...
const Zi = vs.litHtmlPolyfillSupport;
Zi?.(Qe, nt), (vs.litHtmlVersions ??= []).push("3.3.3");
const Xi = (o2, e, t) => {
...
const Yi = gs.litElementPolyfillSupport;
Yi?.({ LitElement: E });
(gs.litElementVersions ??= []).push("4.2.2");
const Gi = { attribute: true, type: String, converter: Tt, reflect: false, hasChanged: fs }, Qi = (o2 = Gi, e, t) => {
  ...
  if (r === void 0 && globalThis.litPropertyMetadata.set(n, r = /* @__PURE__ */ new Map()), s === "setter" && ((o2 = Object.create(o2)).wrapped = true), r.set(t.name, o2), s === "accessor") {
    ...
    return { set(d) {
      ...
      e.set.call(this, d), this.requestUpdate(l, m, o2, true, d);
    }, init(d) {
      return d !== void 0 && this.C(l, void 0, o2, d), d;
    } };
  }
  if (s === "setter") {
    const { name: l } = t;
    return function(d) {
      const m = this[l];
      e.call(this, d), this.requestUpdate(l, m, o2, true, d);
    };
  }
  throw Error("Unsupported decorator location: " + s);
};
function x(o2) {
  return (e, t) => typeof t == "object" ? Qi(o2, e, t) : ((s, n, r) => {
    const l = n.hasOwnProperty(r);
    return n.constructor.createProperty(r, s), l ? Object.getOwnPropertyDescriptor(n, r) : void 0;
  })(o2, e, t);
}
const Ji = (o2, e, t) => (t.configurable = true, t.enumerable = true, Reflect.decorate && typeof e != "object" && Object.defineProperty(o2, e, t), t);
function Ot(o2, e) {
  return (t, s, n) => {
...
function sn(o2, e) {
  ...
  for (const h of t) if (h.type === "M") s = { x: h.nums[0], y: h.nums[1] }, n = s;
    ...
    const g = { x: h.nums[0], y: h.nums[1] }, y = g.x - s.x, w = g.y - s.y;
    ...
    const H = 20;
    for (let R = 1; R <= H; R++) {
      const q = R / H, ze = Fs(s, g, y, q);
      w += Math.hypot(ze.x - z.x, ze.y - z.y), z = ze;
    }
    r.push({ type: "Q", pts: [s, g, y], length: w }), s = y;
  } else if (h.type === "C") {
    const g = { x: h.nums[0], y: h.nums[1] }, y = { x: h.nums[2], y: h.nums[3] }, w = { x: h.nums[4], y: h.nums[5] };
    let z = 0, H = s;
    const R = 20;
    for (let q = 1; q <= R; q++) {
      const ze = q / R, Kt = Ps(s, g, y, w, ze);
      z += Math.hypot(Kt.x - H.x, Kt.y - H.y), H = Kt;
    }
  ...
  const d = r.reduce((h, g) => h + g.length, 0) / (e - 1), m = [];
  let u = 0, v = 0;
  for (let h = 0; h < e; h++) {
    const g = h * d;
    ...
    if (y.type === "L") {
      const [z, H] = y.pts;
      m.push({ x: Ts(z.x, H.x, w), y: Ts(z.y, H.y, w) });
    } else if (y.type === "Q") {
      const [z, H, R] = y.pts;
      m.push(Fs(z, H, R, w));
    } else if (y.type === "C") {
...
function nn(o2) {
  return `${o2.map((t) => {
    const s = Ds(t.x * 100, 0, 100), n = Ds(t.y * 100, 0, 100);
...
function rn(o2, e) {
  ...
  for (let r = 0; r < t; r++) {
    let l = 0;
    for (let d = 0; d < t; d++) {
      const m = e[(d + r) % t], u = o2[d], v = m.x - u.x, h = m.y - u.y;
...
function ln(o2) {
  const e = o2.map((n) => {
    const r = on(n), l = n.map((y) => ({ x: y.x - r.minX, y: y.y - r.minY })), d = Math.max(r.width, r.height) || 1, m = l.map((y) => ({ x: y.x / d, y: y.y / d })), u = r.width / d, v = r.height / d, h = (1 - u) / 2, g = (1 - v) / 2;
    return m.map((y) => ({ x: y.x + h, y: y.y + g }));
  }), t = e[0], s = Math.sign(Ws(t));
  for (let n = 1; n < e.length; n++) {
    let r = e[n];
    const l = Math.sign(Ws(r));
...
function cn(o2, e) {
  return ln(o2.map((t) => sn(t, e))).map((t) => nn(t));
}
function Nn(o2) {
...
var xe, oe, Ce, Ke, _e, ht, pt, mt, ut, ye, Pt, qs, ss, Zs;
class Bt extends ot {
  constructor(e, t) {
    super(e, t), xe.add(this), Ce.set(this, false), Ke.set(this, void 0), _e.set(this, void 0), ht.set(this, (s) => a(this, xe, "m", qs).call(this, s)), pt.set(this, (s) => a(this, xe, "m", ss).call(this, s)), mt.set(this, (s) => a(this, xe, "m", Zs).call(this, s)), ut.set(this, () => b(this, Ce, true, "f")), ye.set(this, () => b(this, Ce, false, "f")), b(this, Ke, t.callback, "f"), b(this, _e, t.filter, "f");
  }
  _observe(e) {
    e.addEventListener("keydown", a(this, ht, "f")), e.addEventListener("focusin", a(this, pt, "f")), e.addEventListener("focusout", a(this, mt, "f")), e.addEventListener("touchstart", a(this, ut, "f"), { passive: true }), e.addEventListener("touchend", a(this, ye, "f")), e.addEventListener("touchcancel", a(this, ye, "f"));
  }
  _unobserve(e) {
    e.removeEventListener("keydown", a(this, ht, "f")), e.removeEventListener("focusin", a(this, pt, "f")), e.removeEventListener("focusout", a(this, mt, "f")), e.removeEventListener("touchstart", a(this, ut, "f")), e.removeEventListener("touchend", a(this, ye, "f")), e.removeEventListener("touchcancel", a(this, ye, "f"));
  }
}
oe = Bt, Ce = /* @__PURE__ */ new WeakMap(), Ke = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), ht = /* @__PURE__ */ new WeakMap(), pt = /* @__PURE__ */ new WeakMap(), mt = /* @__PURE__ */ new WeakMap(), ut = /* @__PURE__ */ new WeakMap(), ye = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakSet(), qs = function(e) {
  ...
  a(this, Ke, "f").call(this, true, t.matches(":focus-visible") || a(oe, oe, "f", Pt) || en(), t);
}, Zs = function(e) {
  a(this, _e, "f")?.call(this, e) || a(this, Ce, "f") || a(this, Ke, "f").call(this, false, false, e.currentTarget);
};
typeof window < "u" && (window.addEventListener("keydown", () => b(oe, oe, true, "f", Pt), { capture: true, passive: true }), window.addEventListener("pointerdown", () => b(oe, oe, false, "f", Pt), { capture: true }));
Pt = { value: false };
var F, ie, G, Q, ft, ge, is, rt, lt, Xs, Ys;
class Gs extends ot {
  constructor(e, t) {
    super(e, t), F.add(this), ie.set(this, void 0), G.set(this, /* @__PURE__ */ new Map()), Q.set(this, /* @__PURE__ */ new Map()), ft.set(this, (s) => a(this, F, "m", Xs).call(this, s)), ge.set(this, (s) => a(this, F, "m", Ys).call(this, s)), b(this, ie, t.callback, "f"), this.startDelay = t.startDelay ?? 0, this.endDelay = t.endDelay ?? 0;
  }
  clearDelays() {
    for (const e of this.targets) a(this, F, "m", is).call(this, e);
  }
  _observe(e) {
    e.addEventListener("pointerenter", a(this, ft, "f")), e.addEventListener("pointerleave", a(this, ge, "f")), e.addEventListener("touchend", a(this, ge, "f"));
  }
  _unobserve(e) {
    e.removeEventListener("pointerenter", a(this, ft, "f")), e.removeEventListener("pointerleave", a(this, ge, "f")), e.removeEventListener("touchend", a(this, ge, "f")), a(this, F, "m", is).call(this, e);
  }
}
ie = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), ft = /* @__PURE__ */ new WeakMap(), ge = /* @__PURE__ */ new WeakMap(), F = /* @__PURE__ */ new WeakSet(), is = function(e) {
  a(this, F, "m", rt).call(this, e), a(this, F, "m", lt).call(this, e);
}, rt = function(e) {
  ...
  const t = e.target;
  a(this, F, "m", lt).call(this, t), this.startDelay > 0 ? (a(this, F, "m", rt).call(this, t), a(this, G, "f").set(t, setTimeout(() => {
    a(this, G, "f").delete(t), a(this, ie, "f").call(this, true, t);
  }, this.startDelay))) : a(this, ie, "f").call(this, true, t);
}, Ys = function(e) {
  const t = e.target;
  a(this, F, "m", rt).call(this, t) || (this.endDelay > 0 ? (a(this, F, "m", lt).call(this, t), a(this, Q, "f").set(t, setTimeout(() => {
    a(this, Q, "f").delete(t), a(this, ie, "f").call(this, false, t);
  }, this.endDelay))) : a(this, ie, "f").call(this, false, t));
};
var U, S, B, je, ae, M, Ve, vt, yt, be, gt, bt, Qs, Js, ei, ti, si, Zt;
class ii extends ot {
  constructor(e, t) {
    super(e, t), U.add(this), S.set(this, void 0), B.set(this, void 0), je.set(this, void 0), ae.set(this, void 0), M.set(this, /* @__PURE__ */ new Map()), Ve.set(this, void 0), vt.set(this, (s) => a(this, U, "m", Qs).call(this, s)), yt.set(this, (s) => a(this, U, "m", Js).call(this, s)), be.set(this, (s) => a(this, U, "m", ei).call(this, s)), gt.set(this, (s) => a(this, U, "m", ti).call(this, s)), bt.set(this, (s) => a(this, U, "m", si).call(this, s)), b(this, S, t.capture, "f"), b(this, B, t.callback, "f"), b(this, je, t.filter, "f"), b(this, ae, t.isPressedKey, "f"), b(this, Ve, t.minPressedDuration ?? 0, "f");
  }
  hostConnected() {
    document.addEventListener("pointerup", a(this, yt, "f"), { capture: a(this, S, "f") }), document.addEventListener("touchend", a(this, be, "f"), { capture: a(this, S, "f") }), document.addEventListener("touchcancel", a(this, be, "f"), { capture: a(this, S, "f") }), super.hostConnected();
  }
  hostDisconnected() {
    document.removeEventListener("pointerup", a(this, yt, "f"), { capture: a(this, S, "f") }), document.removeEventListener("touchend", a(this, be, "f"), { capture: a(this, S, "f") }), document.removeEventListener("touchcancel", a(this, be, "f"), { capture: a(this, S, "f") }), super.hostDisconnected(), a(this, M, "f").clear();
  }
  _observe(e) {
    e.addEventListener("pointerdown", a(this, vt, "f"), { capture: a(this, S, "f") }), a(this, ae, "f") && (e.addEventListener("keydown", a(this, gt, "f"), { capture: a(this, S, "f") }), e.addEventListener("keyup", a(this, bt, "f"), { capture: a(this, S, "f") }));
  }
  _unobserve(e) {
    e.removeEventListener("pointerdown", a(this, vt, "f"), { capture: a(this, S, "f") }), a(this, ae, "f") && (e.removeEventListener("keydown", a(this, gt, "f"), { capture: a(this, S, "f") }), e.removeEventListener("keyup", a(this, bt, "f"), { capture: a(this, S, "f") }));
  }
}
S = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), je = /* @__PURE__ */ new WeakMap(), ae = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), Ve = /* @__PURE__ */ new WeakMap(), vt = /* @__PURE__ */ new WeakMap(), yt = /* @__PURE__ */ new WeakMap(), be = /* @__PURE__ */ new WeakMap(), gt = /* @__PURE__ */ new WeakMap(), bt = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakSet(), Qs = function(e) {
...
class Kn extends ot {
  constructor(e, t) {
    if (super(e, t), De.set(this, void 0), xt.set(this, void 0), _t.set(this, void 0), J.set(this, void 0), We.set(this, true), b(this, De, t.callback, "f"), b(this, xt, t.skipInitial ?? false, "f"), b(this, _t, t.config, "f"), !window.ResizeObserver) {
  ...
  async hostUpdated() {
    a(this, J, "f") && !a(this, xt, "f") && a(this, We, "f") && a(this, De, "f").call(this, [], a(this, J, "f")), b(this, We, false, "f");
  }
  _observe(e) {
    a(this, J, "f")?.observe(e, a(this, _t, "f")), b(this, We, true, "f");
  }
  _unobserve(e) {
    a(this, J, "f")?.unobserve(e);
  }
}
De = /* @__PURE__ */ new WeakMap(), xt = /* @__PURE__ */ new WeakMap(), _t = /* @__PURE__ */ new WeakMap(), J = /* @__PURE__ */ new WeakMap(), We = /* @__PURE__ */ new WeakMap();
const P = (o2) => (e, t) => {
  const s = () => {
...
function ni(o2) {
  ...
  return (t, s, n) => {
    ...
    return n.value = function(...l) {
      const d = this;
      clearTimeout(d[e]), d[e] = setTimeout(() => r.apply(this, l), o2);
    }, n;
  };
}
var re, Dt, qe, Ct, ee, Rs, Xt, oi, ai;
class hn extends ot {
  constructor(e, t) {
    super(e, t), re.add(this), Dt.set(this, void 0), qe.set(this, void 0), Ct.set(this, (s) => a(this, re, "m", ai).call(this, s)), ee.set(this, /* @__PURE__ */ new Map()), b(this, Dt, t.debounce === true, "f"), b(this, qe, t.callback, "f");
  }
  getScrollContainers(e) {
    return a(this, ee, "f").get(e);
  }
  _observe(e) {
    const t = a(this, re, "m", oi).call(this, e);
    if (t.length > 0) {
      a(this, ee, "f").set(e, t);
      for (const s of t) (s === document.documentElement ? document : s).addEventListener("scroll", a(this, Ct, "f"), { passive: true });
    }
  }
  _unobserve(e) {
    if (a(this, ee, "f").has(e)) {
      for (const t of a(this, ee, "f").get(e)) (t === document.documentElement ? document : t).removeEventListener("scroll", a(this, Ct, "f"));
...
Dt = /* @__PURE__ */ new WeakMap(), qe = /* @__PURE__ */ new WeakMap(), Ct = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakMap(), re = /* @__PURE__ */ new WeakSet(), Rs = function(e) {
  ...
  const t = new Array(), s = a(this, re, "m", Rs).call(this, e);
  s && t.push(s);
  let n = e;
  ...
  a(this, Dt, "f") ? this._debounceCallback(t) : a(this, qe, "f").call(this, t);
};
f([ni(40)], hn.prototype, "_debounceCallback", null);
function ri(o2, ...e) {
  return typeof o2 == "object" && o2 !== null && e.every((t) => t in o2);
}
const j = /* @__PURE__ */ Symbol("internals"), Is = /* @__PURE__ */ Symbol("_internals"), de = /* @__PURE__ */ Symbol("_customState");
function bs(o2, e) {
  var t;
  class s extends o2 {
    constructor() {
    ...
    get [(t = de, j)]() {
      return this[Is] ?? (this[Is] = this.attachInternals());
    }
  }
...
function we(o2, e) {
  li(o2, e) || (de in o2 && o2[de].add(e), o2[j]?.states.add(e), o2[j]?.states.has(e));
}
function O(o2, e) {
...
const Ut = { primary: i("var(--md-sys-color-primary, #6750A4)"), onPrimary: i("var(--md-sys-color-on-primary, #FFFFFF)"), primaryContainer: i("var(--md-sys-color-primary-container, #EADDFF)"), onPrimaryContainer: i("var(--md-sys-color-on-primary-container, #4F378B)"), primaryFixed: i("var(--md-sys-color-primary-fixed, #EADDFF)"), primaryFixedDim: i("var(--md-sys-color-primary-fixed-dim, #D0BCFF)"), onPrimaryFixed: i("var(--md-sys-color-on-primary-fixed, #21005D)"), onPrimaryFixedVariant: i("var(--md-sys-color-on-primary-fixed-variant, #4F378B)"), secondary: i("var(--md-sys-color-secondary, #625B71)"), onSecondary: i("var(--md-sys-color-on-secondary, #FFFFFF)"), secondaryContainer: i("var(--md-sys-color-secondary-container, #E8DEF8)"), onSecondaryContainer: i("var(--md-sys-color-on-secondary-container, #4A4458)"), secondaryFixed: i("var(--md-sys-color-secondary-fixed, #E8DEF8)"), secondaryFixedDim: i("var(--md-sys-color-secondary-fixed-dim, #CCC2DC)"), onSecondaryFixed: i("var(--md-sys-color-on-secondary-fixed, #1D192B)"), onSecondaryFixedVariant: i("var(--md-sys-color-on-secondary-fixed-variant, #4A4458)"), tertiary: i("var(--md-sys-color-tertiary, #7D5260)"), onTertiary: i("var(--md-sys-color-on-tertiary, #FFFFFF)"), tertiaryContainer: i("var(--md-sys-color-tertiary-container, #FFD8E4)"), onTertiaryContainer: i("var(--md-sys-color-on-tertiary-container, #633B48)"), tertiaryFixed: i("var(--md-sys-color-tertiary-fixed, #FFD8E4)"), tertiaryFixedDim: i("var(--md-sys-color-tertiary-fixed-dim, #EFB8C8)"), onTertiaryFixed: i("var(--md-sys-color-on-tertiary-fixed, #31111D)"), onTertiaryFixedVariant: i("var(--md-sys-color-on-tertiary-fixed-variant, #633B48)"), error: i("var(--md-sys-color-error, #B3261E)"), onError: i("var(--md-sys-color-on-error, #FFFFFF)"), errorContainer: i("var(--md-sys-color-error-container, #F9DEDC)"), onErrorContainer: i("var(--md-sys-color-on-error-container, #8C1D18)"), surface: i("var(--md-sys-color-surface, #FEF7FF)"), onSurface: i("var(--md-sys-color-on-surface, #1D1B20)"), onSurfaceVariant: i("var(--md-sys-color-on-surface-variant, #49454F)"), surfaceContainerLowest: i("var(--md-sys-color-surface-container-lowest, #FFFFFF)"), surfaceContainerLow: i("var(--md-sys-color-surface-container-low, #F7F2FA)"), surfaceContainer: i("var(--md-sys-color-surface-container, #F3EDF7)"), surfaceContainerHigh: i("var(--md-sys-color-surface-container-high, #ECE6F0)"), surfaceContainerHighest: i("var(--md-sys-color-surface-container-highest, #E6E0E9)"), surfaceDim: i("var(--md-sys-color-surface-dim, #DED8E1)"), surfaceBright: i("var(--md-sys-color-surface-bright, #FEF7FF)"), surfaceVariant: i("var(--md-sys-color-surface-variant, #E7E0EC)"), inverseSurface: i("var(--md-sys-color-inverse-surface, #322F35)"), inverseOnSurface: i("var(--md-sys-color-inverse-on-surface, #F5EFF7)"), inversePrimary: i("var(--md-sys-color-inverse-primary, #D0BCFF)"), outline: i("var(--md-sys-color-outline, #79747E)"), outlineVariant: i("var(--md-sys-color-outline-variant, #CAC4D0)"), shadow: i("var(--md-sys-color-shadow, #000000)"), scrim: i("var(--md-sys-color-scrim, #000000)") }, Yt = { scale: i("var(--md-sys-density-scale, 0)"), size: i("var(--md-sys-density-size, 0.25rem)") }, mn = { ...Yt, calc(o2) {
  return i(`calc(max(${o2}, ${Yt.scale}) * ${Yt.size})`);
} }, un = `color-mix(in srgb, var(--m3e-elevation-color, ${Ut.shadow}) 20%, transparent)`, fn = ["0px 0px 0px 0px", "0px 2px 1px -1px", "0px 3px 1px -2px", "0px 3px 3px -2px", "0px 2px 4px -1px", "0px 3px 5px -1px", "0px 3px 5px -1px", "0px 4px 5px -2px", "0px 5px 5px -3px", "0px 5px 6px -3px", "0px 6px 6px -3px", "0px 6px 7px -4px", "0px 7px 8px -4px", "0px 7px 8px -4px", "0px 7px 9px -4px", "0px 8px 9px -5px", "0px 8px 10px -5px", "0px 8px 11px -5px", "0px 9px 11px -5px", "0px 9px 12px -6px", "0px 10px 13px -6px", "0px 10px 13px -6px", "0px 10px 14px -6px", "0px 11px 14px -7px", "0px 11px 15px -7px"], vn = `color-mix(in srgb, var(--m3e-elevation-color, ${Ut.shadow}) 14%, transparent)`, yn = ["0px 0px 0px 0px", "0px 1px 1px 0px", "0px 2px 2px 0px", "0px 3px 4px 0px", "0px 4px 5px 0px", "0px 5px 8px 0px", "0px 6px 10px 0px", "0px 7px 10px 1px", "0px 8px 10px 1px", "0px 9px 12px 1px", "0px 10px 14px 1px", "0px 11px 15px 1px", "0px 12px 17px 2px", "0px 13px 19px 2px", "0px 14px 21px 2px", "0px 15px 22px 2px", "0px 16px 24px 2px", "0px 17px 26px 2px", "0px 18px 28px 2px", "0px 19px 29px 2px", "0px 20px 31px 3px", "0px 21px 33px 3px", "0px 22px 35px 3px", "0px 23px 36px 3px", "0px 24px 38px 3px"], gn = `color-mix(in srgb, var(--m3e-elevation-color, ${Ut.shadow}) 12%, transparent)`, bn = ["0px 0px 0px 0px", "0px 1px 3px 0px", "0px 1px 5px 0px", "0px 1px 8px 0px", "0px 1px 10px 0px", "0px 1px 14px 0px", "0px 1px 18px 0px", "0px 2px 16px 1px", "0px 3px 14px 2px", "0px 3px 16px 2px", "0px 4px 18px 3px", "0px 4px 20px 3px", "0px 5px 22px 4px", "0px 5px 24px 4px", "0px 5px 26px 4px", "0px 6px 28px 5px", "0px 6px 30px 5px", "0px 6px 32px 5px", "0px 7px 34px 6px", "0px 7px 36px 6px", "0px 8px 38px 7px", "0px 8px 40px 7px", "0px 8px 42px 7px", "0px 9px 44px 8px", "0px 9px 46px 8px"];
function me(o2) {
  return `${un} ${fn[o2]},${vn} ${yn[o2]},${gn} ${bn[o2]}`;
}
const xn = { level0: i(`var(--md-sys-elevation-level0, ${me(0)})`), level1: i(`var(--md-sys-elevation-level1, ${me(1)})`), level2: i(`var(--md-sys-elevation-level2, ${me(3)})`), level3: i(`var(--md-sys-elevation-level3, ${me(6)})`), level4: i(`var(--md-sys-elevation-level4, ${me(8)})`), level5: i(`var(--md-sys-elevation-level5, ${me(12)})`) };
function $(o2) {
...
function et(o2) {
  return ri(o2, "disabledInteractive") && Je(o2);
}
const Os = ["click", "dblclick", "auxclick", "keydown", "keyup"], Ln = ["Tab", "ArrowLeft", "ArrowUp", "ArrowRight", "ArrowDown", "Left", "Up", "Right", "Down"], Gt = /* @__PURE__ */ Symbol("_suppressedEventHandler");
function jn(o2) {
  var e;
  class t extends o2 {
    constructor() {
    ...
    connectedCallback() {
      Os.forEach((n) => this.addEventListener(n, this[Gt], true)), super.connectedCallback();
    }
    disconnectedCallback() {
      Os.forEach((n) => this.removeEventListener(n, this[Gt], true)), super.disconnectedCallback();
    }
    update(n) {
...
function Zn(o2, e = true) {
  var t, s, n, r, l, d, m;
  class u extends o2 {
    constructor() {
      super(...arguments), t.add(this), s.set(this, false), n.set(this, (h) => a(this, t, "m", d).call(this, h)), r.set(this, (h) => a(this, t, "m", m).call(this, h)), l.set(this, () => b(this, s, false, "f"));
    }
    connectedCallback() {
  ...
  return s = /* @__PURE__ */ new WeakMap(), n = /* @__PURE__ */ new WeakMap(), r = /* @__PURE__ */ new WeakMap(), l = /* @__PURE__ */ new WeakMap(), t = /* @__PURE__ */ new WeakSet(), d = function(h) {
    if (h.target !== h.currentTarget || Je(this) && this.disabled || et(this) && this.disabledInteractive) {
      b(this, s, false, "f");
      return;
    }
    (h.key === " " || e && h.key === "Enter") && b(this, s, true, "f");
  }, m = function(h) {
    if (h.target !== h.currentTarget || Je(this) && this.disabled || et(this) && this.disabledInteractive || !a(this, s, "f")) {
      b(this, s, false, "f");
      return;
    }
...
const An = /* @__PURE__ */ Symbol("renderPseudoLink"), es = /* @__PURE__ */ Symbol("_clickHandler");
function Xn(o2, e = false) {
  var t, s, n, r, l;
  class d extends o2 {
    constructor() {
    ...
    [(t = /* @__PURE__ */ new WeakSet(), l = es, An)]() {
...
class Hn extends E {
  ...
  connectedCallback() {
    super.connectedCallback(), this.parentElement?.addEventListener("click", a(this, wt, "f"));
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.parentElement?.removeEventListener("click", a(this, wt, "f"));
  }
  render() {
    return L`<slot></slot>`;
  }
...
Hn.styles = A`:host { display: contents; } ::slotted(.material-icons) { font-size: inherit !important; }`;
var T, Ze, Re, hi, Ie, Oe, os;
let Ee = class extends bs(E) {
  ...
  render() {
    return L`<slot @slotchange="${a(this, T, "m", hi)}"></slot>`;
  }
};
...
var Be, $t, kt, Et, pi, mi, ui;
let Se = class extends Nt(pe(E, "none")) {
  constructor() {
    super(...arguments), Be.add(this), $t.set(this, new Gs(this, { target: null, callback: (e) => a(this, Be, "m", pi).call(this, e) })), kt.set(this, new Bt(this, { target: null, callback: (e) => a(this, Be, "m", mi).call(this, e) })), Et.set(this, new ii(this, { target: null, callback: (e) => a(this, Be, "m", ui).call(this, e) })), this.disabled = false, this.level = null;
  }
  attach(e) {
    super.attach(e), a(this, $t, "f").observe(e), a(this, kt, "f").observe(e), a(this, Et, "f").observe(e);
  }
  detach() {
    this.control && (a(this, $t, "f").unobserve(this.control), a(this, kt, "f").unobserve(this.control), a(this, Et, "f").unobserve(this.control)), super.detach();
  }
  connectedCallback() {
...
f([Ot(".shadow")], Se.prototype, "_shadow", void 0);
...
var as, St, fi;
let Me = class extends Nt(pe(E, "none")) {
  constructor() {
    super(...arguments), as.add(this), St.set(this, new Bt(this, { target: null, callback: (e, t) => a(this, as, "m", fi).call(this, t) })), this.inward = false, this.disabled = false;
  }
  show() {
...
f([Ot(".outline")], Me.prototype, "_outline", void 0);
...
let rs = class extends pn(di(pe(E, "none"))) {
  connectedCallback() {
...
let ls = class extends ci(di(pe(E, "none"))) {
  connectedCallback() {
    super.connectedCallback(), this.ariaHidden = "true";
  }
  render() {
...
const ct = { color: i(`var(--m3e-ripple-color, ${c.color.onSurface})`), opacity: i(`var(--m3e-ripple-opacity, ${c.state.pressedStateLayerOpacity})`), enterDuration: i(`var(--m3e-ripple-enter-duration, ${c.motion.duration.long1})`), exitDuration: i(`var(--m3e-ripple-exit-duration, ${c.motion.duration.medium3})`) };
var te, k, Mt, Lt, vi, yi;
let he = class extends Nt(pe(E, "none")) {
  constructor() {
    super(...arguments), te.add(this), k.set(this, null), Mt.set(this, new ii(this, { target: null, minPressedDuration: 225, isPressedKey: (e) => e === " ", callback: (e, { x: t, y: s }) => a(this, te, "m", yi).call(this, e, t, s) })), this.disabled = false, this.centered = false, this.unbounded = false, this.radius = null;
  }
  get visible() {
    return a(this, k, "f") !== null;
  }
  show(e, t, s = false) {
    a(this, te, "m", Lt).call(this);
    ...
    b(this, k, document.createElement("div"), "f"), a(this, k, "f").classList.add("ripple"), s && a(this, k, "f").classList.add("persistent"), a(this, k, "f").style.left = `${l - r}px`, a(this, k, "f").style.top = `${d - r}px`, a(this, k, "f").style.width = `${r * 2}px`, a(this, k, "f").style.height = `${r * 2}px`, a(this, k, "f").addEventListener("animationend", () => a(this, te, "m", vi).call(this, s), { once: true }), a(this, k, "f").addEventListener("transitionend", () => a(this, te, "m", Lt).call(this), { once: true }), this.shadowRoot?.appendChild(a(this, k, "f"));
  }
  hide() {
    a(this, k, "f")?.classList.add("exit");
  }
  attach(e) {
    super.attach(e), a(this, Mt, "f").observe(e);
  }
  detach() {
    this.control && a(this, Mt, "f").unobserve(this.control), super.detach();
  }
  connectedCallback() {
    this.ariaHidden = "true", super.connectedCallback();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), a(this, te, "m", Lt).call(this);
  }
  updated(e) {
    super.updated(e), e.has("disabled") && this.disabled && this.hide();
  }
...
f([ni(40)], Le.prototype, "_updateScroll", null);
Le = f([P("m3e-scroll-container")], Le);
var Xe, le, gi, xs;
let Wt = class extends bs(E) {
  constructor() {
  ...
  update(e) {
    super.update(e), e.has("selectedIndex") && (this.selectedIndex === null && we(this, "--no-animate"), a(this, Xe, "m", xs).call(this), this.selectedIndex !== null && li(this, "--no-animate") && requestAnimationFrame(() => {
      this.selectedIndex !== null && O(this, "--no-animate");
    }));
  }
  render() {
    return L`<slot @slotchange="${a(this, Xe, "m", gi)}"></slot>`;
  }
};
...
Wt.styles = A`:host { display: flex; position: relative; overflow: hidden; } ::slotted(*) { width: 100%; top: 0; transition: ${i(`inset-inline-start var(--m3e-slide-animation-duration, ${c.motion.duration.long2}) ${c.motion.easing.standard},
...
f([x({ attribute: "selected-index", type: Number, reflect: true })], Wt.prototype, "selectedIndex", void 0);
Wt = f([P("m3e-slide")], Wt);
...
var At, zt, Ht, bi, xi;
let Ae = class extends Nt(pe(E, "none")) {
  constructor() {
    super(...arguments), At.add(this), zt.set(this, new Gs(this, { target: null, callback: (e) => a(this, At, "m", bi).call(this, e) })), Ht.set(this, new Bt(this, { target: null, callback: (e, t) => a(this, At, "m", xi).call(this, t) })), this.disabled = false, this.disableHover = false;
  }
  show(e) {
  ...
  attach(e) {
    super.attach(e), a(this, zt, "f").observe(e), a(this, Ht, "f").observe(e);
  }
  detach() {
    this.control && (a(this, zt, "f").unobserve(this.control), a(this, Ht, "f").unobserve(this.control)), super.detach();
  }
  connectedCallback() {
    this.ariaHidden = "true", super.connectedCallback();
  }
...
f([Ot(".layer")], Ae.prototype, "_layer", void 0);
...
ds = function() {
  ...
  const e = new Array();
  if (a(this, N, "m", _i).call(this, this, e), e.length > 0) {
      ...
      case "ends-with":
        {
          ...
          if (n.endsWith(t)) {
            const r = n.length - t.length, l = r + t.length, d = new Range();
            d.setStart(s, r), d.setEnd(s, l), a(this, W, "f").push(d);
          }
        }
        break;
      case "contains":
        b(this, W, e.map((s) => ({ el: s, text: (this.caseSensitive ? s.textContent : s.textContent?.toLowerCase()) ?? "" })).map(({ el: s, text: n }) => {
          ...
          for (; l < n.length; ) {
            ...
            if (d === -1) break;
            r.push(d), l = d + t.length;
          }
          return r.map((d) => {
            const m = new Range();
            return m.setStart(s, d), m.setEnd(s, d + t.length), m;
          });
        }).flat(), "f");
        break;
    }
...
f([Ot(".container")], it.prototype, "_container", void 0);
f([x({ reflect: true })], it.prototype, "variant", void 0);
it = f([P("m3e-loading-indicator")], it);
const Tn = ["aria-label"], Fn = 24, Pn = 240, Dn = 48, Wn = 38 / 48, Rn = $i({ inheritAttrs: false, __name: "MDLoadingIndicator", props: { label: {}, size: { default: 48 } }, setup(o2) {
  const e = o2, t = at(() => Number.isFinite(e.size) ? Math.min(Pn, Math.max(Fn, e.size)) : Dn), s = at(() => t.value * Wn), n = at(() => ({ width: `${t.value}px`, height: `${t.value}px`, "--m3e-loading-indicator-size": `${s.value}px` })), r = ki(), l = at(() => {
    const d = {};
    for (const [m, u] of Object.entries(r)) (m === "id" || m === "title" || m === "aria-hidden" || m === "aria-describedby" || m.startsWith("data-")) && (d[m] = u);
    return d;
  });
  return (d, m) => (Mi(), Ei("m3e-loading-indicator", Si(l.value, { class: ["md-loading-indicator", _s(r).class], "aria-label": e.label, style: [_s(r).style, n.value] }), null, 16, Tn));
} }), lo = Li(Rn, [["__scopeId", "data-v-68d6467a"]]);
export {
  bs as A,
  c as D,
  qn as F,
