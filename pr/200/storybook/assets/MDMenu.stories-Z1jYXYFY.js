import { d as v, S as R, u as O, A as x, H as T, o as a, c as b, F as _, b as C, a as f, e as o, j as D, t as U, f as h, w as I, g as $, T as g, i as E, C as P, h as N, Q as V, l as F, U as j, r as H } from "./iframe-DcWzJXd9.js";
import { M as B } from "./MDSymbol-CKADLdTI.js";
import { u as q, a as A, M as Q } from "./useStateLayer-CckaQlVX.js";
import { u as z, M as L } from "./MDMenuItemBase.vue_vue_type_style_index_0_scoped_fc574696_lang-DlCkKQQE.js";
import { _ as G } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { M as J } from "./MDButton-BptFyag1.js";
...
import "./useFocusTrap-BN_ffqSt.js";
...
import "./MDLoadingIndicator-B51HU-yp.js";
const K = ["role"], X = { key: 0, class: "md-menu-item-base__leading" }, Y = { class: "md-menu-item-base__label" }, Z = { key: 1, class: "md-menu-item-base__trailing" }, ee = v({ __name: "MDMenuItemBase", props: g({ label: {}, itemRole: {}, symbolName: {} }, { showSubmenu: { type: Boolean }, showSubmenuModifiers: {} }), emits: g(["click"], ["update:showSubmenu"]), setup(e, { emit: r }) {
  ...
  return z(t, y), (M, c) => (a(), b(_, null, [C("button", { ref_key: "menuItemEl", ref: s, type: "button", class: "md-menu-item-base", role: e.itemRole ?? void 0, onClick: d }, [f(o(Q), { hover: o(w), focused: o(k), pressed: o(S) }, null, 8, ["hover", "focused", "pressed"]), e.symbolName ? (a(), b("span", X, [f(o(B), { name: e.symbolName }, null, 8, ["name"])])) : D("", true), C("span", Y, U(o(t)), 1), m.submenu ? (a(), b("span", Z, [f(o(B), { name: "arrow_right" })])) : D("", true)], 8, K), m.submenu ? (a(), h(L, { key: 0, show: u.value, "onUpdate:show": c[0] || (c[0] = (W) => u.value = W), target: s.value, "disabled-teleport": "", placement: "right-start" }, { default: I(() => [$(M.$slots, "submenu", {}, void 0, true)]), _: 3 }, 8, ["show", "target"])) : D("", true)], 64));
} }), te = G(ee, [["__scopeId", "data-v-fc574696"]]), oe = v({ __name: "MDMenuItem", props: { item: {}, itemRole: { default: "menuitem" } }, emits: ["click"], setup(e, { emit: r }) {
  const n = e, i = r, l = (t) => {
    i("click", t ?? n.item);
  }, m = (t) => {
    l(t);
...
} }), _e = { title: "shared/ui/MDMenu", parameters: { layout: "centered" } }, p = { tags: ["visual"], render: () => ({ components: { MDMenuWithSubmenuStory: se }, template: "<MDMenuWithSubmenuStory />" }) };
