import { d as V, R as G, D as A, B as J, l as g, c as p, w as B, u as t, S as N, j as L, o as s, h as W, f as C, g as y, t as Q, n as D, A as k, E as w, k as X, U as Z, b as d, r as H, p as R } from "./iframe-DV-apvGh.js";
import { M as ee } from "./MDCircularProgressIndicator-B7dAxebu.js";
import { M as te } from "./MDOverlayTooltip.vue_vue_type_style_index_0_scoped_237db18c_lang-DwVzMmDg.js";
import { M as z } from "./typography-C_Z8eobQ.js";
import { u as oe, j as I, k as ae, d as P, e as se } from "./index-C53DMLGR.js";
import { o as le, u as ie, a as ne } from "./main-DJpaSGb0.js";
import { u as de, a as re, _ as ue, b as ce, o as pe, f as me, s as fe } from "./floating-ui.vue-DGt7a65j.js";
import { _ as j } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { M as ve } from "./MDSymbol-CCJ3GcDi.js";
import { u as he, a as be, M as _e } from "./useStateLayer-BhxjeFoD.js";
const ge = { key: 0, class: "md-rich-tooltip__actions" }, ye = V({ __name: "MDRichTooltip", props: N({ subhead: {}, disabledTeleport: { type: Boolean }, targetElement: {}, useClick: { type: Boolean }, useHover: { type: Boolean }, placement: { default: "top-end" } }, { show: { type: Boolean }, showModifiers: {} }), emits: N(["interactionOutside"], ["update:show"]), setup(i, { emit: M }) {
  const e = G(i, "show"), S = i, T = M, E = A(), { subhead: r, targetElement: m, useClick: f, useHover: v, placement: u } = J(S), h = oe(), n = d(() => se(m.value ?? h.value)), l = de(), b = I(n), U = d(() => v.value && (b.value || F.value)), c = L("tooltipEl"), F = I(c), K = ae(U, 1500), _ = H(false);
  P(n, "click", () => {
