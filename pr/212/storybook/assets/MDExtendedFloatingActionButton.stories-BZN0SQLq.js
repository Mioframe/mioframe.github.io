import { d as g, r as u } from "./iframe-D7CCZAu7.js";
import { M as e } from "./MDExtendedFloatingActionButton-DcqgBjy9.js";
...
const t = g({ template: `
  ...
  ` }), D = { title: "Material 3/Components/Extended Floating Action Button/MDExtendedFloatingActionButton", component: e, tags: ["autodocs"], args: { color: "primary-container", size: "small" }, parameters: { layout: "centered" } }, o = { render: (n) => ({ components: { AddIcon: t, MDExtendedFloatingActionButton: e }, setup() {
  return { args: n };
}, template: `
    ...
    ` }) }, d = { render: () => ({ components: { AddIcon: t, MDExtendedFloatingActionButton: e }, setup() {
  const n = u(0);
  return { clickCount: n, onClick: () => {
    ...
    ` }) }, a = { render: () => ({ components: { AddIcon: t, MDExtendedFloatingActionButton: e }, setup() {
  ...
  return { attemptedOverrides: n, toggleAttemptedOverrides: () => {
    ...
    ` }) }, i = { render: () => ({ components: { AddIcon: t, MDExtendedFloatingActionButton: e }, template: `
    ...
    ` }) }, r = { render: () => ({ components: { AddIcon: t, MDExtendedFloatingActionButton: e }, template: `
    ...
    ` }) }, c = { render: () => ({ components: { AddIcon: t, MDExtendedFloatingActionButton: e }, template: `
    ...
    ` }) }, l = { render: () => ({ components: { AddIcon: t, MDExtendedFloatingActionButton: e }, template: `
      <div
    ...
    ` }) }, m = { tags: ["visual"], render: () => ({ components: { AddIcon: t, MDExtendedFloatingActionButton: e }, template: `
    ...
    ` }) }, s = { tags: ["visual"], render: () => ({ components: { AddIcon: t, MDExtendedFloatingActionButton: e }, template: `
    ...
    ` }) }, p = { tags: ["visual"], render: () => ({ components: { AddIcon: t, MDExtendedFloatingActionButton: e }, template: `
    ...
    ` }) }, f = { tags: ["visual"], render: () => ({ components: { AddIcon: t, MDExtendedFloatingActionButton: e }, template: `
