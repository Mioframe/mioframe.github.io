import { d as C, i as D, o as m, c as b, n as N, f as g, e as s, j as S, b as E, a as L, t as O, h as v, S as J, F, l as T, T as I, I as q, G as A, B as Q, A as M } from "./iframe-KtfoL3fw.js";
import { b as H, c as $, d as j, a as V, M as w } from "./useStateLayer-DFLHxQDX.js";
import { M as W } from "./MDSymbol-D7w6-X6C.js";
...
import { t as Z } from "./index-C1qInJPL.js";
import { M as U } from "./MDIconButton-gLt_0pBb.js";
function ee(e, i = 0) {
...
const te = { class: "md-navigation-rail-button__symbol-container" }, ae = { class: "md-navigation-rail-button__label" }, oe = C({ __name: "MDNavigationRailButton", props: { symbol: {}, label: {}, active: { type: Boolean }, type: {}, hasRipple: { type: Boolean } }, emits: ["click"], setup(e, { emit: i }) {
  ...
  return (f, R) => (m(), b("button", { ref_key: "refEl", ref: o, type: "button", class: N(["md-navigation-rail-button md", [{ _active: e.active }, `_type-${e.type}`]]), onClick: y }, [d.value ? (m(), g(s(w), { key: 0, hover: s(u), focused: s(r), pressed: s(c) }, null, 8, ["hover", "focused", "pressed"])) : S("", true), E("span", te, [e.type === s(_).vertical ? (m(), g(s(w), { key: 0, hover: s(u), focused: s(r), pressed: s(c) }, null, 8, ["hover", "focused", "pressed"])) : S("", true), L(s(W), { class: "md-navigation-rail-button__symbol", name: e.symbol }, null, 8, ["name"])]), E("span", ae, O(e.label), 1)], 2));
...
const se = { class: "md-navigation-bar-button__label" }, ie = C({ __name: "MDNavigationBarButton", props: { label: {}, symbol: {}, active: { type: Boolean }, type: {} }, emits: ["click"], setup(e, { emit: i }) {
  ...
  return (d, y) => (m(), b("button", { ref_key: "el", ref: a, class: N(["md-navigation-bar-button md", [{ _active: e.active }, `_type-${e.type}`]]), type: "button", onClick: c }, [L(s(w), { hover: s(o), focused: s(u), pressed: s(r) }, null, 8, ["hover", "focused", "pressed"]), L(s(W), { class: "md-navigation-bar-button__symbol", name: e.symbol }, null, 8, ["name"]), E("span", se, O(e.label), 1)], 2));
} }), re = K(ie, [["__scopeId", "data-v-2183c128"]]);
var G = ((e) => (e.vertical = "vertical", e.horizontal = "horizontal", e))(G || {});
G.vertical;
...
.`, type: 2, props: [{ name: "value", global: false, description: "", tags: [], required: true, type: "HTMLElement | null | undefined", schema: "HTMLElement | null | undefined", declarations: [] }, { name: "__@RefSymbol@321", global: false, description: `Type differentiator only.
We need this to be in public d.ts but don't want it to show up in IDE
