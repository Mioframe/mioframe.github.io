import { q as W, l as N, V as B, x as K, b as I, y as x, d as q, R as z, B as P, m as Y, c as Q, w as X, u as E, S as C, j as J, o as k, f as $, A as G, k as Z, E as ee, p as te } from "./iframe-LN07dE5l.js";
import { t as ne, r as re, o as ae, d as se, f as oe, e as ie } from "./index-DMfG1bCx.js";
import { o as ue, u as ce, a as le } from "./main-f_To7Y4N.js";
import { u as fe } from "./useFocusTrap-C9-fNMv6.js";
import { a as de, u as me, _ as ge, b as pe, f as he, s as Ae, c as ve } from "./floating-ui.vue-CAz2qdpC.js";
...
const He = ["aria-label", "role"], je = q({ __name: "MDMenuBase", props: C({ target: {}, outsideIgnore: {}, disabledTeleport: { type: Boolean }, placement: { default: "bottom-start" }, ariaLabel: {}, role: { default: "menu" } }, { show: { type: Boolean, required: true }, showModifiers: {} }), emits: C(["interactionOutside", "deactivateFocus"], ["update:show"]), setup(e, { emit: t }) {
  ...
  return ce(n, () => (S(), false)), le(n, () => (S(), false)), (g, T) => (k(), Q(E(ge), { to: E(m), disabled: e.disabledTeleport, container: o.value }, { default: X(() => [n.value ? (k(), $("div", { key: 0, ref_key: "listContainerRef", ref: o, class: "md md-menu", style: Z(E(l)), "aria-label": e.ariaLabel, role: e.role }, [G(g.$slots, "default", {}, void 0, true)], 12, He)) : ee("", true)]), _: 3 }, 8, ["to", "disabled", "container"]));
