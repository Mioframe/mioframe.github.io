import { d as c, r as u, c as d, b as r, a as p, w as m, e as f, o as a, F as _, l as y, f as x } from "./iframe-B7XlbVyG.js";
import { _ as b } from "./useReorderItem-BOtDQStK.js";
import { R as h } from "./ReorderSelfScrollableStoryItem-DZ-XQ0G3.js";
...
const w = { class: "reorder-fixed-boundary-story-harness" }, g = { role: "region", "aria-label": "Reorder scroll ancestor", class: "reorder-fixed-boundary-story-harness__ancestor" }, R = { class: "reorder-fixed-boundary-story-harness__fixed-surface" }, S = { role: "list", "aria-label": "Fixed boundary reorder items", class: "reorder-fixed-boundary-story-harness__container" }, k = c({ __name: "ReorderFixedBoundaryStoryHarness", setup(F) {
  const s = u(Array.from({ length: 10 }, (t, e) => `row-${e}`)), i = (t) => {
    s.value = [...t.orderedIds];
  };
  return (t, e) => (a(), d("div", w, [e[1] || (e[1] = r("p", null, " position: fixed reorder surface fixture whose containing block is a transformed ancestor, not the browser viewport \u2014 the ancestor's own scroll must still be able to participate in autoscroll ", -1)), r("div", g, [e[0] || (e[0] = r("div", { class: "reorder-fixed-boundary-story-harness__ancestor-spacer-top", "aria-hidden": "true" }, null, -1)), r("div", R, [p(f(b), { "item-ids": s.value, onReorder: i }, { default: m(() => [r("div", S, [(a(true), d(_, null, y(s.value, (n, l) => (a(), x(h, { key: n, "item-id": n, index: l, snap: false }, null, 8, ["item-id", "index"]))), 128))])]), _: 1 }, 8, ["item-ids"])])])]));
