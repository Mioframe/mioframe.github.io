import { d as to, s as Ha, j as ur, k as Tr, l as De, o as Hd, m as Bd, p as no, r as hr, q as Ba, v as ro, x as z, y as Kd, g as Gd, w as Yd, u as qn, e as Xd, z as Zd } from "./iframe-BHm5Ipn_.js";
...
negative, then it replaces from the end of the array.` }, { name: "param", text: "value The value to insert into the copied array." }, { name: "returns", text: "A copy of the original array with the inserted value." }], required: true, type: "(index: number, value: Element) => Element[]", declarations: [], schema: { kind: "event", type: "(index: number, value: Element): Element[]" } }, { name: "__@iterator@640", global: false, description: "Iterator of values in the array.", tags: [], required: true, type: "() => ArrayIterator<Element>", declarations: [], schema: { kind: "event", type: "(): ArrayIterator<Element>" } }, { name: "__@unscopables@642", global: false, description: `Is an object whose properties have the value 'true'
...
given value. If the index is negative, then it replaces from the end
of the array.`, tags: [{ name: "param", text: `index The index of the value to overwrite. If the index is
negative, then it replaces from the end of the array.` }, { name: "param", text: "value The value to write into the copied array." }, { name: "returns", text: "The copied array with the updated value." }], required: true, type: "(index: number, value: PluginConstructor<DragDropManager<Data, Draggable<Data>, Droppable<Data>>, Plugin<DragDropManager<Data, Draggable<Data>, Droppable<...>>, PluginOptions>, PluginOptions> | PluginDescriptor<...>) => (PluginConstructor<...> | PluginDescriptor<...>)[]", declarations: [], schema: { kind: "event", type: "(index: number, value: PluginConstructor<DragDropManager<Data, Draggable<Data>, Droppable<Data>>, Plugin<DragDropManager<Data, Draggable<Data>, Droppable<...>>, PluginOptions>, PluginOptions> | PluginDescriptor<...>): (PluginConstructor<...> | PluginDescriptor<...>)[]" } }, { name: "__@iterator@640", global: false, description: "Iterator", tags: [], required: true, type: "() => ArrayIterator<PluginConstructor<DragDropManager<Data, Draggable<Data>, Droppable<Data>>, Plugin<DragDropManager<Data, Draggable<Data>, Droppable<...>>, PluginOptions>, PluginOptions> | PluginDescriptor<...>>", declarations: [], schema: { kind: "event", type: "(): ArrayIterator<PluginConstructor<DragDropManager<Data, Draggable<Data>, Droppable<Data>>, Plugin<DragDropManager<Data, Draggable<Data>, Droppable<...>>, PluginOptions>, PluginOptions> | PluginDescriptor<...>>" } }, { name: "__@unscopables@642", global: false, description: `Is an object whose properties have the value 'true'
...
given value. If the index is negative, then it replaces from the end
of the array`, tags: [{ name: "param", text: `index The index of the value to overwrite. If the index is
negative, then it replaces from the end of the array.` }, { name: "param", text: "value The value to insert into the copied array." }, { name: "returns", text: "A copy of the original array with the inserted value." }], required: true, type: "(index: number, value: unknown) => unknown[]", declarations: [], schema: { kind: "event", type: "(index: number, value: unknown): unknown[]" } }, { name: "__@iterator@640", global: false, description: "Iterator of values in the array.", tags: [], required: true, type: "() => ArrayIterator<unknown>", declarations: [], schema: { kind: "event", type: "(): ArrayIterator<unknown>" } }, { name: "__@unscopables@642", global: false, description: `Is an object whose properties have the value 'true'
...
given value. If the index is negative, then it replaces from the end
of the array`, tags: [{ name: "param", text: `index The index of the value to overwrite. If the index is
negative, then it replaces from the end of the array.` }, { name: "param", text: "value The value to insert into the copied array." }, { name: "returns", text: "A copy of the original array with the inserted value." }], required: true, type: "(index: number, value: string) => string[]", declarations: [], schema: { kind: "event", type: "(index: number, value: string): string[]" } }, { name: "__@iterator@640", global: false, description: "Iterator of values in the array.", tags: [], required: true, type: "() => ArrayIterator<string>", declarations: [], schema: { kind: "event", type: "(): ArrayIterator<string>" } }, { name: "__@unscopables@642", global: false, description: `Is an object whose properties have the value 'true'
