import { d as g, A as L, H, c as _, a as E, w as M, e as a, v as u, i as A, h as b, o as D, b as B, n as T, g as I, r as l, $ as R } from "./iframe-n94PV55C.js";
import { d as j, j as V, k as $, h as z } from "./index-DqUS5Yfi.js";
import { i as O } from "./isUndefined-Dgw4-efh.js";
import { u as U } from "./useOverlay-Bo1SAQqQ.js";
import { u as N, a as W, _ as q, o as G, s as J } from "./MDSymbol-Bf7knakn.js";
import { a as K } from "./index-Bo_sLfVS.js";
import { u as Q, d as X } from "./FabContainer.vue_vue_type_style_index_0_scoped_3ecc84a9_lang-XoeffOgQ.js";
...
import "./useStateLayer-BwcQqoWp.js";
import "./MDIconButton-DzchXsKy.js";
import "./useLocalSettings-Gc8WCO2X.js";
import { _ as Y } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { M as m } from "./MDExtendedFab-Brg29t0p.js";
...
const Z = ["aria-hidden"], ee = g({ __name: "FabContainer", props: { autoHide: { type: Boolean } }, setup(e) {
  ...
  const { focused: v } = $(s), x = b(() => !n.value || O(r.value) || r.value === "top" || v.value), C = U(), F = Q(), { floatingStyles: w } = N(F, s, { placement: "bottom-end", strategy: "fixed", transform: false, middleware: [G(({ rects: { floating: c } }) => ({ mainAxis: -c.height })), J({ padding: 16 })], whileElementsMounted: W }), { height: S } = z(s, { height: 0, width: 0 }, { box: "border-box" }), P = b(() => ({ height: `${S.value}px` })), k = K();
  return (c, te) => (D(), _("div", { class: "fab-container fab-container__placeholder", style: u(P.value) }, [E(a(q), { container: s.value, to: a(C) }, { default: M(() => [B("div", { ref: "fabContainer", class: T(["fab-container__surface", { "fab-container__surface_auto-hide": a(n), "fab-container__surface_hidden": !x.value }]), style: u(a(w)), "aria-hidden": a(k) }, [I(c.$slots, "default", {}, void 0, true)], 14, Z)]), _: 3 }, 8, ["container", "to"])], 4));
...
const Se = ["Default", "PaneAnchoringLoadingTransition", "TwoPaneLayout"];
export {
  d as Default,
