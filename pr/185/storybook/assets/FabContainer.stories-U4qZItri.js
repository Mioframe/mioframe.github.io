import { d as g, C as L, G as _, c as H, a as E, w as M, e as a, v as u, i as D, h as b, o as A, b as B, n as T, g as I, r as l, $ as R } from "./iframe-BW_3G6Xd.js";
import { d as j, j as V, k as $, h as z } from "./index-CvzXYYFH.js";
import { i as O } from "./isUndefined-Dgw4-efh.js";
import { u as U } from "./useOverlay-CXw3ON-R.js";
import { u as N, a as W, _ as G, o as q, s as J } from "./TeleportContainer.vue_vue_type_script_setup_true_lang-Am3Z5Qnh.js";
import { a as K } from "./index-CdxzS3eU.js";
import { u as Q, d as X } from "./FabContainer.vue_vue_type_style_index_0_scoped_3ecc84a9_lang-ChTYPP0c.js";
...
import "./useStateLayer-BheEhEQ0.js";
import "./MDIconButton-98R518Qz.js";
import "./useLocalSettings-B6N-OD9R.js";
import { _ as Y } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { M as m } from "./MDExtendedFab-C-UZcKZ7.js";
import "./preload-helper-PPVm8Dsz.js";
import "./MDSymbol-BapSH0y3.js";
...
const Z = ["aria-hidden"], ee = g({ __name: "FabContainer", props: { autoHide: { type: Boolean } }, setup(e) {
  const t = e, { autoHide: n } = L(t), s = D("fabContainer"), y = j(), r = l(), { directions: f } = V(y);
  _(() => {
    f.top ? r.value = "top" : f.bottom && (r.value = "bottom");
  });
  const { focused: v } = $(s), x = b(() => !n.value || O(r.value) || r.value === "top" || v.value), C = U(), F = Q(), { floatingStyles: w } = N(F, s, { placement: "bottom-end", strategy: "fixed", transform: false, middleware: [q(({ rects: { floating: c } }) => ({ mainAxis: -c.height })), J({ padding: 16 })], whileElementsMounted: W }), { height: S } = z(s, { height: 0, width: 0 }, { box: "border-box" }), P = b(() => ({ height: `${S.value}px` })), k = K();
  return (c, te) => (A(), H("div", { class: "fab-container fab-container__placeholder", style: u(P.value) }, [E(a(G), { container: s.value, to: a(C) }, { default: M(() => [B("div", { ref: "fabContainer", class: T(["fab-container__surface", { "fab-container__surface_auto-hide": a(n), "fab-container__surface_hidden": !x.value }]), style: u(a(w)), "aria-hidden": a(k) }, [I(c.$slots, "default", {}, void 0, true)], 14, Z)]), _: 3 }, 8, ["container", "to"])], 4));
...
const Pe = ["Default", "PaneAnchoringLoadingTransition", "TwoPaneLayout"];
export {
  d as Default,
