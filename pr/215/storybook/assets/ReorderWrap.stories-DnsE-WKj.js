import { d as l, j as g, o as d, c as n, v as _, s as f, i as p, t as y, b as h, a as v, w as x, r as I, F as b, f as S, p as R } from "./iframe-DG07b4aY.js";
import { u as W, _ as k } from "./useReorderItem-IEjAuZYU.js";
...
const z = ["aria-label"], $ = l({ __name: "ReorderWrapStoryItem", props: { itemId: {}, index: {}, width: {}, height: {} }, setup(e) {
  ...
  return (s, m) => (d(), n("div", D, [m[0] || (m[0] = h("p", null, "wrapping/grid reorder fixture: mixed item sizes, movement across rows", -1)), v(p(k), { "item-ids": a.value, onReorder: c }, { default: x(() => [h("div", E, [(d(true), n(b, null, S(a.value, (o, w) => (d(), R(B, { key: o, "item-id": o, index: w, width: t(o).width, height: t(o).height }, null, 8, ["item-id", "index", "width", "height"]))), 128))])]), _: 1 }, 8, ["item-ids"])]));
