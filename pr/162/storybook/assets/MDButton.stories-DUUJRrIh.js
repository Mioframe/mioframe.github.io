import { d as v, c as D, b as k, a as M, t as B, r as t, e as x } from "./iframe-DS-imMpZ.js";
import { u as q } from "./useFocusIndicator-DmwQbjrh.js";
import { M as e } from "./MDButton-CgO-y1Np.js";
...
const I = { id: "visual-md-button-target-hit", class: "visual-checker-backdrop" }, E = { id: "visual-md-button-target-hit-count" }, p = v({ __name: "MDButtonTargetHitVisualStory", setup(g) {
  const n = t(0), a = () => {
    n.value += 1;
  };
  return (b, h) => (x(), D("div", I, [k(e, { label: "OK", size: "extra-small", onClick: a }), M("output", E, B(n.value), 1)]));
} });
...
const _ = ["Default", "VisualStates", "SizeGeometryMatrix", "ToggleShapes", "DisabledSelectedOutlinedAndText", "ExpandedTargetHitArea", "FocusIndicatorTarget", "BehaviorContracts", "LoadingPresentation"];
export {
