import { i as C, C as L, D as H, _ as J, y as x, $ as V, M as D } from "./iframe-Ct2Kcxpc.js";
function U(o, r, t) {
  const e = new Array(o);
...
function ct(o, r) {
  ...
  return { items: n, totalSize: h, leadingSize: a, trailingSize: m, measure: { mounted(u, c) {
    S(u, c.value);
  }, updated(u, c) {
    S(u, c.value);
  } } };
