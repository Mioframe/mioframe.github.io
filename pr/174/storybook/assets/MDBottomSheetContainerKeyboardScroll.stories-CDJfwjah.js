import { X as U, E as N, J as B, r as x, m as W, d as j, S as q, B as H, c as D, b as g, n as Y, e as h, a as J, g as X, v as F, Y as G, T as Z, i as M, h as O, o as T, f as ee, w as te, F as oe, l as se, t as ne } from "./iframe-KtfoL3fw.js";
import { u as ae, a as re, M as le } from "./useStateLayer-DFLHxQDX.js";
import { r as ie, u as ce, g as ue, t as de, h as pe, a as fe, e as me } from "./index-C1qInJPL.js";
import { u as he } from "./index-CGfI_5ZH.js";
import { u as ve } from "./FabContainer.vue_vue_type_style_index_0_scoped_3ecc84a9_lang-DCtHBC07.js";
...
import { u as be, a as ye } from "./main-DBHdan5g.js";
import "./MDIconButton-gLt_0pBb.js";
import { u as ge } from "./useFocusTrap-DmcJ3RQH.js";
...
const He = (t, { throttleMs: e = 1e3 / 10 } = {}) => {
  ...
  return be(e, () => (e.value = false, false)), ye(e, () => (e.value = false, false)), (m, v) => (T(), D("div", { ref_key: "containerEl", ref: o, class: "md-bottom-sheet md-bottom-sheet__scrim", role: "dialog", "aria-hidden": h(b), style: F(V.value), onClick: G(w, ["self"]), onKeydown: $ }, [g("div", { ref_key: "bodyEl", ref: r, class: "md md-bottom-sheet__body", style: F(R.value) }, [g("div", De, [g("button", { ref_key: "dragHandleEl", ref: i, type: "button", class: Y(["md-bottom-sheet__drag-handle", { "md-state_hover": h(p), "md-state_focused": h(f), "md-state_pressed": h(a) }]), "aria-label": e.value ? l.dragHandleCloseLabel : l.dragHandleExpandLabel, onClick: n }, [J(h(le), { hover: h(p), focused: h(f), pressed: h(a) }, null, 8, ["hover", "focused", "pressed"]), v[0] || (v[0] = g("span", { class: "md-bottom-sheet__drag-pill" }, null, -1))], 10, Le)]), X(m.$slots, "default", {}, void 0, true)], 4)], 44, Me));
...
} }), Ae = z(Oe, [["__scopeId", "data-v-f4c38cc5"]]), ot = { title: "shared/ui/Sheets/MDBottomSheetContainerKeyboardScrollStoryHarness", component: Ae, parameters: { layout: "fullscreen" } }, S = {};
