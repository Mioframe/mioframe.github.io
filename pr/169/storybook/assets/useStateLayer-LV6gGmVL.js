import { I as H, K as q, d as I, c as O, n as K, h as p, o as U, A as R, r as b, G as V } from "./iframe-BFysBzVV.js";
import { _ as j } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { u as f, e as y, v as G, c as W, x as L } from "./index-BdtWu7Hc.js";
...
const A = /* @__PURE__ */ Symbol("MDStateLayerForcedState"), ue = (n) => {
  q(A, n);
}, X = () => H(A, void 0), ee = I({ __name: "MDStateLayer", props: { hover: { type: Boolean, default: false }, focused: { type: Boolean, default: false }, pressed: { type: Boolean, default: false }, dragged: { type: Boolean, default: false }, disabled: { type: Boolean, default: false } }, setup(n) {
  ...
  return (o, c) => (U(), O("span", { class: K(["md-state-layer", { "md-state_hover": !e.disabled && l.value, "md-state_focused": !e.disabled && s.value, "md-state_pressed": !e.disabled && r.value, "md-state_dragged": !e.disabled && t.value, "md-state_disabled": e.disabled }]), "aria-hidden": "true" }, null, 2));
} }), de = j(ee, [["__scopeId", "data-v-73ae0dfb"]]), i = /* @__PURE__ */ Object.create(null), N = 6e4, k = N * 60, S = k * 24, B = S * 365.25;
i.year = i.yr = i.y = B;
