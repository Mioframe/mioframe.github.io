import { y as u, l as A, _ as R, I as k, E as D } from "./iframe-kUPGWLFh.js";
const v = (e) => {
};
...
E.__docgenInfo = Object.assign({ displayName: E.name ?? E.__name }, { exportName: "useListSelectionKeyboard", displayName: "useListSelectionKeyboard", description: "Wires roving keyboard navigation and tab-stop synchronization for a listbox\ncontainer. Only active when `enabled` is true (i.e. when selectionMode !== 'none').", type: 2, props: [{ name: "value", global: false, description: "", tags: [], required: true, type: "HTMLElement | null", schema: "HTMLElement | null", declarations: [] }, { name: "__@RefSymbol@406", global: false, description: `Type differentiator only.
We need this to be in public d.ts but don't want it to show up in IDE
