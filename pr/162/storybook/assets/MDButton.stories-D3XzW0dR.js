...
const h = { id: "visual-md-button-target-hit", class: "visual-checker-backdrop" }, T = { id: "visual-md-button-target-hit-count" }, y = B({ __name: "MDButtonTargetHitVisualStory", setup(m) {
  ...
  return (v, b) => (x(), M("div", h, [k(t, { label: "OK", size: "extra-small", onClick: o }), C("output", T, S(n.value), 1)]));
    ...
    ` }) }, u = { render: () => ({ components: { MDButtonTargetHitVisualStory: y }, template: "<MDButtonTargetHitVisualStory />" }) }, c = { render: () => ({ components: { MDButton: t }, setup() {
  f();
}, template: `
  ...
  const m = e(false), n = e(0), o = e(0), v = e(0), b = e(0), g = e(0);
  return { disabledClickCount: g, loadingClickCount: b, onDisabledClick: () => {
    g.value += 1;
  }, onLoadingClick: () => {
    b.value += 1;
  }, onSubmit: () => {
    ...
    n.value += 1, m.value = D;
  }, resetCount: v, selected: m, selectionIntentCount: n, submitCount: o };
}, template: `
...
const H = ["Default", "VisualStates", "SizeGeometryMatrix", "ToggleShapes", "DisabledSelectedOutlinedAndText", "ExpandedTargetHitArea", "FocusIndicatorTarget", "BehaviorContracts", "LoadingIndicatorPresentation"];
export {
