import { C as U, g as $, r as B, D as q, d as I, k as P, B as R, E as V, c as w, b, h as T, q as S, i as a, t as O, p as z, a as G, G as H, s as Z, j, o as h } from "./iframe-Ca4XsWix.js";
import { u as K } from "./index-4MT_h-IB.js";
import { s as A } from "./uniqueId-qx_q35vh.js";
import { u as J } from "./useFocusTrap-BeX2vaG7.js";
import { u as Q, a as W } from "./main-jaVp5qCE.js";
import { M as F } from "./MDButton-iOvxmI9b.js";
...
import { c as X, t as Y, b as ee } from "./index-BGt0r_ea.js";
...
import "./MDLoadingIndicator-CsiSpm2b.js";
const oe = X(() => {
  ...
  const o = () => {
    ...
    t.push(n), o();
  }), p = async (e) => await i("confirm", e), _ = async (e) => await i("alert", e), m = B(0), v = q();
  return { alert: _, confirm: p, alertSet: l, numberOfOpenDialogs: m, globalDialogContainer: v };
}), te = (l) => {
  ...
  const s = l, o = t, i = P(), { applyLabel: p, cancelLabel: _, hasCancelAction: m, headline: v, loading: e, supportingText: r, type: k, class: D } = R(s), f = K(), g = B(true);
  te(g);
...
} }), ue = ae(pe, [["__scopeId", "data-v-f59891b9"]]), Ee = { title: "Shared/Dialog/DialogForm", component: ue, parameters: { layout: "fullscreen" }, args: { headline: "Confirm", supportingText: "Apply the change?", applyLabel: "Apply" } }, y = {}, u = { args: { hasCancelAction: true, loading: true } };
