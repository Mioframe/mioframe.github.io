import { r as G, C as J, N as j, y as S, D as Yt, a0 as qt, a1 as Kt, M as Y, d as Mt, o as Vt, p as Ut, a2 as Gt, h as Jt, W as Qt, B as Zt, c as te, s as ee, t as ne, i as oe } from "./iframe-O6XwQGQr.js";
import { e as ie, f as se } from "./main-BQTx51mT.js";
import { c as re, t as le, e as dt } from "./index-DLU5p4LU.js";
...
function At(t, e, n) {
  ...
  const s = _(e), r = Wt(e), l = kt(r), c = z(e), a = s === "y", f = o.x + o.width / 2 - i.width / 2, u = o.y + o.height / 2 - i.height / 2, d = o[l] / 2 - i[l] / 2;
  let m;
  switch (c) {
    case "top":
...
const xe = 50, be = async (t, e, n) => {
  ...
  return t === void 0 && (t = {}), { name: "flip", options: t, async fn(e) {
    ...
    const g = z(i), v = _(l), y = z(l) === l, x = await (c.isRTL == null ? void 0 : c.isRTL(a.floating)), O = d || (y || !p ? [it(l)] : de(l)), R = h !== "none";
    ...
    if (T = [...T, { placement: i, overflows: L }], !L.every(($) => $ <= 0)) {
      ...
      if (ut && (!(u === "alignment" ? v !== _(ut) : false) || T.every((A) => _(A.placement) === v ? A.overflows[0] > 0 : true))) return { data: { index: $, overflows: T }, reset: { placement: ut } };
...
async function Oe(t, e) {
  const { placement: n, platform: o, elements: i } = t, s = await (o.isRTL == null ? void 0 : o.isRTL(i.floating)), r = z(n), l = et(n), c = _(n) === "y", a = Ce.has(r) ? -1 : 1, f = s && c ? -1 : 1, u = tt(e, t);
...
const Ee = function(t) {
  ...
  return t === void 0 && (t = {}), { name: "shift", options: t, async fn(e) {
    const { x: n, y: o, placement: i, platform: s } = e, { mainAxis: r = true, crossAxis: l = false, limiter: c = { fn: (v) => {
      let { x: y, y: x } = v;
      return { x: y, y: x };
    } }, ...a } = tt(t, e), f = { x: n, y: o }, u = await s.detectOverflow(e, a), d = _(i), m = Ft(d);
    let h = f[m], p = f[d];
  ...
  return t === void 0 && (t = {}), { name: "size", options: t, async fn(e) {
    ...
    }, ...l } = tt(t, e), c = await i.detectOverflow(e, l), a = z(n), f = et(n), u = _(n) === "y", { width: d, height: m } = o.floating;
    let h, p;
...
function Nt(t) {
  const e = E(t);
  return !yt() || !e.visualViewport ? _e : { x: e.visualViewport.offsetLeft, y: e.visualViewport.offsetTop };
}
function Me(t, e, n) {
...
function I(t, e, n, o) {
  ...
  if (s && o) {
    ...
    let h = d, p = pt(h);
    for (; p && m !== h; ) {
      const w = q(p), g = p.getBoundingClientRect(), v = P(p), y = g.left + (p.clientLeft + parseFloat(v.paddingLeft)) * w.x, x = g.top + (p.clientTop + parseFloat(v.paddingTop)) * w.y;
...
function Ne(t, e) {
  ...
  let r = s ? H(t) : t;
  for (; D(r) && !Q(r); ) {
    const l = P(r), c = vt(r), a = i ? i.position : s ? "fixed" : "";
...
function Ht(t, e) {
  ...
  return o && Q(o) && ht(o) && !vt(o) ? n : o || Pe(t) || n;
}
...
function fn(t, e, n) {
  ...
  const o = n.whileElementsMounted, i = S(() => {
    ...
    if (!f.value) return b;
    const C = Pt(f.value, u.value), L = Pt(f.value, d.value);
...
}, _t = Qt(/* @__PURE__ */ new Set()), Je = () => ({ useLoadSymbol: (e) => {
  J(e, (n) => {
    n && _t.add(n);
  }, { immediate: true });
}, loadedSymbols: _t }), Qe = Mt({ __name: "MDSymbol", props: { name: {} }, setup(t) {
