import { M as k } from "./MDButton-D4LXsblW.js";
import { d as _, c as A, b as n, a as u, w as v, t as D, r as M, o as S, e as b } from "./iframe-D7CCZAu7.js";
...
import { M as t } from "./MDCard-D0OOa8Fw.js";
...
import "./MDLoadingIndicator-DOJpC09Q.js";
import "./preload-helper-PPVm8Dsz.js";
import "./useStateLayer-Bzy0EYjr.js";
...
const V = { class: "md-card-action-story visual-row" }, I = { class: "md-card-action-story__cell" }, $ = { "data-testid": "md-card-button-action-count" }, O = { class: "md-card-action-story__cell" }, T = { "data-testid": "md-card-link-action-count" }, E = { class: "md-card-action-story__cell" }, L = { "data-testid": "md-card-disabled-link-action-count" }, F = _({ __name: "MDCardActionVisualStory", setup(a) {
  ...
  return (j, e) => (S(), A("div", V, [n("div", I, [u(t, { mode: "button", variant: "elevated", class: "md-card-action-story__card", "data-testid": "md-card-button-action", onAction: w }, { default: v(() => [...e[0] || (e[0] = [b(" Tap this whole card ", -1)])]), _: 1 }), n("output", $, D(h.value), 1)]), n("div", O, [u(t, { mode: "link", href: "#md-card-link-action-target", variant: "outlined", class: "md-card-action-story__card", "data-testid": "md-card-link-action", onAction: x }, { default: v(() => [...e[1] || (e[1] = [b(" Open Material 3 cards docs ", -1)])]), _: 1 }), n("output", T, D(y.value), 1)]), n("div", E, [u(t, { mode: "link", href: "/unreachable", variant: "outlined", disabled: "", class: "md-card-action-story__card", "data-testid": "md-card-disabled-link-action", onAction: f }, { default: v(() => [...e[2] || (e[2] = [b(" Disabled link card ", -1)])]), _: 1 }), n("output", L, D(g.value), 1)])]));
    ...
    ` }) }, i = { name: "Actionable button card", render: (a) => ({ components: { MDCard: t }, setup: () => ({ args: a }), template: `
      <MDCard v-bind="args" mode="button" variant="elevated" style="width: 220px;" @action="args.onAction">
        Tap this whole card
      </MDCard>
    ` }) }, o = { name: "Actionable link card", render: (a) => ({ components: { MDCard: t }, setup: () => ({ args: a }), template: `
    ...
    ` }) }, s = { name: "Actionable card action/keyboard behavior", render: () => ({ components: { MDCardActionVisualStory: N }, template: "<MDCardActionVisualStory />" }) }, l = { name: "Disabled actionable cards", render: () => ({ components: { MDCard: t }, template: `
      <div class="visual-row">
...
`, m = { tags: ["visual"], render: () => ({ components: { MDCard: t }, template: `
    ...
    ` }) }, p = { tags: ["visual"], render: () => ({ components: { MDCard: t }, template: `
...
const nt = ["Variants", "StaticWithInternalActions", "ActionableButtonCard", "ActionableLinkCard", "ActionBehavior", "DisabledActionableCards", "Dragged", "VisualInteractionStates", "VisualStates"];
export {
  s as ActionBehavior,
  i as ActionableButtonCard,
  o as ActionableLinkCard,
