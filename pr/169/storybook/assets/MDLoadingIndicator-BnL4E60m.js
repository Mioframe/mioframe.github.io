import { d as $i, O as ki, f as Ei, H as Si, u as _s, b as Kt, o as Mi } from "./iframe-KpOVhpbr.js";
...
const ct = globalThis, ms = ct.ShadowRoot && (ct.ShadyCSS === void 0 || ct.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, us = /* @__PURE__ */ Symbol(), Cs = /* @__PURE__ */ new WeakMap();
let Us = class {
  constructor(e, t, s) {
...
const { is: zi, defineProperty: Hi, getOwnPropertyDescriptor: Ti, getOwnPropertyNames: Fi, getOwnPropertySymbols: Pi, getPrototypeOf: Di } = Object, Wt = globalThis, $s = Wt.trustedTypes, Wi = $s ? $s.emptyScript : "", Ri = Wt.reactiveElementPolyfillSupport, Ne = (o2, e) => o2, Ht = { toAttribute(o2, e) {
  switch (e) {
    case Boolean:
      o2 = o2 ? Wi : null;
      break;
  ...
  return t;
} }, fs = (o2, e) => !zi(o2, e), ks = { attribute: true, type: String, converter: Ht, reflect: false, useDefault: false, hasChanged: fs };
...
ve.elementStyles = [], ve.shadowRootOptions = { mode: "open" }, ve[Ne("elementProperties")] = /* @__PURE__ */ new Map(), ve[Ne("finalized")] = /* @__PURE__ */ new Map(), Ri?.({ ReactiveElement: ve }), (Wt.reactiveElementVersions ??= []).push("2.1.2");
const vs = globalThis, Es = (o2) => o2, Tt = vs.trustedTypes, Ss = Tt ? Tt.createPolicy("lit-html", { createHTML: (o2) => o2 }) : void 0, Ns = "$lit$", K = `lit$${Math.random().toFixed(9).slice(2)}$`, Ks = "?" + K, Ii = `<${Ks}>`, ce = document, Ye = () => ce.createComment(""), Ge = (o2) => o2 === null || typeof o2 != "object" && typeof o2 != "function", ys = Array.isArray, Oi = (o2) => ys(o2) || typeof o2?.[Symbol.iterator] == "function", jt = `[ 	
    ...
    for (; (n = ne.nextNode()) !== null && m.length < d; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const h of n.getAttributeNames()) if (h.endsWith(Ns)) {
          ...
          m.push({ type: 1, index: r, name: w[2], strings: y, ctor: w[1] === "." ? Ki : w[1] === "?" ? ji : w[1] === "@" ? Vi : Rt }), n.removeAttribute(h);
...
const Gi = { attribute: true, type: String, converter: Ht, reflect: false, hasChanged: fs }, Qi = (o2 = Gi, e, t) => {
...
var xe, oe, Ce, Ke, _e, dt, ht, pt, mt, ye, Ft, qs, ss, Zs;
class Ot extends ot {
  constructor(e, t) {
    super(e, t), xe.add(this), Ce.set(this, false), Ke.set(this, void 0), _e.set(this, void 0), dt.set(this, (s) => a(this, xe, "m", qs).call(this, s)), ht.set(this, (s) => a(this, xe, "m", ss).call(this, s)), pt.set(this, (s) => a(this, xe, "m", Zs).call(this, s)), mt.set(this, () => b(this, Ce, true, "f")), ye.set(this, () => b(this, Ce, false, "f")), b(this, Ke, t.callback, "f"), b(this, _e, t.filter, "f");
  }
  _observe(e) {
...
oe = Ot, Ce = /* @__PURE__ */ new WeakMap(), Ke = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), dt = /* @__PURE__ */ new WeakMap(), ht = /* @__PURE__ */ new WeakMap(), pt = /* @__PURE__ */ new WeakMap(), mt = /* @__PURE__ */ new WeakMap(), ye = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakSet(), qs = function(e) {
  ...
  a(this, Ke, "f").call(this, true, t.matches(":focus-visible") || a(oe, oe, "f", Ft) || en(), t);
}, Zs = function(e) {
...
Ft = { value: false };
var F, ie, G, Q, ut, ge, is, at, rt, Xs, Ys;
class Gs extends ot {
  constructor(e, t) {
    super(e, t), F.add(this), ie.set(this, void 0), G.set(this, /* @__PURE__ */ new Map()), Q.set(this, /* @__PURE__ */ new Map()), ut.set(this, (s) => a(this, F, "m", Xs).call(this, s)), ge.set(this, (s) => a(this, F, "m", Ys).call(this, s)), b(this, ie, t.callback, "f"), this.startDelay = t.startDelay ?? 0, this.endDelay = t.endDelay ?? 0;
  }
  clearDelays() {
...
var U, S, B, je, ae, M, Ve, ft, vt, be, yt, gt, Qs, Js, ei, ti, si, Zt;
class ii extends ot {
  constructor(e, t) {
    super(e, t), U.add(this), S.set(this, void 0), B.set(this, void 0), je.set(this, void 0), ae.set(this, void 0), M.set(this, /* @__PURE__ */ new Map()), Ve.set(this, void 0), ft.set(this, (s) => a(this, U, "m", Qs).call(this, s)), vt.set(this, (s) => a(this, U, "m", Js).call(this, s)), be.set(this, (s) => a(this, U, "m", ei).call(this, s)), yt.set(this, (s) => a(this, U, "m", ti).call(this, s)), gt.set(this, (s) => a(this, U, "m", si).call(this, s)), b(this, S, t.capture, "f"), b(this, B, t.callback, "f"), b(this, je, t.filter, "f"), b(this, ae, t.isPressedKey, "f"), b(this, Ve, t.minPressedDuration ?? 0, "f");
  }
  hostConnected() {
...
S = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), je = /* @__PURE__ */ new WeakMap(), ae = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), Ve = /* @__PURE__ */ new WeakMap(), ft = /* @__PURE__ */ new WeakMap(), vt = /* @__PURE__ */ new WeakMap(), be = /* @__PURE__ */ new WeakMap(), yt = /* @__PURE__ */ new WeakMap(), gt = /* @__PURE__ */ new WeakMap(), U = /* @__PURE__ */ new WeakSet(), Qs = function(e) {
...
var re, Pt, qe, _t, ee, Rs, Xt, oi, ai;
class hn extends ot {
  constructor(e, t) {
    super(e, t), re.add(this), Pt.set(this, void 0), qe.set(this, void 0), _t.set(this, (s) => a(this, re, "m", ai).call(this, s)), ee.set(this, /* @__PURE__ */ new Map()), b(this, Pt, t.debounce === true, "f"), b(this, qe, t.callback, "f");
  }
...
Pt = /* @__PURE__ */ new WeakMap(), qe = /* @__PURE__ */ new WeakMap(), _t = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakMap(), re = /* @__PURE__ */ new WeakSet(), Rs = function(e) {
...
var Be, wt, $t, kt, pi, mi, ui;
let Se = class extends Ut(pe(E, "none")) {
  constructor() {
    super(...arguments), Be.add(this), wt.set(this, new Gs(this, { target: null, callback: (e) => a(this, Be, "m", pi).call(this, e) })), $t.set(this, new Ot(this, { target: null, callback: (e) => a(this, Be, "m", mi).call(this, e) })), kt.set(this, new ii(this, { target: null, callback: (e) => a(this, Be, "m", ui).call(this, e) })), this.disabled = false, this.level = null;
  }
  attach(e) {
...
let Me = class extends Ut(pe(E, "none")) {
  constructor() {
    super(...arguments), as.add(this), Et.set(this, new Ot(this, { target: null, callback: (e, t) => a(this, as, "m", fi).call(this, t) })), this.inward = false, this.disabled = false;
  }
  show() {
...
var te, k, St, Mt, vi, yi;
let he = class extends Ut(pe(E, "none")) {
  constructor() {
    super(...arguments), te.add(this), k.set(this, null), St.set(this, new ii(this, { target: null, minPressedDuration: 225, isPressedKey: (e) => e === " ", callback: (e, { x: t, y: s }) => a(this, te, "m", yi).call(this, e, t, s) })), this.disabled = false, this.centered = false, this.unbounded = false, this.radius = null;
  }
  get visible() {
...
let Ae = class extends Ut(pe(E, "none")) {
  constructor() {
    super(...arguments), Lt.add(this), At.set(this, new Gs(this, { target: null, callback: (e) => a(this, Lt, "m", bi).call(this, e) })), zt.set(this, new Ot(this, { target: null, callback: (e, t) => a(this, Lt, "m", xi).call(this, t) })), this.disabled = false, this.disableHover = false;
  }
  show(e) {
...
const Tn = ["aria-label"], Fn = 24, Pn = 240, Dn = 48, Wn = 38 / 48, Rn = $i({ inheritAttrs: false, __name: "MDLoadingIndicator", props: { label: {}, size: { default: 48 } }, setup(o2) {
  const e = o2, t = Kt(() => Number.isFinite(e.size) ? Math.min(Pn, Math.max(Fn, e.size)) : Dn), s = Kt(() => t.value * Wn), n = Kt(() => ({ width: `${t.value}px`, height: `${t.value}px`, "--m3e-loading-indicator-size": `${s.value}px` })), r = ki(), l = () => {
    const d = {};
    for (const [m, u] of Object.entries(r)) (m === "id" || m === "title" || m === "aria-hidden" || m === "aria-describedby" || m.startsWith("data-")) && (d[m] = u);
    return d;
  };
  return (d, m) => (Mi(), Ei("m3e-loading-indicator", Si(l(), { class: ["md-loading-indicator", _s(r).class], "aria-label": e.label, style: [_s(r).style, n.value] }), null, 16, Tn));
} }), lo = Li(Rn, [["__scopeId", "data-v-2d47c860"]]);
export {
  bs as A,
  c as D,
  qn as F,
