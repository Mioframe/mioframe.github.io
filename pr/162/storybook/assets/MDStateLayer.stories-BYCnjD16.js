import { d, r as n, l as p } from "./iframe-DS-imMpZ.js";
import { M as c } from "./MDButton-CgO-y1Np.js";
import { M as l, u, a as v } from "./useStateLayer-RYqP6nCQ.js";
...
const y = d({ components: { MDStateLayer: l }, props: { label: { type: String, required: true }, disabled: { type: Boolean, default: false }, enableRipple: { type: Boolean, default: true }, dragged: { type: Boolean, default: false } }, setup(a) {
  ...
  ` }), S = { title: "shared/ui/MDStateLayer", component: l, parameters: { layout: "centered" } }, e = { tags: ["visual"], render: () => ({ components: { MDStateLayer: l, StateLayerDemoHost: y }, template: `
...
const M = ["VisualStates", "VisualHostIntegration"];
export {
