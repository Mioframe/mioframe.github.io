import { c as d, o as w, t as f, u as v } from "./index-CLWINx2J.js";
import { A as m, L as S, O as k, Y as N, r as x } from "./iframe-B4Cyl5fc.js";
const p = d(() => {
  const t = [];
  return w("Escape", (e) => {
    let s = true;
...
function g(t, n, r) {
  ...
  switch (typeof n) {
    ...
    default: {
      if (Array.isArray(n)) return L(t, n, r);
...
function y(t) {
  return typeof t == "number" || W(t) && E(t) === "[object Number]";
}
const O = d(() => {
  const t = k(), n = j(), r = [];
  let e;
  ...
  const { onBackNavigationStacked: n } = O();
  n(t);
}, T = (t, n) => {
  const { onBackNavigationStacked: r } = O();
  let e;
  const s = m(() => S(t) === true, (i) => {
    i && !e ? e = r(n) : !i && e && (e(), e = void 0);
  }, { immediate: true, flush: "sync" });
