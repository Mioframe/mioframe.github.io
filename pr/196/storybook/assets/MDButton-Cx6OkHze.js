import { d, u as k, h as z, c as S, p as c, w as M, j as o, q as x, b as C, t as D, m as w, y as s, o as r, i as N, Z as A } from "./iframe-DnnZhAKu.js";
import "./MDButton.vue_vue_type_style_index_0_scoped_10bb3159_lang-Be9CuhxN.js";
import { M as I } from "./MDLoadingIndicator-DWljmp30.js";
import { _ as T } from "./_plugin-vue_export-helper-DlAUqK2U.js";
const V = ["aria-busy", "disabled", "size", "type", "variant"], j = { class: "md-button__label-text" }, q = d({ inheritAttrs: false, __name: "MDButton", props: { nativeType: { default: "button" }, color: { default: "filled" }, label: {}, disabled: { type: Boolean }, size: { default: "small" }, loading: { type: Boolean } }, emits: ["click"], setup(u, { emit: p }) {
  const a = u, m = p, b = k(), _ = d({ name: "MDButtonSlottedContent", props: { slotName: { type: String, required: true } }, setup(t, { slots: e }) {
