import { E as J, C as D, a4 as q, M as w, a5 as be, a6 as ce, N as fe, a7 as ge, X as we, r as Y, l as Q, $ as Se, a0 as Ee, a2 as Z, n as Te, D as _, _ as Oe, g as ue, y as N, H as _e, j as Ae } from "./iframe-CHPDa0j6.js";
function Re(e, t, n = {}) {
  let o, u, i, l = true;
  const a = () => {
    l = true, i();
...
function Ne(...e) {
  ...
  const t = e[0];
  return typeof t == "function" ? we(q(() => ({ get: t, set: j }))) : Y(t);
}
function ee(e, t) {
  function n(...o) {
...
function Ge(e, t, n, o = {}) {
  ...
  if (!n) return S;
  const g = w(t), T = Ie(g), E = (u = o.serializer) !== null && u !== void 0 ? u : Je[T], { pause: C, resume: B } = K(S, (m) => P(m), { flush: i, deep: l, eventFilter: v });
  D(h, () => F(), { flush: i });
  let H = false;
  const z = (m) => {
    y && !H || F(m);
...
const ae = 1;
function dt(e, t = {}) {
  const { throttle: n = 0, idle: o = 200, onStop: u = j, onScroll: i = j, offset: l = { left: 0, right: 0, top: 0, bottom: 0 }, observe: a = { mutation: false }, eventListenerOptions: f = { capture: false, passive: true }, behavior: c = "auto", window: s = R, onError: r = (p) => {
    console.error(p);
  ...
  const T = _(false), E = ue({ left: true, right: false, top: true, bottom: false }), C = ue({ left: false, right: false, top: false, bottom: false }), B = (p) => {
    ...
    F === "flex" && W === "column-reverse" ? (E.top = ie, E.bottom = re) : (E.top = re, E.bottom = ie), y.value = L;
  }, U = (p) => {
    var P;
    s && (z((P = p.target.documentElement) !== null && P !== void 0 ? P : p.target), T.value = true, H(p), i(p));
  };
  return x(e, "scroll", n ? je(U, n, true, false) : U, f), V(() => {
    try {
      const p = w(e);
      if (!p) return;
      z(p);
