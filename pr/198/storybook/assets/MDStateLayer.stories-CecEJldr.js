import { d, r as n, h as p } from "./iframe-CfPEjc40.js";
import { M as c } from "./MDButton-BmeEqZ5T.js";
...
import { M as l, u, a as v } from "./useStateLayer-u2hHl2SF.js";
...
const m = d({ components: { MDStateLayer: l }, props: { label: { type: String, required: true }, disabled: { type: Boolean, default: false }, enableRipple: { type: Boolean, default: true }, dragged: { type: Boolean, default: false } }, setup(a) {
  ...
  ` }), w = { title: "shared/ui/MDStateLayer", component: l, parameters: { layout: "centered" } }, e = { tags: ["visual"], render: () => ({ components: { MDStateLayer: l, StateLayerDemoHost: m }, template: `
...
const k = ["VisualStates", "VisualHostIntegration"];
export {
