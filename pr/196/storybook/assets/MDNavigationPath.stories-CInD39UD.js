import { d as P, o as i, p as y, j as d, B, c as m, a as p, F as g, f as x, y as k, r as R } from "./iframe-B-HpdiJM.js";
import { M as _ } from "./MDButton-BqMwW_SR.js";
...
import { M as S } from "./MDSymbol-DMaJ66ZI.js";
...
import "./MDLoadingIndicator-ChpwtKNl.js";
...
const u = { SEPARATOR: "/", normalize(t) {
...
} }, j = P({ __name: "MDNavigationPathSegmentButton", props: { label: {}, path: {} }, emits: ["click"], setup(t, { emit: e }) {
  const a = t, o = e, s = () => {
    o("click", a.path);
  };
  return (h, l) => (i(), y(d(_), { label: t.label, color: "text", class: "md-navigation-path-segment-button", onClick: s }, null, 8, ["label"]));
} }), N = { class: "md-navigation-path", role: "navigation", "aria-label": "Path" }, A = P({ __name: "MDNavigationPath", props: { path: {}, hideCurrent: { type: Boolean } }, emits: ["click", "clickHome"], setup(t, { emit: e }) {
  ...
  return (r, f) => (i(), m("div", N, [p(d(z), { tooltip: "Home", "md-symbol-name": "home", color: "standard", class: "md-navigation-path__home-button", onClick: D }), (i(true), m(g, null, x(M.value, ({ name: c, path: v }) => (i(), m(g, { key: v }, [p(d(S), { class: "md-navigation-path__separator", name: "chevron_right" }), p(j, { label: c, path: v, onClick: C }, null, 8, ["label", "path"])], 64))), 128))]));
