import { r as X, y as w, l as D, z as ce, J as Y, p as J, a4 as Z, a5 as be, Z as Q, a6 as fe, a7 as ge, W as we, $ as Se, a0 as Ee, K as Te, s as _, a2 as Oe, m as _e, G as ue, b as N, u as Ae } from "./iframe-Cwlq_Bp7.js";
function Re(e, t, n = {}) {
  let o, u, i, l = true;
  const a = () => {
    l = true, i();
...
const Ce = (e) => e != null, De = Object.prototype.toString, Me = (e) => De.call(e) === "[object Object]", z = () => {
};
function Ne(...e) {
  if (e.length !== 1) return ge(...e);
  const t = e[0];
  return typeof t == "function" ? we(Z(() => ({ get: t, set: z }))) : X(t);
}
function ee(e, t) {
  function n(...o) {
...
function ze(e, t = 200, n = false, o = true, u = false) {
...
const ae = 1;
function dt(e, t = {}) {
  const { throttle: n = 0, idle: o = 200, onStop: u = z, onScroll: i = z, offset: l = { left: 0, right: 0, top: 0, bottom: 0 }, observe: a = { mutation: false }, eventListenerOptions: f = { capture: false, passive: true }, behavior: c = "auto", window: s = R, onError: r = (p) => {
    console.error(p);
  ...
  const T = _(false), E = ue({ left: true, right: false, top: true, bottom: false }), C = ue({ left: false, right: false, top: false, bottom: false }), B = (p) => {
    ...
    var F;
    if (!s) return;
    const M = (p == null || (F = p.document) === null || F === void 0 ? void 0 : F.documentElement) || p?.documentElement || A(p), { display: W, flexDirection: P, direction: m } = s.getComputedStyle(M), b = m === "rtl" ? -1 : 1, O = M.scrollLeft;
    ...
    var F;
    s && (j((F = p.target.documentElement) !== null && F !== void 0 ? F : p.target), T.value = true, H(p), i(p));
  };
  return x(e, "scroll", n ? ze(U, n, true, false) : U, f), V(() => {
    try {
      const p = w(e);
      if (!p) return;
      j(p);
