import { E as J, C as D, a5 as q, M as w, a6 as be, a7 as ce, N as fe, a8 as ge, X as we, r as Y, l as Q, a0 as Se, a1 as Ee, a3 as Z, n as Te, D as _, _ as Oe, g as ue, y as N, H as _e, i as Ae } from "./iframe-CQBWsFbd.js";
function Re(e, t, n = {}) {
  let o, u, i, l = true;
  const a = () => {
    l = true, i();
  ...
  D(e, a, { flush: "sync", ...n });
  const f = typeof t == "function" ? t : t.get, c = typeof t == "function" ? void 0 : t.set, s = q((r, v) => (u = r, i = v, { get() {
...
function Ne(...e) {
  ...
  const t = e[0];
  return typeof t == "function" ? we(q(() => ({ get: t, set: B }))) : Y(t);
}
function ee(e, t) {
  function n(...o) {
...
function ot(e, t, n = {}) {
  const { flush: o = "sync", deep: u = false, immediate: i = true } = n, l = H(t);
...
function x(...e) {
  const t = (o, u, i, l) => (o.addEventListener(u, i, l), () => o.removeEventListener(u, i, l)), n = N(() => {
    const o = H(w(e[0])).filter((u) => u != null);
    return o.every((u) => typeof u != "string") ? o : void 0;
  });
  return je(() => {
    var o, u;
    return [(o = (u = n.value) === null || u === void 0 ? void 0 : u.map((i) => A(i))) !== null && o !== void 0 ? o : [R].filter((i) => i != null), H(w(n.value ? e[1] : e[0])), H(Ae(n.value ? e[2] : e[1])), w(n.value ? e[3] : e[2])];
  }, ([o, u, i, l], a, f) => {
...
function ut(...e) {
  ...
  const { target: u = R, eventName: i = "keydown", passive: l = false, dedupe: a = false } = o, f = He(t);
  return x(u, i, (s) => {
...
function Ge(e, t, n, o = {}) {
  ...
  if (!n) return S;
  const g = w(t), T = Ie(g), E = (u = o.serializer) !== null && u !== void 0 ? u : Je[T], { pause: C, resume: L } = K(S, (m) => P(m), { flush: i, deep: l, eventFilter: v });
  D(h, () => F(), { flush: i });
  let $ = false;
  const z = (m) => {
    y && !$ || F(m);
...
function dt(e, t = {}) {
  ...
  const T = _(false), E = ue({ left: true, right: false, top: true, bottom: false }), C = ue({ left: false, right: false, top: false, bottom: false }), L = (p) => {
    ...
    var P;
    s && (z((P = p.target.documentElement) !== null && P !== void 0 ? P : p.target), T.value = true, $(p), i(p));
  };
