import { d as Cs, c as $s, i as Es, l as Vt, e as Ms } from "./iframe-DzT2Xe0C.js";
...
const dt = globalThis, pi = dt.ShadowRoot && (dt.ShadyCSS === void 0 || dt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, fi = /* @__PURE__ */ Symbol(), wi = /* @__PURE__ */ new WeakMap();
let Bi = class {
  constructor(e, t, i) {
    if (this._$cssResult$ = true, i !== fi) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (pi && e === void 0) {
      ...
      i && (e = wi.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), i && wi.set(t, e));
    }
    return e;
  }
  toString() {
...
const s = (a2) => new Bi(typeof a2 == "string" ? a2 : a2 + "", void 0, fi), z = (a2, ...e) => {
  const t = a2.length === 1 ? a2[0] : e.reduce((i, n, o) => i + ((l) => {
    if (l._$cssResult$ === true) return l.cssText;
    if (typeof l == "number") return l;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + l + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(n) + a2[o + 1], a2[0]);
  return new Bi(t, a2, fi);
}, As = (a2, e) => {
  if (pi) a2.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
...
}, ki = pi ? (a2) => a2 : (a2) => a2 instanceof CSSStyleSheet ? ((e) => {
  let t = "";
  for (const i of e.cssRules) t += i.cssText;
  return s(t);
})(a2) : a2;
const { is: zs, defineProperty: Ls, getOwnPropertyDescriptor: Ds, getOwnPropertyNames: Ps, getOwnPropertySymbols: Is, getPrototypeOf: Rs } = Object, Tt = globalThis, Ci = Tt.trustedTypes, Ws = Ci ? Ci.emptyScript : "", Hs = Tt.reactiveElementPolyfillSupport, Ue = (a2, e) => a2, Pt = { toAttribute(a2, e) {
  switch (e) {
    case Boolean:
      a2 = a2 ? Ws : null;
      break;
  ...
  return t;
} }, gi = (a2, e) => !zs(a2, e), $i = { attribute: true, type: String, converter: Pt, reflect: false, useDefault: false, hasChanged: gi };
...
let ye = class extends HTMLElement {
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const n of i) t.unshift(ki(n));
    } else e !== void 0 && t.push(ki(e));
    return t;
  }
  static _$Eu(e, t) {
    const i = t.attribute;
  ...
  requestUpdate(e, t, i, n = false, o) {
    if (e !== void 0) {
      ...
      if (n === false && (o = this[e]), i ??= l.getPropertyOptions(e), !((i.hasChanged ?? gi)(o, t) || i.useDefault && i.reflect && o === this._$Ej?.get(e) && !this.hasAttribute(l._$Eu(e, i)))) return;
      this.C(e, t, i);
    }
...
const yi = globalThis, Ei = (a2) => a2, It = yi.trustedTypes, Mi = It ? It.createPolicy("lit-html", { createHTML: (a2) => a2 }) : void 0, Oi = "$lit$", U = `lit$${Math.random().toFixed(9).slice(2)}$`, Ui = "?" + U, Ts = `<${Ui}>`, ce = document, Ge = () => ce.createComment(""), Qe = (a2) => a2 === null || typeof a2 != "object" && typeof a2 != "function", vi = Array.isArray, Ns = (a2) => vi(a2) || typeof a2?.[Symbol.iterator] == "function", jt = `[ 	
\f\r]`, Pe = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Si = /-->/g, Ai = />/g, Z = RegExp(`>|${jt}(?:([^\\s"'>=/]+)(${jt}*=${jt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), zi = /'/g, Li = /"/g, Vi = /^(?:script|style|textarea|title)$/i, Fs = (a2) => (e, ...t) => ({ _$litType$: a2, strings: e, values: t }), A = Fs(1), $e = /* @__PURE__ */ Symbol.for("lit-noChange"), w = /* @__PURE__ */ Symbol.for("lit-nothing"), Di = /* @__PURE__ */ new WeakMap(), ae = ce.createTreeWalker(ce, 129);
function ji(a2, e) {
  if (!vi(a2) || !a2.hasOwnProperty("raw")) throw Error("invalid template strings array");
...
const qs = (a2, e) => {
  ...
  for (let m = 0; m < t; m++) {
    const u = a2[m];
    let p, g, c = -1, v = 0;
    for (; v < u.length && (l.lastIndex = v, g = l.exec(u), g !== null); ) v = l.lastIndex, l === Pe ? g[1] === "!--" ? l = Si : g[1] !== void 0 ? l = Ai : g[2] !== void 0 ? (Vi.test(g[2]) && (n = RegExp("</" + g[2], "g")), l = Z) : g[3] !== void 0 && (l = Z) : l === Z ? g[0] === ">" ? (l = n ?? Pe, c = -1) : g[1] === void 0 ? c = -2 : (c = l.lastIndex - g[2].length, p = g[1], l = g[3] === void 0 ? Z : g[3] === '"' ? Li : zi) : l === Li || l === zi ? l = Z : l === Si || l === Ai ? l = Pe : (l = Z, n = void 0);
    const y = l === Z && a2[m + 1].startsWith("/>") ? " " : "";
    o += l === Pe ? u + Ts : c >= 0 ? (i.push(p), u.slice(0, c) + Oi + u.slice(c) + U + y) : u + U + (c === -2 ? m : y);
  }
  return [ji(a2, o + (a2[t] || "<?>") + (e === 2 ? "</svg>" : e === 3 ? "</math>" : "")), i];
};
class Je {
  constructor({ strings: e, _$litType$: t }, i) {
    ...
    for (; (n = ae.nextNode()) !== null && u.length < m; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const c of n.getAttributeNames()) if (c.endsWith(Oi)) {
      ...
      } else if (n.nodeType === 8) if (n.data === Ui) u.push({ type: 2, index: o });
      else {
        let c = -1;
...
class at {
  ...
  $(e) {
    const { values: t, _$litType$: i } = e, n = typeof i == "number" ? this._$AC(e) : (i.el === void 0 && (i.el = Je.createElement(ji(i.h, i.h[0]), this.options)), i);
  ...
  _$AC(e) {
    ...
    return t === void 0 && Di.set(e.strings, t = new Je(e)), t;
  }
  k(e) {
...
const Ks = yi.litHtmlPolyfillSupport;
Ks?.(Je, at), (yi.litHtmlVersions ??= []).push("3.3.3");
const Zs = (a2, e, t) => {
...
E._$litElement$ = true, E.finalized = true, bi.litElementHydrateSupport?.({ LitElement: E });
const Xs = bi.litElementPolyfillSupport;
Xs?.({ LitElement: E });
(bi.litElementVersions ??= []).push("4.2.2");
const Ys = { attribute: true, type: String, converter: Pt, reflect: false, hasChanged: gi }, Gs = (a2 = Ys, e, t) => {
...
function tn(a2, e) {
  ...
  for (let c = 0; c < e; c++) {
    ...
    if (y.type === "L") {
      const [L, D] = y.pts;
      u.push({ x: Pi(L.x, D.x, k), y: Pi(L.y, D.y, k) });
    } else if (y.type === "Q") {
      const [L, D, T] = y.pts;
      u.push(Ii(L, D, T, k));
    } else if (y.type === "C") {
...
function sn(a2) {
  return `${a2.map((t) => {
    const i = Wi(t.x * 100, 0, 100), n = Wi(t.y * 100, 0, 100);
...
function on(a2) {
  ...
  }), t = e[0], i = Math.sign(Hi(t));
  for (let n = 1; n < e.length; n++) {
    let o = e[n];
    const l = Math.sign(Hi(o));
...
var _e, re, ke, Ve, we, ct, ht, mt, ut, ve, Rt, Ki, si, Zi;
class qt extends rt {
  constructor(e, t) {
    super(e, t), _e.add(this), ke.set(this, false), Ve.set(this, void 0), we.set(this, void 0), ct.set(this, (i) => r(this, _e, "m", Ki).call(this, i)), ht.set(this, (i) => r(this, _e, "m", si).call(this, i)), mt.set(this, (i) => r(this, _e, "m", Zi).call(this, i)), ut.set(this, () => b(this, ke, true, "f")), ve.set(this, () => b(this, ke, false, "f")), b(this, Ve, t.callback, "f"), b(this, we, t.filter, "f");
  }
  _observe(e) {
...
re = qt, ke = /* @__PURE__ */ new WeakMap(), Ve = /* @__PURE__ */ new WeakMap(), we = /* @__PURE__ */ new WeakMap(), ct = /* @__PURE__ */ new WeakMap(), ht = /* @__PURE__ */ new WeakMap(), mt = /* @__PURE__ */ new WeakMap(), ut = /* @__PURE__ */ new WeakMap(), ve = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakSet(), Ki = function(e) {
  if (r(this, we, "f")?.call(this, e)) return;
  e.currentTarget.matches(":focus-within") && r(this, _e, "m", si).call(this, e);
}, si = function(e) {
...
Rt = { value: false };
var I, ne, Q, J, pt, be, ni, ot, lt, Xi, Yi;
class Gi extends rt {
  constructor(e, t) {
    super(e, t), I.add(this), ne.set(this, void 0), Q.set(this, /* @__PURE__ */ new Map()), J.set(this, /* @__PURE__ */ new Map()), pt.set(this, (i) => r(this, I, "m", Xi).call(this, i)), be.set(this, (i) => r(this, I, "m", Yi).call(this, i)), b(this, ne, t.callback, "f"), this.startDelay = t.startDelay ?? 0, this.endDelay = t.endDelay ?? 0;
  }
  clearDelays() {
    for (const e of this.targets) r(this, I, "m", ni).call(this, e);
  }
  _observe(e) {
  ...
  _unobserve(e) {
    e.removeEventListener("pointerenter", r(this, pt, "f")), e.removeEventListener("pointerleave", r(this, be, "f")), e.removeEventListener("touchend", r(this, be, "f")), r(this, I, "m", ni).call(this, e);
  }
}
ne = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), J = /* @__PURE__ */ new WeakMap(), pt = /* @__PURE__ */ new WeakMap(), be = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakSet(), ni = function(e) {
...
var B, M, q, je, oe, S, Ke, ft, gt, xe, yt, vt, Qi, Ji, es, ts, is, Xt;
class ss extends rt {
  constructor(e, t) {
    super(e, t), B.add(this), M.set(this, void 0), q.set(this, void 0), je.set(this, void 0), oe.set(this, void 0), S.set(this, /* @__PURE__ */ new Map()), Ke.set(this, void 0), ft.set(this, (i) => r(this, B, "m", Qi).call(this, i)), gt.set(this, (i) => r(this, B, "m", Ji).call(this, i)), xe.set(this, (i) => r(this, B, "m", es).call(this, i)), yt.set(this, (i) => r(this, B, "m", ts).call(this, i)), vt.set(this, (i) => r(this, B, "m", is).call(this, i)), b(this, M, t.capture, "f"), b(this, q, t.callback, "f"), b(this, je, t.filter, "f"), b(this, oe, t.isPressedKey, "f"), b(this, Ke, t.minPressedDuration ?? 0, "f");
  }
  hostConnected() {
...
M = /* @__PURE__ */ new WeakMap(), q = /* @__PURE__ */ new WeakMap(), je = /* @__PURE__ */ new WeakMap(), oe = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap(), Ke = /* @__PURE__ */ new WeakMap(), ft = /* @__PURE__ */ new WeakMap(), gt = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakMap(), yt = /* @__PURE__ */ new WeakMap(), vt = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakSet(), Qi = function(e) {
  ...
  e.pointerType === "mouse" && e.button > 1 || r(this, B, "m", Xt).call(this, e.x, e.y);
}, es = function(e) {
  r(this, B, "m", Xt).call(this, e.changedTouches[0]?.clientX ?? 0, e.changedTouches[0]?.clientY ?? 0);
}, ts = function(e) {
...
var le, Wt, Ze, _t, te, Ti, Yt, as, rs;
class cn extends rt {
  constructor(e, t) {
    super(e, t), le.add(this), Wt.set(this, void 0), Ze.set(this, void 0), _t.set(this, (i) => r(this, le, "m", rs).call(this, i)), te.set(this, /* @__PURE__ */ new Map()), b(this, Wt, t.debounce === true, "f"), b(this, Ze, t.callback, "f");
  }
  getScrollContainers(e) {
    return r(this, te, "f").get(e);
  }
  _observe(e) {
    const t = r(this, le, "m", as).call(this, e);
    if (t.length > 0) {
      r(this, te, "f").set(e, t);
...
Wt = /* @__PURE__ */ new WeakMap(), Ze = /* @__PURE__ */ new WeakMap(), _t = /* @__PURE__ */ new WeakMap(), te = /* @__PURE__ */ new WeakMap(), le = /* @__PURE__ */ new WeakSet(), Ti = function(e) {
  const t = e.shadowRoot;
  if (!t) return null;
  const i = document.createTreeWalker(t, NodeFilter.SHOW_ELEMENT);
  let n = i.currentNode;
  for (; n; ) {
    if (n instanceof Element && r(this, le, "m", Yt).call(this, n)) return n;
    n = i.nextNode();
  }
  return null;
}, Yt = function(e) {
  ...
  const t = new Array(), i = r(this, le, "m", Ti).call(this, e);
  i && t.push(i);
  let n = e;
  for (; n; ) r(this, le, "m", Yt).call(this, n) && t.push(n), n = n.parentElement;
  return t;
}, rs = function(e) {
  const t = e.target === document ? document.documentElement : e.target;
  r(this, Wt, "f") ? this._debounceCallback(t) : r(this, Ze, "f").call(this, t);
};
f([ns(40)], cn.prototype, "_debounceCallback", null);
function os(a2, ...e) {
  return typeof a2 == "object" && a2 !== null && e.every((t) => t in a2);
}
const V = /* @__PURE__ */ Symbol("internals"), Ni = /* @__PURE__ */ Symbol("_internals"), he = /* @__PURE__ */ Symbol("_customState");
function xi(a2, e) {
  var t;
  class i extends a2 {
    constructor() {
...
function Ce(a2, e) {
  ls(a2, e) || (he in a2 && a2[he].add(e), a2[V]?.states.add(e), a2[V]?.states.has(e));
}
function F(a2, e) {
...
function et(a2) {
  return os(a2, "disabled");
}
function cs(a2, e = true) {
  class t extends a2 {
    constructor() {
...
function tt(a2) {
  return os(a2, "disabledInteractive") && et(a2);
}
const Fi = ["click", "dblclick", "auxclick", "keydown", "keyup"], Sn = ["Tab", "ArrowLeft", "ArrowUp", "ArrowRight", "ArrowDown", "Left", "Up", "Right", "Down"], Qt = /* @__PURE__ */ Symbol("_suppressedEventHandler");
function On(a2) {
  var e;
  class t extends a2 {
    constructor() {
    ...
    connectedCallback() {
      Fi.forEach((n) => this.addEventListener(n, this[Qt], true)), super.connectedCallback();
    }
    disconnectedCallback() {
      Fi.forEach((n) => this.removeEventListener(n, this[Qt], true)), super.disconnectedCallback();
    }
    update(n) {
  ...
  return e = Qt, f([x({ attribute: "disabled-interactive", type: Boolean, reflect: true })], t.prototype, "disabledInteractive", void 0), t;
}
...
const Jt = /* @__PURE__ */ Symbol("_clickHandler");
function Vn(a2) {
  var e;
  class t extends a2 {
    constructor() {
    ...
    connectedCallback() {
      super.connectedCallback(), this.addEventListener("click", this[Jt]);
    }
    disconnectedCallback() {
      super.disconnectedCallback(), this.removeEventListener("click", this[Jt]);
    }
  }
  return e = Jt, t.formAssociated = true, f([x()], t.prototype, "name", null), f([x()], t.prototype, "value", null), f([x()], t.prototype, "type", void 0), t;
}
const fe = /* @__PURE__ */ Symbol("_control"), ei = /* @__PURE__ */ Symbol("_firstUpdated");
function Ot(a2) {
  var e;
  class t extends a2 {
    constructor() {
    ...
    firstUpdated(n) {
      super.firstUpdated(n), this[ei] = true;
    }
    update(n) {
      ...
      } else this.control && this[ei] && this.detach();
    }
    attach(n) {
  ...
  return e = ei, f([x({ attribute: "for" })], t.prototype, "htmlFor", void 0), t;
}
function jn(a2, e = true) {
  var t, i, n, o, l, m, u;
  class p extends a2 {
    constructor() {
...
const An = /* @__PURE__ */ Symbol("renderPseudoLink"), ti = /* @__PURE__ */ Symbol("_clickHandler");
function Kn(a2, e = false) {
  var t, i, n, o, l;
  class m extends a2 {
    constructor() {
    ...
    connectedCallback() {
      super.connectedCallback(), e || this.addEventListener("click", this[ti]), this.hasAttribute("href") && this.role === "button" && (this.role = "link");
    }
    disconnectedCallback() {
      super.disconnectedCallback(), e || this.removeEventListener("click", this[ti]);
    }
    [(t = /* @__PURE__ */ new WeakSet(), l = ti, An)]() {
      const p = et(this) && this.disabled, g = tt(this) && this.disabledInteractive;
      return !p && !g && this.href ? A`<a href="${this.href}" target="${Kt(this.target || void 0)}" rel="${Kt(this.rel || void 0)}" download="${Kt(this.download || void 0)}" tabindex="-1" aria-hidden="true" @pointerdown="${r(this, t, "m", i)}" @focus="${r(this, t, "m", n)}" @blur="${r(this, t, "m", o)}"></a>` : w;
    }
  }
  return i = function(p) {
...
const ii = /* @__PURE__ */ Symbol("_wasConnected");
function zn(a2) {
  var e;
  class t extends a2 {
    constructor() {
    ...
    connectedCallback() {
      super.connectedCallback(), this[ii] && this.reconnectedCallback();
    }
    disconnectedCallback() {
      super.disconnectedCallback(), this[ii] = true;
    }
  }
  return e = ii, t;
}
...
var P, Xe, Ne, hs, Fe, qe, ri;
let Me = class extends xi(E) {
  constructor() {
  ...
  render() {
    return A`<slot @slotchange="${r(this, P, "m", hs)}"></slot>`;
  }
};
...
var Be, kt, Ct, $t, ms, us, ps;
let Se = class extends Ot(ue(E, "none")) {
  constructor() {
    super(...arguments), Be.add(this), kt.set(this, new Gi(this, { target: null, callback: (e) => r(this, Be, "m", ms).call(this, e) })), Ct.set(this, new qt(this, { target: null, callback: (e) => r(this, Be, "m", us).call(this, e) })), $t.set(this, new ss(this, { target: null, callback: (e) => r(this, Be, "m", ps).call(this, e) })), this.disabled = false, this.level = null;
  }
  attach(e) {
...
let Ae = class extends Ot(ue(E, "none")) {
  constructor() {
    super(...arguments), oi.add(this), Et.set(this, new qt(this, { target: null, callback: (e, t) => r(this, oi, "m", fs).call(this, t) })), this.inward = false, this.disabled = false;
  }
  show() {
...
let li = class extends hn(cs(ue(E, "none"))) {
  connectedCallback() {
...
let me = class extends Ot(ue(E, "none")) {
  constructor() {
    super(...arguments), ie.add(this), $.set(this, null), Mt.set(this, new ss(this, { target: null, minPressedDuration: 150, isPressedKey: (e) => e === " ", callback: (e, { x: t, y: i }) => r(this, ie, "m", ys).call(this, e, t, i) })), this.disabled = false, this.centered = false, this.unbounded = false, this.radius = null;
  }
  get visible() {
...
let ze = class extends xi(E) {
  ...
  _updateScroll() {
    ...
    ai(this, "--above", e), ai(this, "--below", t);
  }
};
...
f([ns(40)], ze.prototype, "_updateScroll", null);
ze = f([R("m3e-scroll-container")], ze);
var Ye, de, vs, _i;
let Ht = class extends xi(E) {
  constructor() {
  ...
  update(e) {
    super.update(e), e.has("selectedIndex") && (this.selectedIndex === null && Ce(this, "--no-animate"), r(this, Ye, "m", _i).call(this), this.selectedIndex !== null && ls(this, "--no-animate") && requestAnimationFrame(() => {
      this.selectedIndex !== null && F(this, "--no-animate");
    }));
  }
  render() {
    return A`<slot @slotchange="${r(this, Ye, "m", vs)}"></slot>`;
  }
};
...
vs = function(e) {
  ...
  b(this, de, t, "f"), r(this, Ye, "m", _i).call(this);
};
_i = function() {
...
let Le = class extends Ot(ue(E, "none")) {
  constructor() {
    super(...arguments), At.add(this), zt.set(this, new Gi(this, { target: null, callback: (e) => r(this, At, "m", bs).call(this, e) })), Lt.set(this, new qt(this, { target: null, callback: (e, t) => r(this, At, "m", xs).call(this, t) })), this.disabled = false, this.disableHover = false;
  }
  show(e) {
...
let j = mi = class extends E {
  ...
  updated(e) {
    super.updated(e), (e.has("term") || e.has("caseSensitive") || e.has("disabled")) && r(this, O, "m", hi).call(this);
  }
  render() {
    return A`<slot @slotchange="${r(this, O, "m", hi)}"></slot>`;
  }
};
...
_s = function a(e, t) {
  e instanceof HTMLSlotElement ? e.assignedNodes({ flatten: true }).forEach((i) => {
    switch (i.nodeType) {
      case Node.TEXT_NODE:
        r(this, O, "m", ci).call(this, i) && t.push(i);
        break;
...
hi = function() {
  ...
  const e = new Array();
  if (r(this, O, "m", _s).call(this, this, e), e.length > 0) {
...
const Dn = ["aria-label"], Pn = 24, In = 240, Rn = 48, Wn = 38 / 48, Dt = Cs({ __name: "MDLoadingIndicator", props: { label: {}, size: { default: 48 } }, setup(a2) {
  const e = a2, t = Vt(() => Number.isFinite(e.size) ? Math.min(In, Math.max(Pn, e.size)) : Rn), i = Vt(() => t.value * Wn), n = Vt(() => ({ width: `${t.value}px`, height: `${t.value}px`, "--m3e-loading-indicator-size": `${i.value}px` }));
  return (o, l) => (Ms(), $s("m3e-loading-indicator", { class: "md-loading-indicator", "aria-label": e.label, style: Es(n.value) }, null, 12, Dn));
} }), ra = Ss(Dt, [["__scopeId", "data-v-b3881bd4"]]);
...
loading news article or refreshing page").`, tags: [], required: true, type: "string", declarations: [], schema: "string" }, { name: "size", global: false, description: `Overall Loading indicator component size in Material dp, mapped 1:1 to CSS
