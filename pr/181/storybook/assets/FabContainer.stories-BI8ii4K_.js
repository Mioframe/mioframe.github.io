import { d as g, N as L, C as _, c as H, a as E, w as M, e as a, v as u, i as D, h as b, o as A, b as B, n as T, g as I, r as l, $ as R } from "./iframe-jrS2Xpoj.js";
import { b as j, j as V, k as $, h as z } from "./index-CfVB1c-5.js";
import { i as N } from "./isUndefined-Dgw4-efh.js";
import { u as O, a as U, b as W, _ as q, o as G, s as J } from "./useOverlay-CC7SdfNB.js";
import { a as K } from "./index-DwleAfRN.js";
import { u as Q, d as X } from "./FabContainer.vue_vue_type_style_index_0_scoped_3ecc84a9_lang-TYv3Xrck.js";
...
import "./useStateLayer-SxWSlBff.js";
import "./MDIconButton-BVflWqWF.js";
import { _ as Y } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { M as m } from "./MDExtendedFab-DSe9hDzW.js";
import "./preload-helper-PPVm8Dsz.js";
import "./MDSymbol-DSr6de22.js";
...
const Z = ["aria-hidden"], ee = g({ __name: "FabContainer", props: { autoHide: { type: Boolean } }, setup(e) {
  ...
  const { focused: v } = $(s), x = b(() => !n.value || N(r.value) || r.value === "top" || v.value), C = O(), F = Q(), { floatingStyles: w } = U(F, s, { placement: "bottom-end", strategy: "fixed", transform: false, middleware: [G(({ rects: { floating: c } }) => ({ mainAxis: -c.height })), J({ padding: 16 })], whileElementsMounted: W }), { height: S } = z(s, { height: 0, width: 0 }, { box: "border-box" }), P = b(() => ({ height: `${S.value}px` })), k = K();
