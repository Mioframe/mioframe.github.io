import { d as C, i as D, o as m, c as b, n as N, f as g, e as s, j as L, b as E, a as S, t as O, h as v, U as G, F, l as q, V as I, L as H, J as T, B as Q, C as M } from "./iframe-wWaMc33J.js";
import { b as A, c as $, d as V, a as j, M as w } from "./useStateLayer-BCkE_jfh.js";
import { M as W } from "./MDSymbol-BD7cBTPe.js";
...
import { t as U } from "./index-CzGmZI-3.js";
...
const te = { class: "md-navigation-rail-button__symbol-container" }, ae = { class: "md-navigation-rail-button__label" }, oe = C({ __name: "MDNavigationRailButton", props: { symbol: {}, label: {}, active: { type: Boolean }, type: {}, hasRipple: { type: Boolean } }, emits: ["click"], setup(e, { emit: i }) {
  const t = e, a = i, o = D("refEl"), u = A(o), { focused: r } = $(o, { useTarget: true, focusVisible: true }), { durationPressedState: c } = V(o);
  j(v(() => t.hasRipple ? o.value : void 0));
  const d = v(() => t.type === _.railHorizontal), y = (f) => {
    a("click", f);
  };
  return (f, R) => (m(), b("button", { ref_key: "refEl", ref: o, type: "button", class: N(["md-navigation-rail-button md", [{ _active: e.active }, `_type-${e.type}`]]), onClick: y }, [d.value ? (m(), g(s(w), { key: 0, hover: s(u), focused: s(r), pressed: s(c) }, null, 8, ["hover", "focused", "pressed"])) : L("", true), E("span", te, [e.type === s(_).vertical ? (m(), g(s(w), { key: 0, hover: s(u), focused: s(r), pressed: s(c) }, null, 8, ["hover", "focused", "pressed"])) : L("", true), S(s(W), { class: "md-navigation-rail-button__symbol", name: e.symbol }, null, 8, ["name"])]), E("span", ae, O(e.label), 1)], 2));
...
const se = { class: "md-navigation-bar-button__label" }, ie = C({ __name: "MDNavigationBarButton", props: { label: {}, symbol: {}, active: { type: Boolean }, type: {} }, emits: ["click"], setup(e, { emit: i }) {
  const t = i, a = D("el");
  j(a);
  const o = A(a), { focused: u } = $(a, { useTarget: true, focusVisible: true }), { durationPressedState: r } = V(a), c = (d) => {
    t("click", d);
  };
  return (d, y) => (m(), b("button", { ref_key: "el", ref: a, class: N(["md-navigation-bar-button md", [{ _active: e.active }, `_type-${e.type}`]]), type: "button", onClick: c }, [S(s(w), { hover: s(o), focused: s(u), pressed: s(r) }, null, 8, ["hover", "focused", "pressed"]), S(s(W), { class: "md-navigation-bar-button__symbol", name: e.symbol }, null, 8, ["name"]), E("span", se, O(e.label), 1)], 2));
...
.`, type: 2, props: [{ name: "value", global: false, description: "", tags: [], required: true, type: "HTMLElement | null | undefined", schema: "HTMLElement | null | undefined", declarations: [] }, { name: "__@RefSymbol@304", global: false, description: `Type differentiator only.
We need this to be in public d.ts but don't want it to show up in IDE
