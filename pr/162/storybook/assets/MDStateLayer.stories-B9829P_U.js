import { d, r as n, l as p } from "./iframe-DhsDwekB.js";
import { M as c } from "./MDButton-NYqT0GeV.js";
import { M as l, u, a as v } from "./useStateLayer-srL00fdS.js";
...
const y = d({ components: { MDStateLayer: l }, props: { label: { type: String, required: true }, disabled: { type: Boolean, default: false }, enableRipple: { type: Boolean, default: true }, dragged: { type: Boolean, default: false } }, setup(a) {
  ...
  ` }), D = { title: "shared/ui/MDStateLayer", component: l, parameters: { layout: "centered" } }, e = { tags: ["visual"], render: () => ({ components: { MDStateLayer: l, StateLayerDemoHost: y }, template: `
...
const _ = ["VisualStates", "VisualHostIntegration"];
export {
