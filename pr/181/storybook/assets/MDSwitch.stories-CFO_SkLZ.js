import { d as oe, u as ce, N as re, B as ne, e as o, c as v, b as h, g as y, j as M, n as z, a as ie, O as le, P as de, h as l, i as ue, o as S, A as H, r as f } from "./iframe-CGoIUeDj.js";
import { u as pe, a as me, M as ve } from "./useStateLayer-D2dIG2v_.js";
import { s as he } from "./uniqueId-CTut717w.js";
import { _ as Se } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { M as $ } from "./MDSymbol-D9wXXJnv.js";
import { _ as G } from "./MDStateLayerForcedStateProvider.vue_vue_type_script_setup_true_lang-CztPQHiJ.js";
import { u as we } from "./useFocusIndicator-xirUtGjh.js";
...
const be = { class: "md-switch__track" }, fe = { class: "md-switch__handle" }, De = { key: 0, class: "md-switch__icon", "aria-hidden": "true" }, ye = { key: 1, class: "md-switch__icon", "aria-hidden": "true" }, Me = ["for", "tabindex", "aria-label", "aria-labelledby", "aria-checked", "aria-disabled"], ge = ["id", "disabled"], ke = { class: "md-switch__track" }, _e = { class: "md-switch__handle", "data-md-focus-indicator-target": "" }, Ie = { key: 0, class: "md-switch__icon", "aria-hidden": "true" }, Pe = { key: 1, class: "md-switch__icon", "aria-hidden": "true" }, Le = oe({ __name: "MDSwitch", props: { selected: { type: Boolean, default: false }, disabled: { type: Boolean }, id: { default: () => he("switch") }, ariaLabel: {}, ariaLabelledby: {}, autofocus: { type: Boolean }, tabIndex: { default: 0 }, presentation: { type: Boolean } }, emits: ["update:selected", "change"], setup(t, { emit: i }) {
  const w = t, D = i, d = ce(), { disabled: a, selected: J, presentation: u } = re(w), s = l({ get: () => !!J.value, set: (e) => {
    D("update:selected", e), D("change", e);
  } }), U = l(() => !!d["selected-icon"]), E = l(() => !!d["unselected-icon"]), A = l(() => s.value ? U.value : E.value), N = () => {
    u.value || a.value || (s.value = !s.value);
  }, p = H(false), R = H(0), b = H(false), Q = (e) => {
    u.value || a.value || e.button !== 0 || (p.value = true, R.value = e.clientX, b.value = false, n.value?.setPointerCapture?.(e.pointerId));
  }, Y = (e) => {
    p.value && e.preventDefault();
  }, Z = (e) => {
    if (!p.value) return;
    p.value = false, n.value?.releasePointerCapture?.(e.pointerId);
    const c = e.clientX - R.value;
    if (Math.abs(c) > 4) {
      b.value = true;
      const m = n.value;
      if (m) {
...
`, Ue = () => ({ components: { MDSwitch: r }, setup: () => {
  ...
  return { changeCount: t, selected: i, onChange: () => {
    ...
    ` }) }, L = { render: Ue }, F = { render: Ee }, C = { tags: ["visual"], render: () => ({ components: { MDSwitch: r }, template: Fe }) }, x = { tags: ["visual"], render: () => ({ components: { MDSwitch: r, MDStateLayerForcedStateProvider: G }, template: Ce }) }, T = { tags: ["visual"], render: () => ({ components: { MDSwitch: r, MDSymbol: $ }, template: xe }) }, V = { tags: ["visual"], render: () => ({ components: { MDSwitch: r, MDSymbol: $, MDStateLayerForcedStateProvider: G }, template: Te }) }, B = { render: () => ({ components: { MDSwitch: r }, setup() {
  we();
}, template: `
