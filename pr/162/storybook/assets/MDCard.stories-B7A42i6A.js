import { M as q } from "./MDButton-BL1kYdfo.js";
import "./MDLoadingIndicator-BxaW09W2.js";
import { M as e } from "./MDCard-DbaHNTmK.js";
import { d as I, c as A, a as n, b as g, w as h, t as f, r as b, e as E, B as y } from "./iframe-CfWJo6hY.js";
import { _ as N } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import "./useStateLayer-DJsp2v26.js";
import "./index-b3-jZfhd.js";
import "./preload-helper-PPVm8Dsz.js";
const R = { class: "md-card-action-story visual-row" }, P = { class: "md-card-action-story__cell" }, z = { "data-testid": "md-card-button-action-count" }, B = { class: "md-card-action-story__cell" }, W = { "data-testid": "md-card-link-action-count" }, _ = { class: "md-card-action-story__cell" }, S = { "data-testid": "md-card-disabled-link-action-count" }, p = I({ __name: "MDCardActionVisualStory", setup(a) {
  const D = b(0), M = b(0), k = b(0), x = () => {
    D.value += 1;
  }, w = () => {
    M.value += 1;
  }, C = () => {
...
const G = { title: "shared/ui/MDCard", component: e, argTypes: { onAction: { action: "action" } }, parameters: { layout: "centered", docs: { description: { component: 'Material 3 card. Checked against `components/cards/overview.md`,\n`components/cards/specs.md`, `components/cards/guidelines.md`, and\n`components/cards/accessibility.md` (m3-docs-mcp cache).\n\nA card is either a non-actionable container that holds its own buttons/links\n(`mode="static"`, the default), or a directly actionable card surface with no\ninternal buttons/links (`mode="button"` / `mode="link"`). Material explicitly\nwarns against stacking actionable surfaces, so MDCard does not support nested\nbuttons/links inside an actionable card as a documented pattern \u2014 that\ncombination is a deviation from the component contract, not a supported slot\nshape.\n\n`mode="button"` renders the whole card as a native `<button>`, whose HTML\ncontent model only accepts phrasing content (text, inline elements, icons).\nMDCard does not restrict this at the type level (the default slot is\ngeneric), but it does warn in development when the rendered content\nincludes a block-level or interactive tag \u2014 use `mode="static"` for rich\nblock content or cards with internal buttons/links instead. `mode="link"`\nhas no such restriction: `<a>` accepts flow content.' } } } }, i = { render: () => ({ components: { MDCard: e }, template: `
    ...
    ` }) }, r = { name: "Static card with internal actions", render: () => ({ components: { MDCard: e, MDButton: q }, template: `
    ...
    ` }) }, s = { name: "Actionable button card", render: (a) => ({ components: { MDCard: e }, setup: () => ({ args: a }), template: `
      <MDCard v-bind="args" mode="button" variant="elevated" style="width: 220px;" @action="args.onAction">
        Tap this whole card
      </MDCard>
    ` }) }, l = { name: "Actionable link card", render: (a) => ({ components: { MDCard: e }, setup: () => ({ args: a }), template: `
    ...
    ` }) }, d = { name: "Actionable card action/keyboard behavior", render: () => ({ components: { MDCardActionVisualStory: V }, template: "<MDCardActionVisualStory />" }) }, o = { name: "Disabled actionable cards", render: () => ({ components: { MDCard: e }, template: `
      <div class="visual-row">
    ...
    ` }) }, c = { render: () => ({ components: { MDCard: e }, template: `
...
`, u = { tags: ["visual"], render: () => ({ components: { MDCard: e }, template: `
      <div data-testid="visual-md-card-interaction-states" class="visual-checker-backdrop">
        ${v("elevated")}
        ${v("filled")}
        ${v("outlined")}
      </div>
    ` }) }, m = { tags: ["visual"], render: () => ({ components: { MDCard: e }, template: `
...
const J = ["Variants", "StaticWithInternalActions", "ActionableButtonCard", "ActionableLinkCard", "ActionBehavior", "DisabledActionableCards", "Dragged", "VisualInteractionStates", "VisualStates"];
export {
  d as ActionBehavior,
  s as ActionableButtonCard,
  l as ActionableLinkCard,
  o as DisabledActionableCards,
  c as Dragged,
  r as StaticWithInternalActions,
  i as Variants,
  u as VisualInteractionStates,
  m as VisualStates,
