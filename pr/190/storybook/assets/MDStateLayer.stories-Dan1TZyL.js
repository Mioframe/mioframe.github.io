import { d, r as n, h as p } from "./iframe-n94PV55C.js";
import { M as c } from "./MDButton-KgnbpXuH.js";
import "./MDLoadingIndicator-CKzDpcYY.js";
import "./MDSwitch.vue_vue_type_style_index_0_scoped_579f9506_lang-CELtLxdn.js";
import { M as l, u, a as v } from "./useStateLayer-BwcQqoWp.js";
...
const m = d({ components: { MDStateLayer: l }, props: { label: { type: String, required: true }, disabled: { type: Boolean, default: false }, enableRipple: { type: Boolean, default: true }, dragged: { type: Boolean, default: false } }, setup(a) {
  ...
  ` }), M = { title: "shared/ui/MDStateLayer", component: l, parameters: { layout: "centered" } }, e = { tags: ["visual"], render: () => ({ components: { MDStateLayer: l, StateLayerDemoHost: m }, template: `
...
const j = ["VisualStates", "VisualHostIntegration"];
export {
