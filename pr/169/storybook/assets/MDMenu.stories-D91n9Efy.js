import { d as v, R, D as O, B as E, m as T, o as a, f as b, F as I, g as C, h as f, u as o, E as D, t as U, c as h, w as _, A as $, S as g, j as x, s as P, b as N, I as V, i as F, T as j, r as q } from "./iframe-Dc00fXbl.js";
import { M as B } from "./MDSymbol-B4px_Re3.js";
import { u as A, a as H, M as z } from "./useStateLayer-DrC7-UCD.js";
import { u as G, M as L } from "./MDMenuItemBase.vue_vue_type_style_index_0_scoped_fc574696_lang-COnmBkn4.js";
import { _ as J } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { M as K } from "./MDButton-92cvE20U.js";
import "./MDLoadingIndicator-DTjjhR9h.js";
import "./preload-helper-PPVm8Dsz.js";
import "./index-ChIkYlLg.js";
import "./main-ChGonpFT.js";
import "./floating-ui.vue-BDPM0VcI.js";
import "./useFocusTrap-DtwQhGZo.js";
...
const Q = ["role"], X = { key: 0, class: "md-menu-item-base__leading" }, Y = { class: "md-menu-item-base__label" }, Z = { key: 1, class: "md-menu-item-base__trailing" }, ee = v({ __name: "MDMenuItemBase", props: g({ label: {}, itemRole: {}, symbolName: {} }, { showSubmenu: { type: Boolean }, showSubmenuModifiers: {} }), emits: g(["click"], ["update:showSubmenu"]), setup(e, { emit: r }) {
  ...
  return G(t, y), (M, c) => (a(), b(I, null, [C("button", { ref_key: "menuItemEl", ref: s, type: "button", class: "md-menu-item-base", role: e.itemRole ?? void 0, onClick: d }, [f(o(z), { hover: o(w), focused: o(k), pressed: o(S) }, null, 8, ["hover", "focused", "pressed"]), e.symbolName ? (a(), b("span", X, [f(o(B), { name: e.symbolName }, null, 8, ["name"])])) : D("", true), C("span", Y, U(o(t)), 1), m.submenu ? (a(), b("span", Z, [f(o(B), { name: "arrow_right" })])) : D("", true)], 8, Q), m.submenu ? (a(), h(L, { key: 0, show: u.value, "onUpdate:show": c[0] || (c[0] = (W) => u.value = W), target: s.value, "disabled-teleport": "", placement: "right-start" }, { default: _(() => [$(M.$slots, "submenu", {}, void 0, true)]), _: 3 }, 8, ["show", "target"])) : D("", true)], 64));
  ...
  return (t, s) => {
    ...
    return a(), h(te, { label: e.item.label, "symbol-name": e.item.symbolName, "item-role": e.itemRole, onClick: l }, V({ _: 2 }, [e.item.submenu ? { name: "submenu", fn: _(() => [(a(true), b(I, null, F(e.item.submenu, (d) => (a(), h(u, { key: d.label, item: d, "item-role": e.itemRole, onClick: m }, null, 8, ["item", "item-role"]))), 128))]), key: "0" } : void 0]), 1032, ["label", "symbol-name", "item-role"]);
  };
  ...
  return (y, M) => (a(), h(L, { show: n.value, "onUpdate:show": M[0] || (M[0] = (c) => n.value = c), target: o(m), "outside-ignore": o(s), "disabled-teleport": e.disabledTeleport, placement: o(u), "aria-label": e.ariaLabel, role: e.role, onDeactivateFocus: k, onInteractionOutside: S }, { default: _(() => [(a(true), b(I, null, F(o(t), (c) => (a(), h(oe, { key: c.key, item: c, "item-role": w.value, onClick: d }, null, 8, ["item", "item-role"]))), 128))]), _: 1 }, 8, ["show", "target", "outside-ignore", "disabled-teleport", "placement", "aria-label", "role"]));
