import { d, k as B, u as z, c as S, p as c, w as M, i as o, q as x, b as C, t as D, m as w, y as s, o as r, h as N, Z as A } from "./iframe-Ca4XsWix.js";
import "./MDButton.vue_vue_type_style_index_0_scoped_b23df5d8_lang-BmCPi_QP.js";
import { M as I } from "./MDLoadingIndicator-CsiSpm2b.js";
...
const V = ["aria-busy", "disabled", "size", "type", "variant"], q = { class: "md-button__label-text" }, L = d({ inheritAttrs: false, __name: "MDButton", props: { nativeType: { default: "button" }, color: { default: "filled" }, label: {}, disabled: { type: Boolean }, size: { default: "small" }, loading: { type: Boolean } }, emits: ["click"], setup(u, { emit: p }) {
  const a = u, m = p, b = B(), f = d({ name: "MDButtonSlottedContent", props: { slotName: { type: String, required: true } }, setup(t, { slots: e }) {
  ...
  return (t, e) => (r(), S("m3e-button", w(k(), { class: ["md-button", o(l).class], style: o(l).style, "aria-busy": n.value ? "true" : void 0, disabled: a.disabled, shape: "rounded", size: y.value, toggle: false, type: v.value, variant: _.value, onClick: h }), [n.value || b.icon ? (r(), c(o(f), { key: 0, class: "md-button__icon", "slot-name": "icon" }, { default: M(() => [n.value ? (r(), c(o(I), { key: 0, class: "md-button__loading-indicator", "aria-hidden": "true", label: a.label, size: g.value }, null, 8, ["label", "size"])) : N(t.$slots, "icon", {}, void 0, true, 1)]), _: 3 })) : x("", true), C("span", q, D(a.label), 1)], 16, V));
} }), P = T(L, [["__scopeId", "data-v-b23df5d8"]]);
export {
  P as M
};
