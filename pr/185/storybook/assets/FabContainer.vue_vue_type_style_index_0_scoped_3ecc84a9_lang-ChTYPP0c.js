import { d as C, i as D, o as m, c as b, n as N, f as g, e as s, j as E, b as L, a as S, t as O, h as v, T as J, F, l as T, U as I, K as q, I as A, A as Q, B as M } from "./iframe-BW_3G6Xd.js";
import { b as H, c as $, d as j, a as K, M as w } from "./useStateLayer-BheEhEQ0.js";
import { M as V } from "./MDSymbol-BapSH0y3.js";
...
import { t as U } from "./index-CvzXYYFH.js";
...
const te = { class: "md-navigation-rail-button__symbol-container" }, ae = { class: "md-navigation-rail-button__label" }, oe = C({ __name: "MDNavigationRailButton", props: { symbol: {}, label: {}, active: { type: Boolean }, type: {}, hasRipple: { type: Boolean } }, emits: ["click"], setup(e, { emit: i }) {
  const t = e, a = i, o = D("refEl"), u = H(o), { focused: r } = $(o, { useTarget: true, focusVisible: true }), { durationPressedState: c } = j(o);
  K(v(() => t.hasRipple ? o.value : void 0));
  const d = v(() => t.type === _.railHorizontal), y = (f) => {
    a("click", f);
  };
  return (f, R) => (m(), b("button", { ref_key: "refEl", ref: o, type: "button", class: N(["md-navigation-rail-button md", [{ _active: e.active }, `_type-${e.type}`]]), onClick: y }, [d.value ? (m(), g(s(w), { key: 0, hover: s(u), focused: s(r), pressed: s(c) }, null, 8, ["hover", "focused", "pressed"])) : E("", true), L("span", te, [e.type === s(_).vertical ? (m(), g(s(w), { key: 0, hover: s(u), focused: s(r), pressed: s(c) }, null, 8, ["hover", "focused", "pressed"])) : E("", true), S(s(V), { class: "md-navigation-rail-button__symbol", name: e.symbol }, null, 8, ["name"])]), L("span", ae, O(e.label), 1)], 2));
} }), ne = W(oe, [["__scopeId", "data-v-518bf59b"]]);
p.collapsed;
const se = { class: "md-navigation-bar-button__label" }, ie = C({ __name: "MDNavigationBarButton", props: { label: {}, symbol: {}, active: { type: Boolean }, type: {} }, emits: ["click"], setup(e, { emit: i }) {
  const t = i, a = D("el");
  K(a);
  const o = H(a), { focused: u } = $(a, { useTarget: true, focusVisible: true }), { durationPressedState: r } = j(a), c = (d) => {
    t("click", d);
  };
  return (d, y) => (m(), b("button", { ref_key: "el", ref: a, class: N(["md-navigation-bar-button md", [{ _active: e.active }, `_type-${e.type}`]]), type: "button", onClick: c }, [S(s(w), { hover: s(o), focused: s(u), pressed: s(r) }, null, 8, ["hover", "focused", "pressed"]), S(s(V), { class: "md-navigation-bar-button__symbol", name: e.symbol }, null, 8, ["name"]), L("span", se, O(e.label), 1)], 2));
} }), re = W(ie, [["__scopeId", "data-v-2183c128"]]);
...
const Y = /* @__PURE__ */ Symbol("PROVIDE_PANE_SCROLL_CONTAINER_KEY"), ce = v(() => document.body), x = (e) => {
  q(Y, v(() => e.value));
}, Me = () => A(Y, ce);
...
.`, type: 2, props: [{ name: "value", global: false, description: "", tags: [], required: true, type: "HTMLElement | null | undefined", schema: "HTMLElement | null | undefined", declarations: [] }, { name: "__@RefSymbol@313", global: false, description: `Type differentiator only.
We need this to be in public d.ts but don't want it to show up in IDE
