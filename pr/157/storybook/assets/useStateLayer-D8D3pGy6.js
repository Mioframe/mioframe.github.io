import { p as ze, v as _e, d as We, c as Be, n as Oe, l as D, e as Ce, r as F, x as w, j as M, y as we, V as re, m as Z, a4 as se, a5 as Le, W as le, a6 as ke, a7 as Fe, R as Ve, Y as je, Z as He, a0 as $e, s as I, a1 as Ue, k as xe, C as he, u as Ke } from "./iframe-Ds94X5Or.js";
...
function Ye(e, t = 25, n = {}) {
  ...
  let a, r, s = [], i, o;
  const u = (l, m) => (i = Xe(e, l, m), i.finally(() => {
    if (i = null, n.trailing && o && !r) {
      const f = u(l, o);
      return o = null, f;
    }
  }), i), c = function(...l) {
    return n.trailing && (o = l), i || new Promise((m) => {
      const f = !r && n.leading;
...
ee.__docgenInfo = Object.assign({ displayName: ee.name ?? ee.__name }, { exportName: "provideMDStateLayerForcedState", displayName: "provideMDStateLayerForcedState", type: 2, props: [{ name: "hovered", global: false, description: "Forces the hover state-layer visual on or off when set.", tags: [], required: false, type: "Ref<boolean | undefined, boolean | undefined>", declarations: [], schema: "Ref<boolean | undefined, boolean | undefined>" }, { name: "focused", global: false, description: "Forces the focus state-layer visual on or off when set.", tags: [], required: false, type: "Ref<boolean | undefined, boolean | undefined>", declarations: [], schema: "Ref<boolean | undefined, boolean | undefined>" }, { name: "pressed", global: false, description: "Forces the pressed state-layer visual on or off when set.", tags: [], required: false, type: "Ref<boolean | undefined, boolean | undefined>", declarations: [], schema: "Ref<boolean | undefined, boolean | undefined>" }, { name: "dragged", global: false, description: "Forces the dragged state-layer visual on or off when set.", tags: [], required: false, type: "Ref<boolean | undefined, boolean | undefined>", declarations: [], schema: "Ref<boolean | undefined, boolean | undefined>" }], events: [], slots: [], exposed: [], sourceFiles: "/home/runner/work/mioframe/mioframe/app-source/src/shared/ui/material/foundation/state/forcedState.ts" });
const X = We({ __name: "MDStateLayer", props: { hover: { type: Boolean, default: false }, focused: { type: Boolean, default: false }, pressed: { type: Boolean, default: false }, dragged: { type: Boolean, default: false }, disabled: { type: Boolean, default: false } }, setup(e) {
  const t = e, n = Ze(), a = D(() => n?.hovered?.value ?? t.hover), r = D(() => n?.focused?.value ?? t.focused), s = D(() => n?.pressed?.value ?? t.pressed), i = D(() => n?.dragged?.value ?? t.dragged);
  return (o, u) => (Ce(), Be("span", { class: Oe(["md-state-layer", { "md-state_hover": !t.disabled && a.value, "md-state_focused": !t.disabled && r.value, "md-state_pressed": !t.disabled && s.value, "md-state_dragged": !t.disabled && i.value, "md-state_disabled": t.disabled }]), "aria-hidden": "true" }, null, 2));
} }), Bt = Je(X, [["__scopeId", "data-v-7b0009db"]]);
...
function Qe(e, t, n = {}) {
  ...
  M(e, o, { flush: "sync", ...n });
  const u = typeof t == "function" ? t : t.get, c = typeof t == "function" ? void 0 : t.set, d = se((l, m) => (r = l, s = m, { get() {
    return i && (a = u(a), i = false), r(), a;
  }, set(f) {
    c?.(f);
  } }));
...
function et(e) {
  let t = false, n;
  const a = Le(true);
  return ((...r) => (t || (n = a.run(() => e(...r)), t = true), n));
}
const tt = typeof window < "u" && typeof document < "u";
typeof WorkerGlobalScope < "u" && globalThis instanceof WorkerGlobalScope;
const nt = (e) => e != null, at = Object.prototype.toString, it = (e) => at.call(e) === "[object Object]", O = () => {
};
function rt(...e) {
...
function lt(...e) {
  let t = 0, n, a = true, r = O, s, i, o, u, c;
  !ke(e[0]) && typeof e[0] == "object" ? { delay: i, trailing: o = true, leading: u = true, rejectOnCancel: c = false } = e[0] : [i, o = true, u = true, c = false] = e;
  const d = () => {
    n && (clearTimeout(n), n = void 0, r(), r = O);
  };
  return (m) => {
    const f = w(i), b = Date.now() - t, k = () => s = m();
    return d(), f <= 0 ? (t = Date.now(), k()) : (b > f ? (t = Date.now(), (u || !a) && k()) : o && (s = new Promise((g, E) => {
      r = c ? E : g, n = setTimeout(() => {
...
function ot(e = qe, t = {}) {
  const { initialState: n = "active" } = t, a = rt(n === "active");
  function r() {
    a.value = false;
  }
  function s() {
  ...
  return { isActive: we(a), pause: r, resume: s, eventFilter: i };
}
function ge(e, t = false, n = "Timeout") {
  return new Promise((a, r) => {
    t ? setTimeout(r, e, n) : setTimeout(a, e);
  });
}
function j(e) {
...
function dt(e, t = 200, n = false, a = true, r = false) {
  return oe(lt(t, n, a, r), e);
}
function ut(e, t, n = {}) {
  const { eventFilter: a = qe, ...r } = n;
  return M(e, oe(a, t), r);
}
function ne(e, t, n = {}) {
  const { eventFilter: a, initialState: r = "active", ...s } = n, { eventFilter: i, pause: o, resume: u, isActive: c } = ot(a, { initialState: r });
  return { stop: ut(e, t, { ...s, eventFilter: i }), pause: o, resume: u, isActive: c };
}
function Lt(e, t, ...[n]) {
  const { flush: a = "sync", deep: r = false, immediate: s = true, direction: i = "both", transform: o = {} } = n || {}, u = [], c = "ltr" in o && o.ltr || ((m) => m), d = "rtl" in o && o.rtl || ((m) => m);
  return (i === "both" || i === "ltr") && u.push(ne(e, (m) => {
    u.forEach((f) => f.pause()), t.value = c(m), u.forEach((f) => f.resume());
  }, { flush: a, deep: r, immediate: s })), (i === "both" || i === "rtl") && u.push(ne(t, (m) => {
...
function ye(e, t, n = {}) {
  const { flush: a = "sync", deep: r = false, immediate: s = true } = n, i = j(t);
  return M(e, (o) => i.forEach((u) => u.value = o), { flush: a, deep: r, immediate: s });
}
function Ft(e, t) {
  Re() && $e(e, t);
}
...
function ae(e, t = false) {
  ...
  return Array.isArray(w(e)) ? { toMatch: n, toContains: u, changed: c, changedTimes: d, get not() {
    return ae(e, !t);
  } } : { toMatch: n, toBe: a, toBeTruthy: r, toBeNull: s, toBeNaN: o, toBeUndefined: i, changed: c, changedTimes: d, get not() {
    return ae(e, !t);
  } };
}
function Vt(e) {
...
function x(...e) {
  const t = (a, r, s, i) => (a.addEventListener(r, s, i), () => a.removeEventListener(r, s, i)), n = D(() => {
    const a = j(w(e[0])).filter((r) => r != null);
    return a.every((r) => typeof r != "string") ? a : void 0;
  });
  return ct(() => {
    var a, r;
    return [(a = (r = n.value) === null || r === void 0 ? void 0 : r.map((s) => q(s))) !== null && a !== void 0 ? a : [A].filter((s) => s != null), j(w(n.value ? e[1] : e[0])), j(Ke(n.value ? e[2] : e[1])), w(n.value ? e[3] : e[2])];
  }, ([a, r, s, i], o, u) => {
    if (!a?.length || !r?.length || !s?.length) return;
    const c = it(i) ? { ...i } : i, d = a.flatMap((l) => r.flatMap((m) => s.map((f) => t(l, m, f, c))));
    u(() => {
      d.forEach((l) => l());
    });
  }, { flush: "post" });
...
function de(e, t, n = {}) {
  const { window: a = A, ...r } = n;
  let s;
  const i = Ne(() => a && "MutationObserver" in a), o = () => {
    s && (s.disconnect(), s = void 0);
  }, u = M(D(() => {
    const l = j(w(e)).map(q).filter(nt);
    return new Set(l);
  }), (l) => {
    o(), i.value && l.size && (s = new MutationObserver(t), l.forEach((m) => s.observe(m, r)));
  }, { immediate: true, flush: "post" }), c = () => s?.takeRecords(), d = () => {
    u(), o();
  };
  return Q(d), { isSupported: i, stop: d, takeRecords: c };
}
function Ie(e, t, n = {}) {
  const { window: a = A, document: r = a?.document, flush: s = "sync" } = n;
  if (!a || !r) return O;
  let i;
  const o = (d) => {
    i?.(), i = d;
...
function jt(...e) {
  ...
  const { target: r = A, eventName: s = "keydown", passive: i = false, dedupe: o = false } = a, u = ft(t);
  return x(r, s, (d) => {
...
function pt(e = {}) {
  var t;
  const { window: n = A, deep: a = true, triggerOnRemoval: r = false } = e, s = (t = e.document) !== null && t !== void 0 ? t : n?.document, i = () => {
  ...
  return r && Ie(o, u, { document: s }), u(), o;
}
...
function Et(e, t, n, a = {}) {
  var r;
  const { flush: s = "pre", deep: i = true, listenToStorageChanges: o = true, writeDefaults: u = true, mergeDefaults: c = false, shallow: d, window: l = A, eventFilter: m, onError: f = (p) => {
    console.error(p);
  ...
  if (!n) return k;
  const E = w(t), S = bt(E), R = (r = a.serializer) !== null && r !== void 0 ? r : vt[S], { pause: P, resume: C } = ne(k, (p) => _(p), { flush: s, deep: i, eventFilter: m });
  M(g, () => z(), { flush: s });
  let H = false;
  const V = (p) => {
    b && !H || z(p);
...
function wt(e) {
  const t = le(), n = Qe(() => null, () => t.proxy.$el);
  return Ue(n.trigger), re(n.trigger), n;
}
function Me(e, t, n = {}) {
  const { window: a = A, ...r } = n;
  let s;
  const i = Ne(() => a && "ResizeObserver" in a), o = () => {
    s && (s.disconnect(), s = void 0);
  }, u = M(D(() => {
    const d = w(e);
    ...
    if (o(), i.value && a) {
      ...
      for (const l of d) l && s.observe(l, r);
    }
  }, { immediate: true, flush: "post" }), c = () => {
    o(), u();
  };
  return Q(c), { isSupported: i, stop: c };
}
function Ht(e, t = {}) {
  const { reset: n = true, windowResize: a = true, windowScroll: r = true, immediate: s = true, updateTiming: i = "sync" } = t, o = I(0), u = I(0), c = I(0), d = I(0), l = I(0), m = I(0), f = I(0), b = I(0);
  function k() {
    const E = q(e);
    if (!E) {
  ...
  return Me(e, g), M(() => q(e), (E) => !E && g()), de(e, g, { attributeFilter: ["style", "class"] }), r && x("scroll", g, { capture: true, passive: true }), a && x("resize", g, { passive: true }), $(() => {
    s && g();
  }), { height: o, bottom: u, left: c, right: d, top: l, width: m, x: f, y: b, update: g };
}
function $t(e, t = {}) {
  const { delayEnter: n = 0, delayLeave: a = 0, triggerOnRemoval: r = false, window: s = A } = t, i = I(false);
  let o;
  const u = (c) => {
    const d = c ? n : a;
    o && (clearTimeout(o), o = void 0), d ? o = setTimeout(() => i.value = c, d) : i.value = c;
  };
  return s && (x(e, "mouseenter", () => u(true), { passive: true }), x(e, "mouseleave", () => u(false), { passive: true }), r && Ie(D(() => q(e)), () => u(false))), i;
}
function Ut(e, t = { width: 0, height: 0 }, n = {}) {
  const { window: a = A, box: r = "content-box" } = n, s = D(() => {
    var l;
    return (l = q(e)) === null || l === void 0 || (l = l.namespaceURI) === null || l === void 0 ? void 0 : l.includes("svg");
  }), i = I(t.width), o = I(t.height), { stop: u } = Me(e, ([l]) => {
    const m = r === "border-box" ? l.borderBoxSize : r === "content-box" ? l.contentBoxSize : l.devicePixelContentBoxSize;
    if (a && s.value) {
      const f = q(e);
      if (f) {
        const b = f.getBoundingClientRect();
        i.value = b.width, o.value = b.height;
      }
    } else if (m) {
      const f = j(m);
      i.value = f.reduce((b, { inlineSize: k }) => b + k, 0), o.value = f.reduce((b, { blockSize: k }) => b + k, 0);
    } else i.value = l.contentRect.width, o.value = l.contentRect.height;
  }, n);
  $(() => {
    const l = q(e);
    l && (i.value = "offsetWidth" in l ? l.offsetWidth : t.width, o.value = "offsetHeight" in l ? l.offsetHeight : t.height);
  });
  const c = M(() => q(e), (l) => {
    i.value = l ? t.width : 0, o.value = l ? t.height : 0;
  });
  function d() {
    u(), c();
  }
  return { width: i, height: o, stop: d };
}
function kt(e, t = {}) {
  const { initialValue: n = false, focusVisible: a = false, preventScroll: r = false } = t, s = I(false), i = D(() => q(e)), o = { passive: true };
  x(i, "focus", (c) => {
    var d, l;
    (!a || !((d = (l = c.target).matches) === null || d === void 0) && d.call(l, ":focus-visible")) && (s.value = true);
  }, o), x(i, "blur", () => s.value = false, o);
  const u = D({ get: () => s.value, set(c) {
    var d, l;
    !c && s.value ? (d = i.value) === null || d === void 0 || d.blur() : c && !s.value && ((l = i.value) === null || l === void 0 || l.focus({ preventScroll: r }));
  } });
  return M(i, () => {
    u.value = n;
...
function Kt(e, t = {}) {
  const { window: n = A } = t, a = D(() => q(e)), r = I(false), s = D(() => r.value);
  if (!n || !pt(t).value) return { focused: s };
  const o = { passive: true };
  return x(a, xt, () => r.value = true, o), x(a, Dt, () => {
    var u, c, d;
    return r.value = (u = (c = a.value) === null || c === void 0 || (d = c.matches) === null || d === void 0 ? void 0 : d.call(c, qt)) !== null && u !== void 0 ? u : false;
  }, o), { focused: s };
}
const ve = 1;
function Jt(e, t = {}) {
  const { throttle: n = 0, idle: a = 200, onStop: r = O, onScroll: s = O, offset: i = { left: 0, right: 0, top: 0, bottom: 0 }, observe: o = { mutation: false }, eventListenerOptions: u = { capture: false, passive: true }, behavior: c = "auto", window: d = A, onError: l = (h) => {
    console.error(h);
  ...
  const S = I(false), R = he({ left: true, right: false, top: true, bottom: false }), P = he({ left: false, right: false, top: false, bottom: false }), C = (h) => {
    S.value && (S.value = false, P.left = false, P.right = false, P.top = false, P.bottom = false, r(h));
  }, H = Se(C, n + a), V = (h) => {
    var _;
    if (!d) return;
    ...
    const ce = Math.abs(N * v) <= (i.left || 0), me = Math.abs(N * v) + T.clientWidth >= T.scrollWidth - (i.right || 0) - ve;
    ...
    const fe = Math.abs(L) <= (i.top || 0), pe = Math.abs(L) + T.clientHeight >= T.scrollHeight - (i.bottom || 0) - ve;
...
function W(e = "", t = "ms") {
  let n = null, a;
  return String(e).replace(new RegExp(`(\\d)[${W.unit.placeholder}${W.unit.group}](\\d)`, "g"), "$1$2").replace(W.unit.decimal, ".").replace(Rt, (r, s, i) => {
    ...
    a = i = W.unit[i] || W.unit[i.replace(/s$/, "")], i && (n = (n || 0) + s * i);
  }), n && n / (W.unit[t] || 1) * (e[0] === "-" ? -1 : 1);
}
let G;
const St = (e) => {
  const t = D(() => q(e)), n = F(false);
  x(t, ["mousedown", "dragstart", "touchstart"], ({ currentTarget: i }) => {
    i instanceof Element && i === q(t) && (!G || !i.contains(G)) && (G = i, n.value = true);
  ...
  return M(n, (i) => {
    i ? (a.value = i, clearTimeout(r), r = setTimeout(() => {
      a.value = n.value, r = void 0;
    }, s())) : r === void 0 && (a.value = n.value);
...
const Mt = () => new Promise(requestAnimationFrame), At = async ({ target: e, clientX: t, clientY: n }) => {
  const { left: a, top: r, right: s, bottom: i } = e.getBoundingClientRect(), o = t - a, u = n - r, c = Math.max(Math.hypot(a - t, r - n), Math.hypot(s - t, r - n), Math.hypot(a - t, i - n), Math.hypot(s - t, i - n)) * 2, d = document.createElement("span");
  d.classList.add("md-ripple"), d.style.setProperty("--md-private-ripple-y", `${u}px`), d.style.setProperty("--md-private-ripple-x", `${o}px`), d.style.setProperty("--md-private-ripple-diameter", `${c}px`), e.prepend(d);
  const l = 1e3;
  await Mt();
  const m = d.animate([{ "--md-private-ripple-opacity": 1, "--md-private-ripple-scale": 0 }, { "--md-private-ripple-opacity": 1, "--md-private-ripple-scale": 1 }, { "--md-private-ripple-opacity": 0, "--md-private-ripple-scale": 1 }], { duration: l });
...
const Xt = (e) => {
  ...
  let n;
  const a = async (i) => {
    const { target: o, clientX: u, clientY: c } = i;
  ...
  x(t, "pointerdown", ({ currentTarget: i, clientX: o, clientY: u }) => {
    a({ clientX: o, clientY: u, target: i });
  }, { passive: true }), x(t, ["pointerup", "pointerout", "pointerleave", "touchend", "touchcancel", "keyup", "touchmove", "pointermove"], () => {
    r();
  });
  const s = Ye(({ currentTarget: i, key: o }) => {
    (o === " " || o === "Enter") && i instanceof Element && a({ clientX: 0, clientY: 0, target: i });
  }, 500, { leading: true });
  x(t, "keydown", (i) => {
    s(i);
  });
  ...
  const n = D(() => {
    const r = q(e);
    if (r) {
      if (t?.useTarget && r.matches(Ee)) return r;
      const s = r.querySelector(Ee);
  ...
  const e = F([]), t = D(() => e.value.at(-1)), n = () => {
    ...
    e.value.includes(s) && r(s), e.value.push(s);
  }, r = (s) => {
  ...
  return x("pointerdown", (s) => {
    ie(s.pointerType) || n();
  }, { passive: true, capture: true }), x(["touchstart", "pointercancel", "touchcancel", "dragstart", "drop"], n, { passive: true, capture: true }), { clear: n, push: a, remove: r, lastTarget: t };
}), zt = (e) => {
  const t = D(() => q(e)), { lastTarget: n, push: a, remove: r } = Tt();
  return x(t, "pointerenter", (s) => {
    if (!ie(s.pointerType)) return;
    const { currentTarget: i } = s;
    i instanceof Element && i === t.value && a(i);
  }), x(t, "pointerleave", (s) => {
    if (!ie(s.pointerType)) return;
    const { currentTarget: i } = s;
    i instanceof Element && r(i);
  }), M(t, (s, i) => {
    i instanceof Element && r(i);
  }, { immediate: true }), D(() => !!t.value && t.value === n.value);
}, te = (e, t = {}) => {
  const { pressed: n, durationPressedState: a } = St(e), r = zt(e), { focused: s } = Pt(e, { useTarget: true, focusVisible: true }), i = t.dragged ?? F(false);
  return t.hover && ye(r, t.hover), t.focused && ye(s, t.focused), { hover: r, focused: s, pressed: n, durationPressedState: a, dragged: i };
};
te.__docgenInfo = Object.assign({ displayName: te.name ?? te.__name }, { exportName: "useStateLayer", displayName: "useStateLayer", type: 2, props: [{ name: "value", global: false, description: "", tags: [], required: true, type: "HTMLElement | null", declarations: [], schema: { kind: "enum", type: "HTMLElement | null", schema: ["null", { kind: "object", type: "HTMLElement" }] } }, { name: "__@RefSymbol@1036", global: false, description: `Type differentiator only.
We need this to be in public d.ts but don't want it to show up in IDE
autocomplete, so we use a private Symbol instead.`, tags: [], required: true, type: "true", declarations: [], schema: "true" }], events: [], slots: [], exposed: [], sourceFiles: "/home/runner/work/mioframe/mioframe/app-source/src/shared/ui/material/foundation/state/useStateLayer.ts" });
export {
  ee as A,
  ne as B,
  Bt as M,
