...
`) } } } }, E = () => ({ template: '<div class="visual-checker-backdrop"><story /></div>' }), c = { decorators: [E] }, u = { args: { variant: "toggle", selected: true, color: "tonal", label: "Bookmark" }, decorators: [E] }, m = { args: { variant: "toggle", selected: true, color: "text", label: "Bookmark" }, decorators: [E] }, p = { tags: ["visual"], render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, template: `
    ...
    ` }) }, g = { tags: ["visual"], render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, template: `
    ...
    ` }) }, v = { decorators: [E], render: () => ({ components: { MDButton: e }, setup() {
  G();
}, template: `
    ...
    ` }) }, y = { tags: ["visual"], render: () => ({ components: { MDButton: e }, template: `
    ...
    ` }) }, h = { tags: ["visual"], render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, template: `
    ...
    ` }) }, Y = ["elevated", "filled", "tonal", "outlined", "text"], j = ["hover", "focus", "pressed"], f = { render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, setup() {
  return { DEFAULT_ROLE_BUTTON_STYLES: Y, DEFAULT_ROLE_STATES: j };
}, template: `
    ...
    ` }) }, D = { render: () => ({ components: { MDButtonTargetHitVisualStory: w }, template: "<MDButtonTargetHitVisualStory />" }) }, M = { render: () => ({ components: { MDButton: e }, template: `
    ...
    ` }) }, K = ["extra-small", "small", "medium", "large", "extra-large"], S = { render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, setup() {
  return { BUTTON_SIZES: K };
}, template: `
    ...
    ` }) }, B = { render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, template: `
    ...
    ` }) }, x = { render: () => ({ components: { MDButton: e }, template: `
    ...
    ` }) }, L = { render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, template: `
    ...
    ` }) }, z = ["elevated", "filled", "tonal", "outlined"], I = ["hover", "focus", "pressed"], k = { render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, setup() {
  return { BUTTON_TOGGLE_STYLES: z, BUTTON_TOGGLE_INTERACTION_STATES: I };
}, template: `
  ...
  return { BUTTON_TOGGLE_STYLES: z, BUTTON_TOGGLE_INTERACTION_STATES: I, buttonToggleRestingStyle: Z, buttonToggleInteractionStyle: X };
    ...
    ` }) }, T = { render: () => ({ components: { MDButton: e }, template: `
    ...
    ` }) }, F = { render: () => ({ components: { MDButton: e }, template: `
    ...
    ` }) }, l = { render: () => ({ components: { MDButton: e }, template: `
...
}`, ...l.parameters?.docs?.source }, description: { story: `Official Buttons guidelines: label text must never truncate or wrap on Web \u2014 it should always
...
its containing block rather than wrap or truncate the label.`, ...l.parameters?.docs?.description } } };
s.parameters = { ...s.parameters, docs: { ...s.parameters?.docs, source: { originalSource: `{
  render: () => ({
    components: {
      MDButton
...
}`, ...s.parameters?.docs?.source }, description: { story: 'The leading icon is not an independent trailing-icon feature \u2014 anatomy names one optional\nleading icon only. `MDButton.vue` renders icon-then-label with no directional CSS (default\n`flex-direction: row`, which is writing-mode/direction relative), so under `dir="rtl"` the\nicon should mirror to the visual right of the label without any RTL-specific code.', ...s.parameters?.docs?.description } } };
const le = ["Default", "Toggle", "ToggleText", "ToggleShapes", "ToggleInteractionStates", "DisabledSelectedOutlinedAndText", "FocusIndicatorTarget", "VisualStates", "VisualInteractionStates", "DefaultRoleMatrix", "ExpandedTargetHitArea", "SizeTypography", "SizeGeometryMatrix", "DisabledStatePrecedence", "TextButtonSpacing", "TokenRoutingMatrix", "DefaultToggleRoleMatrix", "ToggleTokenRoutingMatrix", "LoadingColorRouting", "TargetLayers", "LabelNoWrap", "RtlIconMirroring"];
export {
  c as Default,
  f as DefaultRoleMatrix,
  k as DefaultToggleRoleMatrix,
  b as DisabledSelectedOutlinedAndText,
  B as DisabledStatePrecedence,
  D as ExpandedTargetHitArea,
  v as FocusIndicatorTarget,
  l as LabelNoWrap,
  T as LoadingColorRouting,
  s as RtlIconMirroring,
  S as SizeGeometryMatrix,
  M as SizeTypography,
  F as TargetLayers,
  x as TextButtonSpacing,
  u as Toggle,
  g as ToggleInteractionStates,
  p as ToggleShapes,
  m as ToggleText,
  P as ToggleTokenRoutingMatrix,
  L as TokenRoutingMatrix,
  h as VisualInteractionStates,
  y as VisualStates,
