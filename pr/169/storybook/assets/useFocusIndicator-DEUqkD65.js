import { l as a, s as n } from "./iframe-dh2whCvJ.js";
import { i as I, o as L, d as l, h as P, t as R } from "./index-DAwKyIqy.js";
const A = () => {
  const r = n();
  ...
  const m = () => {
    ...
    t.style.opacity = "1";
  }, y = ({ top: e, left: o, width: s, height: i }) => {
  ...
  a(c, (e) => {
    if (e && !e.classList.contains("md-focus-indicator_hidden")) {
      ...
      for (const u of S) {
        const h = E.getPropertyValue(u).trim();
        h ? t.style.setProperty(u, h) : t.style.removeProperty(u);
      }
