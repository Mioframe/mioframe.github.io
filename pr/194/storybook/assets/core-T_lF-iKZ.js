...
const ht = globalThis, xs = ht.ShadowRoot && (ht.ShadyCSS === void 0 || ht.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, _s = /* @__PURE__ */ Symbol(), Ls = /* @__PURE__ */ new WeakMap();
let Js = class {
  constructor(e, t, s) {
    if (this._$cssResult$ = true, s !== _s) throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
  ...
  get styleSheet() {
    ...
    if (xs && e === void 0) {
      ...
      s && (e = Ls.get(t)), e === void 0 && ((this.o = e = new CSSStyleSheet()).replaceSync(this.cssText), s && Ls.set(t, e));
    }
    return e;
  }
  toString() {
...
const r = (i2) => new Js(typeof i2 == "string" ? i2 : i2 + "", void 0, _s), F = (i2, ...e) => {
  const t = i2.length === 1 ? i2[0] : e.reduce((s, n, o) => s + ((l) => {
    if (l._$cssResult$ === true) return l.cssText;
    if (typeof l == "number") return l;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + l + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(n) + i2[o + 1], i2[0]);
  return new Js(t, i2, _s);
}, Li = (i2, e) => {
  if (xs) i2.adoptedStyleSheets = e.map((t) => t instanceof CSSStyleSheet ? t : t.styleSheet);
...
}, zs = xs ? (i2) => i2 : (i2) => i2 instanceof CSSStyleSheet ? ((e) => {
  let t = "";
  for (const s of e.cssRules) t += s.cssText;
  return r(t);
})(i2) : i2;
const { is: zi, defineProperty: Hi, getOwnPropertyDescriptor: Ti, getOwnPropertyNames: Fi, getOwnPropertySymbols: Pi, getPrototypeOf: Di } = Object, Nt = globalThis, Hs = Nt.trustedTypes, Wi = Hs ? Hs.emptyScript : "", Ri = Nt.reactiveElementPolyfillSupport, Ke = (i2, e) => i2, Pt = { toAttribute(i2, e) {
  switch (e) {
    case Boolean:
      i2 = i2 ? Wi : null;
      break;
  ...
  return t;
} }, ws = (i2, e) => !zi(i2, e), Ts = { attribute: true, type: String, converter: Pt, reflect: false, useDefault: false, hasChanged: ws };
...
let ve = class extends HTMLElement {
  ...
  static getPropertyOptions(e) {
    return this.elementProperties.get(e) ?? Ts;
  }
  static _$Ei() {
  ...
  static finalize() {
    ...
    if (this.finalized = true, this._$Ei(), this.hasOwnProperty(Ke("properties"))) {
  ...
  static finalizeStyles(e) {
    ...
    if (Array.isArray(e)) {
      ...
      for (const n of s) t.unshift(zs(n));
    } else e !== void 0 && t.push(zs(e));
    return t;
  }
  static _$Eu(e, t) {
    const s = t.attribute;
  ...
  requestUpdate(e, t, s, n = false, o) {
    if (e !== void 0) {
      ...
      if (n === false && (o = this[e]), s ??= l.getPropertyOptions(e), !((s.hasChanged ?? ws)(o, t) || s.useDefault && s.reflect && o === this._$Ej?.get(e) && !this.hasAttribute(l._$Eu(e, s)))) return;
      this.C(e, t, s);
    }
...
ve.elementStyles = [], ve.shadowRootOptions = { mode: "open" }, ve[Ke("elementProperties")] = /* @__PURE__ */ new Map(), ve[Ke("finalized")] = /* @__PURE__ */ new Map(), Ri?.({ ReactiveElement: ve }), (Nt.reactiveElementVersions ??= []).push("2.1.2");
const $s = globalThis, Fs = (i2) => i2, Dt = $s.trustedTypes, Ps = Dt ? Dt.createPolicy("lit-html", { createHTML: (i2) => i2 }) : void 0, Qs = "$lit$", K = `lit$${Math.random().toFixed(9).slice(2)}$`, ei = "?" + K, Oi = `<${ei}>`, ce = document, Qe = () => ce.createComment(""), et = (i2) => i2 === null || typeof i2 != "object" && typeof i2 != "function", ks = Array.isArray, Ui = (i2) => ks(i2) || typeof i2?.[Symbol.iterator] == "function", Yt = `[ 	
\f\r]`, Fe = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ds = /-->/g, Ws = />/g, G = RegExp(`>|${Yt}(?:([^\\s"'>=/]+)(${Yt}*=${Yt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Rs = /'/g, Os = /"/g, ti = /^(?:script|style|textarea|title)$/i, Ii = (i2) => (e, ...t) => ({ _$litType$: i2, strings: e, values: t }), T = Ii(1), $e = /* @__PURE__ */ Symbol.for("lit-noChange"), w = /* @__PURE__ */ Symbol.for("lit-nothing"), Us = /* @__PURE__ */ new WeakMap(), re = ce.createTreeWalker(ce, 129);
function si(i2, e) {
  if (!ks(i2) || !i2.hasOwnProperty("raw")) throw Error("invalid template strings array");
...
const Bi = (i2, e) => {
  ...
  for (let d = 0; d < t; d++) {
    const u = i2[d];
    let m, v, h = -1, g = 0;
    for (; g < u.length && (l.lastIndex = g, v = l.exec(u), v !== null); ) g = l.lastIndex, l === Fe ? v[1] === "!--" ? l = Ds : v[1] !== void 0 ? l = Ws : v[2] !== void 0 ? (ti.test(v[2]) && (n = RegExp("</" + v[2], "g")), l = G) : v[3] !== void 0 && (l = G) : l === G ? v[0] === ">" ? (l = n ?? Fe, h = -1) : v[1] === void 0 ? h = -2 : (h = l.lastIndex - v[2].length, m = v[1], l = v[3] === void 0 ? G : v[3] === '"' ? Os : Rs) : l === Os || l === Rs ? l = G : l === Ds || l === Ws ? l = Fe : (l = G, n = void 0);
    const y = l === G && i2[d + 1].startsWith("/>") ? " " : "";
    o += l === Fe ? u + Oi : h >= 0 ? (s.push(m), u.slice(0, h) + Qs + u.slice(h) + K + y) : u + K + (h === -2 ? d : y);
  }
...
class tt {
  constructor({ strings: e, _$litType$: t }, s) {
    ...
    for (; (n = re.nextNode()) !== null && u.length < d; ) {
      if (n.nodeType === 1) {
        if (n.hasAttributes()) for (const h of n.getAttributeNames()) if (h.endsWith(Qs)) {
          const g = v[l++], y = n.getAttribute(h).split(K), k = /([.?@])?(.*)/.exec(g);
          u.push({ type: 1, index: o, name: k[2], strings: y, ctor: k[1] === "." ? Vi : k[1] === "?" ? qi : k[1] === "@" ? Ki : Vt }), n.removeAttribute(h);
        } else h.startsWith(K) && (u.push({ type: 6, index: o }), n.removeAttribute(h));
        if (ti.test(n.tagName)) {
          const h = n.textContent.split(K), g = h.length - 1;
          if (g > 0) {
            n.textContent = Dt ? Dt.emptyScript : "";
            for (let y = 0; y < g; y++) n.append(h[y], Qe()), re.nextNode(), u.push({ type: 2, index: ++o });
            n.append(h[g], Qe());
          }
        }
        ...
        let h = -1;
        for (; (h = n.data.indexOf(K, h + 1)) !== -1; ) u.push({ type: 7, index: o }), h += K.length - 1;
      }
      o++;
    }
  }
...
class Ni {
  ...
  u(e) {
    ...
    for (; u !== void 0; ) {
      if (l === u.index) {
        let m;
        u.type === 2 ? m = new it(o, o.nextSibling, this, e) : u.type === 1 ? m = new u.ctor(o, u.name, u.strings, this, e) : u.type === 6 && (m = new ji(o, this, e)), this._$AV.push(m), u = s[++d];
      }
...
class it {
  ...
  _$AC(e) {
    ...
    return t === void 0 && Us.set(e.strings, t = new tt(e)), t;
  }
  k(e) {
    ks(this._$AH) || (this._$AH = [], this._$AR());
    const t = this._$AH;
    let s, n = 0;
    for (const o of e) n === t.length ? t.push(s = new it(this.O(Qe()), this.O(Qe()), this, this.options)) : s = t[n], s._$AI(o), n++;
    n < t.length && (this._$AR(s && s._$AB.nextSibling, n), t.length = n);
  }
  _$AR(e = this._$AA.nextSibling, t) {
    for (this._$AP?.(false, true, t); e !== this._$AB; ) {
      const s = Fs(e).nextSibling;
      Fs(e).remove(), e = s;
    }
  }
  setConnected(e) {
...
const Xi = $s.litHtmlPolyfillSupport;
Xi?.(tt, it), ($s.litHtmlVersions ??= []).push("3.3.3");
const Yi = (i2, e, t) => {
  const s = t?.renderBefore ?? e;
  let n = s._$litPart$;
  if (n === void 0) {
    const o = t?.renderBefore ?? null;
    s._$litPart$ = n = new it(e.insertBefore(Qe(), o), o, void 0, t ?? {});
  }
  return n._$AI(i2), n;
};
const Cs = globalThis;
...
S._$litElement$ = true, S.finalized = true, Cs.litElementHydrateSupport?.({ LitElement: S });
const Zi = Cs.litElementPolyfillSupport;
Zi?.({ LitElement: S });
(Cs.litElementVersions ??= []).push("4.2.2");
const Gi = { attribute: true, type: String, converter: Pt, reflect: false, hasChanged: ws }, Ji = (i2 = Gi, e, t) => {
...
function x(i2) {
  return (e, t) => typeof t == "object" ? Ji(i2, e, t) : ((s, n, o) => {
    const l = n.hasOwnProperty(o);
    return n.constructor.createProperty(o, s), l ? Object.getOwnPropertyDescriptor(n, o) : void 0;
  })(i2, e, t);
}
const Qi = (i2, e, t) => (t.configurable = true, t.enumerable = true, Reflect.decorate && typeof e != "object" && Object.defineProperty(i2, e, t), t);
function Es(i2, e) {
  return (t, s, n) => {
...
function sn(i2, e) {
  ...
  for (const h of t) if (h.type === "M") s = { x: h.nums[0], y: h.nums[1] }, n = s;
    ...
    const U = 20;
    for (let Z = 1; Z <= U; Z++) {
      const Te = Z / U, Xt = Ns(s, g, y, k, Te);
      L += Math.hypot(Xt.x - z.x, Xt.y - z.y), z = Xt;
    }
  ...
  for (let h = 0; h < e; h++) {
    ...
    if (y.type === "L") {
      const [L, z] = y.pts;
      u.push({ x: Is(L.x, z.x, k), y: Is(L.y, z.y, k) });
    } else if (y.type === "Q") {
      const [L, z, U] = y.pts;
      u.push(Bs(L, z, U, k));
    } else if (y.type === "C") {
...
function nn(i2) {
  return `${i2.map((t) => {
    const s = Vs(t.x * 100, 0, 100), n = Vs(t.y * 100, 0, 100);
...
function ln(i2) {
  ...
  }), t = e[0], s = Math.sign(qs(t));
  for (let n = 1; n < e.length; n++) {
    let o = e[n];
    const l = Math.sign(qs(o));
...
var xe, ae, we, je, _e, pt, ut, mt, ft, ye, Wt, ii, cs, ni;
class qt extends nt {
  constructor(e, t) {
    super(e, t), xe.add(this), we.set(this, false), je.set(this, void 0), _e.set(this, void 0), pt.set(this, (s) => a(this, xe, "m", ii).call(this, s)), ut.set(this, (s) => a(this, xe, "m", cs).call(this, s)), mt.set(this, (s) => a(this, xe, "m", ni).call(this, s)), ft.set(this, () => b(this, we, true, "f")), ye.set(this, () => b(this, we, false, "f")), b(this, je, t.callback, "f"), b(this, _e, t.filter, "f");
  }
  _observe(e) {
...
ae = qt, we = /* @__PURE__ */ new WeakMap(), je = /* @__PURE__ */ new WeakMap(), _e = /* @__PURE__ */ new WeakMap(), pt = /* @__PURE__ */ new WeakMap(), ut = /* @__PURE__ */ new WeakMap(), mt = /* @__PURE__ */ new WeakMap(), ft = /* @__PURE__ */ new WeakMap(), ye = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakSet(), ii = function(e) {
  if (a(this, _e, "f")?.call(this, e)) return;
  e.currentTarget.matches(":focus-within") && a(this, xe, "m", cs).call(this, e);
}, cs = function(e) {
  if (a(this, _e, "f")?.call(this, e) || a(this, we, "f")) return;
  const t = e.currentTarget;
  a(this, je, "f").call(this, true, t.matches(":focus-visible") || a(ae, ae, "f", Wt) || en(), t);
}, ni = function(e) {
  a(this, _e, "f")?.call(this, e) || a(this, we, "f") || a(this, je, "f").call(this, false, false, e.currentTarget);
};
...
Wt = { value: false };
var D, ne, J, Q, vt, ge, hs, at, ot, ri, ai;
class oi extends nt {
  constructor(e, t) {
    super(e, t), D.add(this), ne.set(this, void 0), J.set(this, /* @__PURE__ */ new Map()), Q.set(this, /* @__PURE__ */ new Map()), vt.set(this, (s) => a(this, D, "m", ri).call(this, s)), ge.set(this, (s) => a(this, D, "m", ai).call(this, s)), b(this, ne, t.callback, "f"), this.startDelay = t.startDelay ?? 0, this.endDelay = t.endDelay ?? 0;
  }
  clearDelays() {
    for (const e of this.targets) a(this, D, "m", hs).call(this, e);
  }
  _observe(e) {
  ...
  _unobserve(e) {
    e.removeEventListener("pointerenter", a(this, vt, "f")), e.removeEventListener("pointerleave", a(this, ge, "f")), e.removeEventListener("touchend", a(this, ge, "f")), a(this, D, "m", hs).call(this, e);
  }
}
ne = /* @__PURE__ */ new WeakMap(), J = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakMap(), vt = /* @__PURE__ */ new WeakMap(), ge = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakSet(), hs = function(e) {
  ...
  const t = e.target;
  a(this, D, "m", ot).call(this, t), this.startDelay > 0 ? (a(this, D, "m", at).call(this, t), a(this, J, "f").set(t, setTimeout(() => {
    a(this, J, "f").delete(t), a(this, ne, "f").call(this, true, t);
  }, this.startDelay))) : a(this, ne, "f").call(this, true, t);
}, ai = function(e) {
  const t = e.target;
  a(this, D, "m", at).call(this, t) || (this.endDelay > 0 ? (a(this, D, "m", ot).call(this, t), a(this, Q, "f").set(t, setTimeout(() => {
    a(this, Q, "f").delete(t), a(this, ne, "f").call(this, false, t);
  }, this.endDelay))) : a(this, ne, "f").call(this, false, t));
};
var N, M, B, Xe, oe, A, Ye, yt, gt, be, bt, xt, li, di, ci, hi, pi, Jt;
class ui extends nt {
  constructor(e, t) {
...
M = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), Xe = /* @__PURE__ */ new WeakMap(), oe = /* @__PURE__ */ new WeakMap(), A = /* @__PURE__ */ new WeakMap(), Ye = /* @__PURE__ */ new WeakMap(), yt = /* @__PURE__ */ new WeakMap(), gt = /* @__PURE__ */ new WeakMap(), be = /* @__PURE__ */ new WeakMap(), bt = /* @__PURE__ */ new WeakMap(), xt = /* @__PURE__ */ new WeakMap(), N = /* @__PURE__ */ new WeakSet(), li = function(e) {
  ...
  e.pointerType === "mouse" && e.button > 1 || a(this, N, "m", Jt).call(this, e.x, e.y);
}, ci = function(e) {
  a(this, N, "m", Jt).call(this, e.changedTouches[0]?.clientX ?? 0, e.changedTouches[0]?.clientY ?? 0);
}, hi = function(e) {
...
Rt = /* @__PURE__ */ new WeakMap(), Ze = /* @__PURE__ */ new WeakMap(), $t = /* @__PURE__ */ new WeakMap(), te = /* @__PURE__ */ new WeakMap(), le = /* @__PURE__ */ new WeakSet(), Ks = function(e) {
  ...
  let n = s.currentNode;
  for (; n; ) {
    if (n instanceof Element && a(this, le, "m", Qt).call(this, n)) return n;
    n = s.nextNode();
  }
  return null;
}, Qt = function(e) {
  ...
  s && t.push(s);
  let n = e;
  for (; n; ) a(this, le, "m", Qt).call(this, n) && t.push(n), n = n.parentElement;
  return t;
}, vi = function(e) {
...
function Xs(i2) {
  return Y(i2, "indeterminate") && Ut(i2);
}
function pn(i2) {
...
const es = /* @__PURE__ */ Symbol("_eventHandler");
function On(i2) {
  var e;
  class t extends i2 {
    constructor() {
    ...
    connectedCallback() {
      this.markAsPristine(), super.connectedCallback(), this.addEventListener("change", this[es]);
    }
    disconnectedCallback() {
      super.disconnectedCallback(), this.removeEventListener("change", this[es]);
    }
    markAsPristine() {
      P(this, "--dirty");
    }
...
const ts = /* @__PURE__ */ Symbol("_eventHandler");
function Un(i2) {
  var e;
  class t extends i2 {
    constructor() {
    ...
    connectedCallback() {
      this.markAsUntouched(), super.connectedCallback(), this.addEventListener("focusout", this[ts], { capture: true });
    }
    disconnectedCallback() {
      super.disconnectedCallback(), this.removeEventListener("focusout", this[ts], { capture: true });
    }
    markAsTouched() {
      j(this, "--touched");
    }
...
const Ys = ["click", "dblclick", "auxclick", "keydown", "keyup"], Ln = ["Tab", "ArrowLeft", "ArrowUp", "ArrowRight", "ArrowDown", "Left", "Up", "Right", "Down"], is = /* @__PURE__ */ Symbol("_suppressedEventHandler");
function In(i2) {
  var e;
  class t extends i2 {
    constructor() {
    ...
    connectedCallback() {
      Ys.forEach((n) => this.addEventListener(n, this[is], true)), super.connectedCallback();
    }
    disconnectedCallback() {
      Ys.forEach((n) => this.removeEventListener(n, this[is], true)), super.disconnectedCallback();
    }
    update(n) {
  ...
  return e = is, f([x({ attribute: "disabled-interactive", type: Boolean, reflect: true })], t.prototype, "disabledInteractive", void 0), t;
}
...
function Bn(i2) {
  ...
  class t extends i2 {
    ...
    [(e = Pe, kt)]() {
      const n = this.hasAttribute("tabindex"), o = Ce(this) && this.disabled || Ee(this) && this.disabledInteractive, l = Ms(this) && this.touched && (this.ariaInvalid || rt(this, "--invalid"));
...
const Zs = /* @__PURE__ */ Symbol("formValue"), Gs = /* @__PURE__ */ Symbol("defaultValue"), lt = /* @__PURE__ */ Symbol("_defaultValue"), ns = /* @__PURE__ */ Symbol("_defaultIndeterminate"), rs = /* @__PURE__ */ Symbol("_formDisabled");
function Nn(i2) {
  var e, t;
  class s extends i2 {
    constructor() {
    ...
    get disabled() {
      return super.disabled || this[rs];
    }
    set disabled(o) {
      super.disabled = o;
    }
    connectedCallback() {
      super.connectedCallback(), Ut(this) ? (this[lt] = this.checked, Xs(this) && (this[ns] = this.indeterminate)) : "value" in this && (this[lt] = this.value);
    }
    requestUpdate(o, l, d) {
      super.requestUpdate(o, l, d), this[$].setFormValue(this[Zs]);
    }
    formDisabledCallback(o) {
      const l = this.disabled;
      this[rs] = o, this.disabled != l && this.requestUpdate("disabled", l);
    }
    formResetCallback() {
      Ut(this) ? (this.checked = this[lt] === true, Xs(this) && (this.indeterminate = this[ns])) : "value" in this && (this.value = this[Gs]), un(this) && this.markAsPristine(), Ms(this) && this.markAsUntouched();
    }
  }
  return s.formAssociated = true, f([x({ noAccessor: true })], s.prototype, "name", null), f([x({ type: Boolean })], s.prototype, "disabled", null), s;
}
const It = /* @__PURE__ */ Symbol("validate"), q = /* @__PURE__ */ Symbol("_updateValidity"), dt = /* @__PURE__ */ Symbol("_validityMessage");
function Vn(i2) {
  var e, t;
  class s extends i2 {
    constructor() {
    ...
    get validity() {
      return this[q](), this[$].validity;
    }
    get validationMessage() {
      return this[q](), this[$].validationMessage;
    }
    [(e = /* @__PURE__ */ new WeakSet(), It)]() {
      return this[dt] ? { customError: true } : void 0;
    }
    reportValidity() {
      return Ms(this) && this.markAsTouched(), this[q](), this[$].reportValidity();
    }
    checkValidity() {
      return this[q](), this[$].checkValidity();
    }
    setCustomValidity(o) {
      o ? this[dt] = o : this[dt] = void 0, this[q]();
    }
    requestUpdate(o, l, d) {
      super.requestUpdate(o, l, d), this[q]();
    }
    firstUpdated(o) {
      super.firstUpdated(o), this[q]();
    }
    [q]() {
      if (!this.isConnected) return;
      const o = this[It](), l = o && Object.keys(o).some((u) => o[u] === true);
...
const as = /* @__PURE__ */ Symbol("_clickHandler");
function Kn(i2) {
  var e;
  class t extends i2 {
    constructor() {
    ...
    connectedCallback() {
      super.connectedCallback(), this.addEventListener("click", this[as]);
    }
    disconnectedCallback() {
      super.disconnectedCallback(), this.removeEventListener("click", this[as]);
    }
  }
  return e = as, t.formAssociated = true, f([x()], t.prototype, "name", null), f([x()], t.prototype, "value", null), f([x()], t.prototype, "type", void 0), t;
}
const me = /* @__PURE__ */ Symbol("_control"), os = /* @__PURE__ */ Symbol("_firstUpdated");
function jt(i2) {
  var e;
  class t extends i2 {
    constructor() {
    ...
    firstUpdated(n) {
      super.firstUpdated(n), this[os] = true;
    }
    update(n) {
      ...
      } else this.control && this[os] && this.detach();
    }
    attach(n) {
  ...
  return e = os, f([x({ attribute: "for" })], t.prototype, "htmlFor", void 0), t;
}
function jn(i2, e = true) {
  var t, s, n, o, l, d, u;
  class m extends i2 {
    constructor() {
...
const Hn = /* @__PURE__ */ Symbol("renderPseudoLink"), ls = /* @__PURE__ */ Symbol("_clickHandler");
function Xn(i2, e = false) {
  ...
  class d extends i2 {
    ...
    connectedCallback() {
      super.connectedCallback(), e || this.addEventListener("click", this[ls]), this.hasAttribute("href") && this.role === "button" && (this.role = "link");
    }
    disconnectedCallback() {
      super.disconnectedCallback(), e || this.removeEventListener("click", this[ls]);
    }
    [(t = /* @__PURE__ */ new WeakSet(), l = ls, Hn)]() {
      const m = Ce(this) && this.disabled, v = Ee(this) && this.disabledInteractive;
      return !m && !v && this.href ? T`<a href="${this.href}" target="${Zt(this.target || void 0)}" rel="${Zt(this.rel || void 0)}" download="${Zt(this.download || void 0)}" tabindex="-1" aria-hidden="true" @pointerdown="${a(this, t, "m", s)}" @focus="${a(this, t, "m", n)}" @blur="${a(this, t, "m", o)}"></a>` : w;
    }
  }
  return s = function(m) {
...
const ds = /* @__PURE__ */ Symbol("_wasConnected");
function Yn(i2) {
  var e;
  class t extends i2 {
    constructor() {
    ...
    connectedCallback() {
      super.connectedCallback(), this[ds] && this.reconnectedCallback();
    }
    disconnectedCallback() {
      super.disconnectedCallback(), this[ds] = true;
    }
  }
  return e = ds, t;
}
function Zn(i2) {
  class e extends i2 {
    ...
    update(s) {
      super.update(s), s.has("required") && (this.ariaRequired = `${this.required}`);
    }
  }
  return f([x({ type: Boolean, reflect: true })], e.prototype, "required", void 0), e;
}
function Gn(i2) {
  class e extends i2 {
    [It]() {
      const s = super[It]();
      if (!s && this.required) {
        if (Ut(this) && !this.checked) return { valueMissing: true };
...
var H, Ge, Ie, bi, Be, Ne, ps;
let Se = class extends Ss(S) {
  constructor() {
  ...
  update(e) {
    ...
    if (j(this, "--no-animate"), !a(this, Ge, "f")) {
      this.open && (b(this, Ie, true, "f"), a(this, H, "m", Be).call(this)), b(this, Ge, true, "f");
      return;
    }
    this.toggleAttribute("inert", !this.open), this.open ? (b(this, Ie, true, "f"), t || Gt() || (a(this, H, "m", Be).call(this), Ot(this, "--overflows", this.orientation === "vertical" ? this.clientHeight < this.scrollHeight : this.orientation === "horizontal" ? this.clientWidth < this.scrollWidth : this.clientHeight < this.scrollHeight || this.clientWidth < this.scrollWidth), a(this, H, "m", Ne).call(this)), P(this, "--closing"), j(this, "--opening"), this.dispatchEvent(new Event("opening")), a(this, H, "m", Ne).call(this), P(this, "--no-animate"), a(this, H, "m", ps).call(this), t || Gt() ? (a(this, H, "m", Be).call(this), P(this, "--opening"), this.dispatchEvent(new Event("opened"))) : this.addEventListener("transitionend", () => {
      this.open && (a(this, H, "m", Be).call(this), P(this, "--opening"), this.dispatchEvent(new Event("opened")));
    }, { once: true })) : (P(this, "--opening"), j(this, "--closing"), this.dispatchEvent(new Event("closing")), a(this, H, "m", ps).call(this), a(this, Ie, "f") && P(this, "--no-animate"), t || Gt() ? (a(this, H, "m", Ne).call(this), P(this, "--closing"), this.dispatchEvent(new Event("closed"))) : requestAnimationFrame(() => {
...
let Me = class extends jt(He(S, "none")) {
  constructor() {
    super(...arguments), Ve.add(this), Et.set(this, new oi(this, { target: null, callback: (e) => a(this, Ve, "m", xi).call(this, e) })), St.set(this, new qt(this, { target: null, callback: (e) => a(this, Ve, "m", _i).call(this, e) })), Mt.set(this, new ui(this, { target: null, callback: (e) => a(this, Ve, "m", wi).call(this, e) })), this.disabled = false, this.level = null;
  }
  attach(e) {
...
f([Es(".shadow")], Me.prototype, "_shadow", void 0);
...
var us, At, $i;
let Ae = class extends jt(He(S, "none")) {
  constructor() {
    super(...arguments), us.add(this), At.set(this, new qt(this, { target: null, callback: (e, t) => a(this, us, "m", $i).call(this, t) })), this.inward = false, this.disabled = false;
  }
  show() {
...
f([Es(".outline")], Ae.prototype, "_outline", void 0);
...
let ms = class extends pn(gi(He(S, "none"))) {
  connectedCallback() {
...
let pe = class extends jt(He(S, "none")) {
  constructor() {
...
var qe;
let Le = class extends Ss(S) {
  constructor() {
    super(...arguments), qe.set(this, () => this._updateScroll()), this.dividers = "above-below", this.thin = false;
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.removeEventListener("scroll", a(this, qe, "f"));
  }
  update(e) {
    super.update(e), e.has("dividers") && (this.removeEventListener("scroll", a(this, qe, "f")), this.dividers !== "none" && this.addEventListener("scroll", a(this, qe, "f"), { passive: true }));
  }
  render() {
...
var Je, de, Ei, As;
let Bt = class extends Ss(S) {
  constructor() {
    super(...arguments), Je.add(this), de.set(this, new Array()), this.selectedIndex = null;
  }
  connectedCallback() {
    super.connectedCallback(), j(this, "--no-animate");
  }
  update(e) {
    super.update(e), e.has("selectedIndex") && (this.selectedIndex === null && j(this, "--no-animate"), a(this, Je, "m", As).call(this), this.selectedIndex !== null && rt(this, "--no-animate") && requestAnimationFrame(() => {
      this.selectedIndex !== null && P(this, "--no-animate");
    }));
  }
  render() {
    return T`<slot @slotchange="${a(this, Je, "m", Ei)}"></slot>`;
  }
};
...
Ei = function(e) {
  ...
  b(this, de, t, "f"), a(this, Je, "m", As).call(this);
};
As = function() {
...
Bt.styles = F`:host { display: flex; position: relative; overflow: hidden; } ::slotted(*) { width: 100%; top: 0; transition: ${r(`inset-inline-start var(--m3e-slide-animation-duration, ${c.motion.duration.long2}) ${c.motion.easing.standard},
...
f([x({ attribute: "selected-index", type: Number, reflect: true })], Bt.prototype, "selectedIndex", void 0);
Bt = f([O("m3e-slide")], Bt);
...
var Ht, Tt, Ft, Si, Mi;
let ze = class extends jt(He(S, "none")) {
  constructor() {
    super(...arguments), Ht.add(this), Tt.set(this, new oi(this, { target: null, callback: (e) => a(this, Ht, "m", Si).call(this, e) })), Ft.set(this, new qt(this, { target: null, callback: (e, t) => a(this, Ht, "m", Mi).call(this, t) })), this.disabled = false, this.disableHover = false;
  }
  show(e) {
...
f([Es(".layer")], ze.prototype, "_layer", void 0);
...
let X = gs = class extends S {
  ...
  updated(e) {
    super.updated(e), (e.has("term") || e.has("caseSensitive") || e.has("disabled")) && a(this, V, "m", ys).call(this);
  }
  render() {
    return T`<slot @slotchange="${a(this, V, "m", ys)}"></slot>`;
  }
};
st = /* @__PURE__ */ new WeakMap();
...
Ai = function i(e, t) {
  e instanceof HTMLSlotElement ? e.assignedNodes({ flatten: true }).forEach((s) => {
    switch (s.nodeType) {
      case Node.TEXT_NODE:
        a(this, V, "m", vs).call(this, s) && t.push(s);
        break;
...
X = gs = f([O("m3e-text-highlight")], X);
let bs = class extends S {
  render() {
    return T`<span class="base"><slot></slot></span>`;
  }
};
bs.styles = F`:host { flex: 1 1 auto; display: inline-flex; align-items: center; flex-wrap: nowrap; min-width: 0; } .base { flex: 1 1 auto; display: inline; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }`;
bs = f([O("m3e-text-overflow")], bs);
export {
  Ss as A,
  pn as B,
  Vn as C,
