import { d as b, c as y, b as v, a as D, t as k, r as n, e as M } from "./iframe-D_xDKw6y.js";
import { u as x } from "./useFocusIndicator-B2mV3kFE.js";
import { M as e } from "./MDButton-6KlHwjJd.js";
...
const T = { title: "Material 3/Components/Buttons/MDButton", component: e, args: { color: "filled", label: "Save" }, argTypes: { onClick: { action: "click" } }, parameters: { layout: "centered", docs: { description: { component: "Mioframe Button adapter backed privately by @m3e/web. Supports five appearances and sizes, round/square shapes, disabled, controlled toggle intent, native form types, a leading icon slot, and the loading extension." } } } }, i = {}, l = { tags: ["visual"], render: () => ({ components: { MDButton: e }, template: `
    ...
    ` }) }, r = { render: () => ({ components: { MDButton: e }, template: `
    ...
    ` }) }, s = { tags: ["visual"], render: () => ({ components: { MDButton: e }, template: `
    ...
    ` }) }, d = { render: () => ({ components: { MDButtonTargetHitVisualStory: m }, template: "<MDButtonTargetHitVisualStory />" }) }, u = { render: () => ({ components: { MDButton: e }, setup() {
  x();
}, template: `
  ...
  const p = n(false), t = n(0), a = n(0), g = n(0);
  return { disabledClickCount: g, loadingClickCount: a, onDisabledClick: () => {
    g.value += 1;
  }, onLoadingClick: () => {
    a.value += 1;
  }, onSubmit: () => {
...
const O = ["Default", "VisualStates", "SizeGeometryMatrix", "ToggleShapes", "DisabledSelectedOutlinedAndText", "ExpandedTargetHitArea", "FocusIndicatorTarget", "BehaviorContracts"];
export {
