...
`) } } } }, E = () => ({ template: '<div class="visual-checker-backdrop"><story /></div>' }), i = { decorators: [E] }, c = { args: { variant: "toggle", selected: true, color: "tonal", label: "Bookmark" }, decorators: [E] }, u = { args: { variant: "toggle", selected: true, color: "text", label: "Bookmark" }, decorators: [E] }, m = { tags: ["visual"], render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, template: `
    ...
    ` }) }, p = { tags: ["visual"], render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, template: `
    ...
    ` }) }, g = { tags: ["visual"], render: () => ({ components: { MDButton: e }, template: `
    ...
    ` }) }, b = { decorators: [E], render: () => ({ components: { MDButton: e }, setup() {
  U();
}, template: `
    ...
    ` }) }, v = { tags: ["visual"], render: () => ({ components: { MDButton: e }, template: `
    ...
    ` }) }, y = { tags: ["visual"], render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, template: `
    ...
    ` }) }, H = ["elevated", "filled", "tonal", "outlined", "text"], Y = ["hover", "focus", "pressed"], h = { render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, setup() {
  return { DEFAULT_ROLE_BUTTON_STYLES: H, DEFAULT_ROLE_STATES: Y };
}, template: `
    ...
    ` }) }, f = { render: () => ({ components: { MDButtonTargetHitVisualStory: F }, template: "<MDButtonTargetHitVisualStory />" }) }, D = { render: () => ({ components: { MDButton: e }, template: `
    ...
    ` }) }, j = ["extra-small", "small", "medium", "large", "extra-large"], M = { render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, setup() {
  return { BUTTON_SIZES: j };
}, template: `
    ...
    ` }) }, S = { render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, template: `
    ...
    ` }) }, B = { render: () => ({ components: { MDButton: e }, template: `
    ...
    ` }) }, x = { render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, template: `
    ...
    ` }) }, _ = ["elevated", "filled", "tonal", "outlined"], z = ["hover", "focus", "pressed"], L = { render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, setup() {
  return { BUTTON_TOGGLE_STYLES: _, BUTTON_TOGGLE_INTERACTION_STATES: z };
}, template: `
  ...
  const n = I[a], s = t === "hover" ? n[o] : w[a][o][t], q = t === "hover" ? n.hoverOpacity : w[a][`${t}Opacity`], d = t === "hover" ? "hovered" : t === "focus" ? "focused" : "pressed";
  return { [`--md-comp-button-${a}-${d}-state-layer-opacity`]: q, [`--md-comp-button-${a}-${o}-${d}-label-text-color`]: s.label, [`--md-comp-button-${a}-${o}-${d}-icon-color`]: s.icon, [`--md-comp-button-${a}-${o}-${d}-state-layer-color`]: s.stateLayerColor };
}, k = { render: () => ({ components: { MDButton: e, MDStateLayerForcedStateProvider: r }, setup() {
  return { BUTTON_TOGGLE_STYLES: _, BUTTON_TOGGLE_INTERACTION_STATES: z, buttonToggleRestingStyle: K, buttonToggleInteractionStyle: Z };
}, template: `
...
}`, ...l.parameters?.docs?.source }, description: { story: `Official Buttons accessibility guidance: labels should fit within two lines after 200% text
