import { c as d, o as O, t as f, u as v } from "./index-SSb-D2-R.js";
import { B as m, M as S, P as k, X as N, r as x } from "./iframe-iZe8_ggN.js";
const p = d(() => {
  const t = [];
  return O("Escape", (e) => {
    let s = true;
...
function A(t) {
  switch (typeof t) {
    ...
    case "symbol":
      return false;
    case "string":
      return t === "" || t.startsWith(".") || t.endsWith(".") ? false : B.test(t);
    default:
      return false;
  }
}
function g(t, n, r) {
  ...
  switch (typeof n) {
    case "string": {
      if (l(n)) return r;
      const e = t[n];
      return e === void 0 ? A(n) && !Object.hasOwn(t, n) ? g(t, P(n), r) : r : e;
    }
    case "number":
    case "symbol": {
